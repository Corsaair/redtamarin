...
toplevel_classes += " ../as3/clib/C/stdlib.as";
toplevel_classes += " ../as3/clib/C/unistd.as";
toplevel_classes += " ../as3/clib/C/string.as";
toplevel_classes += " ../as3/clib/C/errno.as";
toplevel_classes += " ../as3/clib/C/stdio.as";
toplevel_classes += " ../as3/clib/C/socket.as";
toplevel_classes += " ../as3/shell/avmplus/FileSystem.as";
toplevel_classes += " ../as3/shell/avmplus/OperatingSystem.as";
toplevel_classes += " ../as3/shell/avmplus/Socket.as";
