...
const uint32_t C_unistd___unistd_F_OK_get = 124;
const uint32_t C_unistd___unistd_X_OK_get = 125;
const uint32_t C_unistd___unistd_W_OK_get = 126;
const uint32_t C_unistd___unistd_R_OK_get = 127;
const uint32_t C_unistd___unistd_S_IFMT_get = 128;
const uint32_t C_unistd___unistd_S_IFIFO_get = 129;
const uint32_t C_unistd___unistd_S_IFCHR_get = 130;
const uint32_t C_unistd___unistd_S_IFDIR_get = 131;
const uint32_t C_unistd___unistd_S_IFBLK_get = 132;
const uint32_t C_unistd___unistd_S_IFREG_get = 133;
const uint32_t C_unistd___unistd_S_IFLNK_get = 134;
const uint32_t C_unistd___unistd_S_IFSOCK_get = 135;
const uint32_t C_unistd___unistd_S_IRWXU_get = 136;
const uint32_t C_unistd___unistd_S_IRUSR_get = 137;
const uint32_t C_unistd___unistd_S_IWUSR_get = 138;
const uint32_t C_unistd___unistd_S_IXUSR_get = 139;
const uint32_t C_unistd___unistd_S_IRWXG_get = 140;
const uint32_t C_unistd___unistd_S_IRGRP_get = 141;
const uint32_t C_unistd___unistd_S_IWGRP_get = 142;
const uint32_t C_unistd___unistd_S_IXGRP_get = 143;
const uint32_t C_unistd___unistd_S_IRWXO_get = 144;
const uint32_t C_unistd___unistd_S_IROTH_get = 145;
const uint32_t C_unistd___unistd_S_IWOTH_get = 146;
const uint32_t C_unistd___unistd_S_IXOTH_get = 147;
const uint32_t C_unistd___unistd_S_IREAD_get = 148;
const uint32_t C_unistd___unistd_S_IWRITE_get = 149;
const uint32_t C_unistd___unistd_S_IEXEC_get = 150;
const uint32_t C_unistd___unistd_access = 151;
const uint32_t C_unistd___unistd_chdir = 152;
const uint32_t C_unistd___unistd_chmod = 153;
const uint32_t C_unistd___unistd_getcwd = 154;
const uint32_t C_unistd___unistd_gethostname = 155;
const uint32_t C_unistd___unistd_getlogin = 156;
const uint32_t C_unistd___unistd_mkdir = 157;
const uint32_t C_unistd___unistd_rmdir = 158;
const uint32_t C_unistd___unistd_sleep = 159;
const uint32_t C_unistd___unistd_unlink = 160;
const uint32_t C_string___string_strerror = 168;
const uint32_t C_string___string_strlen = 169;
const uint32_t C_errno___errno_EDOM_get = 175;
const uint32_t C_errno___errno_EILSEQ_get = 176;
const uint32_t C_errno___errno_ERANGE_get = 177;
const uint32_t C_errno___errno_EPERM_get = 178;
const uint32_t C_errno___errno_ENOENT_get = 179;
const uint32_t C_errno___errno_ESRCH_get = 180;
const uint32_t C_errno___errno_EINTR_get = 181;
const uint32_t C_errno___errno_EIO_get = 182;
const uint32_t C_errno___errno_ENXIO_get = 183;
const uint32_t C_errno___errno_E2BIG_get = 184;
const uint32_t C_errno___errno_ENOEXEC_get = 185;
const uint32_t C_errno___errno_EBADF_get = 186;
const uint32_t C_errno___errno_ECHILD_get = 187;
const uint32_t C_errno___errno_EAGAIN_get = 188;
const uint32_t C_errno___errno_ENOMEM_get = 189;
const uint32_t C_errno___errno_EACCES_get = 190;
const uint32_t C_errno___errno_EFAULT_get = 191;
const uint32_t C_errno___errno_EBUSY_get = 192;
const uint32_t C_errno___errno_EEXIST_get = 193;
const uint32_t C_errno___errno_EXDEV_get = 194;
const uint32_t C_errno___errno_ENODEV_get = 195;
const uint32_t C_errno___errno_ENOTDIR_get = 196;
const uint32_t C_errno___errno_EISDIR_get = 197;
const uint32_t C_errno___errno_EINVAL_get = 198;
const uint32_t C_errno___errno_ENFILE_get = 199;
const uint32_t C_errno___errno_EMFILE_get = 200;
const uint32_t C_errno___errno_ENOTTY_get = 201;
const uint32_t C_errno___errno_EFBIG_get = 202;
const uint32_t C_errno___errno_ENOSPC_get = 203;
const uint32_t C_errno___errno_ESPIPE_get = 204;
const uint32_t C_errno___errno_EROFS_get = 205;
const uint32_t C_errno___errno_EMLINK_get = 206;
const uint32_t C_errno___errno_EPIPE_get = 207;
const uint32_t C_errno___errno_EDEADLK_get = 208;
const uint32_t C_errno___errno_ENAMETOOLONG_get = 209;
const uint32_t C_errno___errno_ENOLCK_get = 210;
const uint32_t C_errno___errno_ENOSYS_get = 211;
const uint32_t C_errno___errno_ENOTEMPTY_get = 212;
const uint32_t C_errno___errno_ENETDOWN_get = 213;
const uint32_t C_errno___errno_ENETUNREACH_get = 214;
const uint32_t C_errno___errno_ENETRESET_get = 215;
const uint32_t C_errno___errno_ECONNABORTED_get = 216;
const uint32_t C_errno___errno_ECONNRESET_get = 217;
const uint32_t C_errno___errno_ENOBUFS_get = 218;
const uint32_t C_errno___errno_EISCONN_get = 219;
const uint32_t C_errno___errno_ENOTCONN_get = 220;
const uint32_t C_errno___errno_ESHUTDOWN_get = 221;
const uint32_t C_errno___errno_ETOOMANYREFS_get = 222;
const uint32_t C_errno___errno_ETIMEDOUT_get = 223;
const uint32_t C_errno___errno_ECONNREFUSED_get = 224;
const uint32_t C_errno___errno_errno_get = 225;
const uint32_t C_errno___errno_errno_set = 226;
const uint32_t C_stdio___stdio_FILENAME_MAX_get = 232;
const uint32_t C_stdio___stdio_PATH_MAX_get = 233;
const uint32_t C_stdio___stdio_remove = 234;
const uint32_t C_stdio___stdio_rename = 235;
const uint32_t C_socket___socket_SOCK_RAW_get = 241;
const uint32_t C_socket___socket_SOCK_STREAM_get = 242;
const uint32_t C_socket___socket_SOCK_DGRAM_get = 243;
const uint32_t C_socket___socket_SO_ACCEPTCONN_get = 244;
const uint32_t C_socket___socket_SO_BROADCAST_get = 245;
const uint32_t C_socket___socket_SO_DONTROUTE_get = 246;
const uint32_t C_socket___socket_SO_KEEPALIVE_get = 247;
const uint32_t C_socket___socket_SO_OOBINLINE_get = 248;
const uint32_t C_socket___socket_SO_RCVBUF_get = 249;
const uint32_t C_socket___socket_SO_RCVTIMEO_get = 250;
const uint32_t C_socket___socket_SO_REUSEADDR_get = 251;
const uint32_t C_socket___socket_SO_SNDBUF_get = 252;
const uint32_t C_socket___socket_SO_SNDTIMEO_get = 253;
const uint32_t C_socket___socket_SO_TYPE_get = 254;
const uint32_t C_socket___socket_SOMAXCONN_get = 255;
const uint32_t C_socket___socket_MSG_CTRUNC_get = 256;
const uint32_t C_socket___socket_MSG_DONTROUTE_get = 257;
const uint32_t C_socket___socket_MSG_OOB_get = 258;
const uint32_t C_socket___socket_MSG_PEEK_get = 259;
const uint32_t C_socket___socket_MSG_TRUNC_get = 260;
const uint32_t C_socket___socket_MSG_WAITALL_get = 261;
const uint32_t C_socket___socket_AF_INET_get = 262;
const uint32_t C_socket___socket_AF_INET6_get = 263;
const uint32_t C_socket___socket_AF_UNSPEC_get = 264;
const uint32_t C_socket___socket_SHUT_RD_get = 265;
const uint32_t C_socket___socket_SHUT_RDWR_get = 266;
const uint32_t C_socket___socket_SHUT_WR_get = 267;
const uint32_t C_socket___socket_IPPROTO_IP_get = 268;
const uint32_t C_socket___socket_IPPROTO_IPV6_get = 269;
const uint32_t C_socket___socket_IPPROTO_ICMP_get = 270;
const uint32_t C_socket___socket_IPPROTO_RAW_get = 271;
const uint32_t C_socket___socket_IPPROTO_TCP_get = 272;
const uint32_t C_socket___socket_IPPROTO_UDP_get = 273;
const uint32_t C_socket___socket_INADDR_ANY_get = 274;
const uint32_t C_socket___socket_INADDR_BROADCAST_get = 275;
const uint32_t C_socket___socket___gethostbyaddr = 276;
const uint32_t C_socket___socket___gethostbyname = 277;
const uint32_t avmplus_JObject_create = 284;
const uint32_t avmplus_JObject_createArray = 285;
const uint32_t avmplus_JObject_toArray = 286;
const uint32_t avmplus_JObject_constructorSignature = 287;
const uint32_t avmplus_JObject_methodSignature = 288;
const uint32_t avmplus_JObject_fieldSignature = 289;
