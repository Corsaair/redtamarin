...
os.system(asc+" -abcfuture -builtin -import ../../core/builtin.abc -out toplevel toplevel.as flashplatform.as Domain.as StringBuilder.as ByteArray.as ../../extensions/Sampler.as ../../extensions/Trace.as ../../extensions/Dictionary.as Endian.as Java.as redtamarin.as standardC.as")
