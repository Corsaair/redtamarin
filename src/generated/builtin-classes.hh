...
public:
    inline uint32_t call_get_bytesAvailable()
    {
        ...
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1390);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1393);
        avmplus::Atom const result = this->toplevel()->getproperty(this->atom(), mn, this->vtable);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1392);
        avmplus::Atom const result = this->toplevel()->getproperty(this->atom(), mn, this->vtable);
        return avmplus::AvmCore::toUInt32(result);
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1378);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1379);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
    ...
    inline void call_readBytes(GCRef<avmplus::ByteArrayObject> arg1, uint32_t arg2, uint32_t arg3)
    {
        ...
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1377);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1386);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1385);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::number(result);
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1383);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::integer(result);
    }
    inline GCRef<avmplus::String> call_readMultiByte(uint32_t arg1, GCRef<avmplus::String> arg2)
    {
        avmplus::AvmCore* const core = ((avmplus::AvmCore*)(this->core()));
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1387);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1391);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return result;
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1381);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::integer(result);
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1388);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return GCRef<avmplus::String>(avmplus::AvmCore::atomToString(result));
    }
    inline GCRef<avmplus::String> call_readUTFBytes(uint32_t arg1)
    {
        avmplus::AvmCore* const core = ((avmplus::AvmCore*)(this->core()));
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1389);
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1380);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::toUInt32(result);
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1384);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::toUInt32(result);
    }
    ...
    {
        PoolObject* pool = toplevel()->abcEnv()->pool();
        const avmplus::Multiname* const mn = pool->precomputedMultiname(1382);
        avmplus::Atom args[1] = { thisRef.reinterpretCast<avmplus::ScriptObject>()->atom() };
        avmplus::Atom const result = this->toplevel()->callproperty(this->atom(), mn, 0, args, this->vtable);
        return avmplus::AvmCore::toUInt32(result);
    }
