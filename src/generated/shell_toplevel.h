...
namespace avmplus {
    ...
    class __cClass; // C::__c$
    class __cObject; // C::__c
...
/* classes */
const uint32_t abcclass_C___c = 0;
const uint32_t abcclass_C_ctype___ctype = 1;
const uint32_t abcclass_C_errno___errno = 2;
const uint32_t abcclass_C_errno_ErrorNumber = 3;
const uint32_t abcclass_C_errno_CError = 4;
const uint32_t abcclass_C_limits___limits = 5;
const uint32_t abcclass_C_locale___locale = 6;
const uint32_t abcclass_C_signal___signal = 7;
const uint32_t abcclass_C_signal_sigval = 8;
const uint32_t abcclass_C_signal_siginfo_t = 9;
const uint32_t abcclass_C_stdio___stdio = 10;
const uint32_t abcclass_C_stdio_FILE = 11;
const uint32_t abcclass_C_stdio_fpos_t = 12;
const uint32_t abcclass_C_stdlib___stdlib = 13;
const uint32_t abcclass_C_stdlib_div_t = 14;
const uint32_t abcclass_C_stdlib_ldiv_t = 15;
const uint32_t abcclass_C_stdlib_lldiv_t = 16;
const uint32_t abcclass_C_time___time = 17;
const uint32_t abcclass_C_time_tm = 18;
const uint32_t abcclass_C_time_timespec = 19;
const uint32_t abcclass_C_time_itimerspec = 20;
const uint32_t abcclass_C_arpa_inet___inet = 21;
const uint32_t abcclass_C_dirent_DIR = 22;
const uint32_t abcclass_C_dirent_dirent = 23;
const uint32_t abcclass_C_fcntl___fcntl = 24;
const uint32_t abcclass_C_netdb___netdb = 25;
const uint32_t abcclass_C_netdb_hostent = 26;
const uint32_t abcclass_C_netdb_netent = 27;
const uint32_t abcclass_C_netdb_protoent = 28;
const uint32_t abcclass_C_netdb_servent = 29;
const uint32_t abcclass_C_netdb_addrinfo = 30;
const uint32_t abcclass_C_netdb_CEAIrror = 31;
const uint32_t abcclass_C_netinet___netinet = 32;
const uint32_t abcclass_C_netinet_in_addr = 33;
const uint32_t abcclass_C_netinet_sockaddr_in = 34;
const uint32_t abcclass_C_netinet_in6_addr = 35;
const uint32_t abcclass_C_netinet_sockaddr_in6 = 36;
const uint32_t abcclass_C_netinet_ipv6_mreq = 37;
const uint32_t abcclass_C_spawn_pid_t = 38;
const uint32_t abcclass_C_sys_select___select = 39;
const uint32_t abcclass_C_sys_select_timeval = 40;
const uint32_t abcclass_C_sys_select_fd_set = 41;
const uint32_t abcclass_C_sys_socket___socket = 42;
const uint32_t abcclass_C_sys_socket_sockaddr = 43;
const uint32_t abcclass_C_sys_socket_sockaddr_storage = 44;
const uint32_t abcclass_C_sys_socket_msghdr = 45;
const uint32_t abcclass_C_sys_stat___stat = 46;
const uint32_t abcclass_C_sys_stat_status = 47;
const uint32_t abcclass_C_sys_utsname_utsname = 48;
const uint32_t abcclass_C_sys_wait___wait = 49;
const uint32_t abcclass_C_sys_wait_wait_status = 50;
const uint32_t abcclass_C_unistd___unistd = 51;
const uint32_t abcclass_shell_Program = 52;
const uint32_t abcclass_shell_Runtime = 53;
const uint32_t abcclass_shell_Diagnostics = 54;
const uint32_t abcclass_shell_HardwareInformation = 55;
const uint32_t abcclass_shell_OperatingSystem = 56;
const uint32_t abcclass_shell_FileSystem = 57;
const uint32_t abcclass_shell_RunMode = 58;
const uint32_t abcclass_shell_ShellType = 59;
const uint32_t abcclass_shell_Cygwin = 60;
const uint32_t abcclass_shell_Domain = 61;
const uint32_t abcclass_shell_Environment = 62;
const uint32_t abcclass_shell_BinaryData = 63;
const uint32_t abcclass_shell_async_EventLoop = 64;
const uint32_t abcclass_flash_accessibility_ISearchableText = 65;
const uint32_t abcclass_flash_accessibility_ISimpleTextSelection = 66;
const uint32_t abcclass_flash_accessibility_Accessibility = 67;
const uint32_t abcclass_flash_accessibility_AccessibilityImplementation = 68;
const uint32_t abcclass_flash_accessibility_AccessibilityProperties = 69;
const uint32_t abcclass_flash_data_EncryptedLocalStore = 70;
const uint32_t abcclass_flash_data_SQLCollationType = 71;
const uint32_t abcclass_flash_data_SQLColumnNameStyle = 72;
const uint32_t abcclass_flash_data_SQLColumnSchema = 73;
const uint32_t abcclass_flash_data_SQLConnection = 74;
const uint32_t abcclass_flash_data_SQLIndexSchema = 75;
const uint32_t abcclass_flash_data_SQLMode = 76;
const uint32_t abcclass_flash_data_SQLResult = 77;
const uint32_t abcclass_flash_data_SQLSchema = 78;
const uint32_t abcclass_flash_data_SQLSchemaResult = 79;
const uint32_t abcclass_flash_data_SQLStatement = 80;
const uint32_t abcclass_flash_data_SQLTableSchema = 81;
const uint32_t abcclass_flash_data_SQLTransactionLockType = 82;
const uint32_t abcclass_flash_data_SQLTriggerSchema = 83;
const uint32_t abcclass_flash_data_SQLViewSchema = 84;
const uint32_t abcclass_flash_display_IBitmapDrawable = 85;
const uint32_t abcclass_flash_display_IDrawCommand = 86;
const uint32_t abcclass_flash_display_IGraphicsData = 87;
const uint32_t abcclass_flash_display_IGraphicsFill = 88;
const uint32_t abcclass_flash_display_IGraphicsPath = 89;
const uint32_t abcclass_flash_display_IGraphicsStroke = 90;
const uint32_t abcclass_flash_display_ActionScriptVersion = 91;
const uint32_t abcclass_flash_display_PixelSnapping = 92;
const uint32_t abcclass_flash_display_PNGEncoderOptions = 93;
const uint32_t abcclass_flash_display_Scene = 94;
const uint32_t abcclass_flash_display_StageAlign = 95;
const uint32_t abcclass_flash_display_StageAspectRatio = 96;
const uint32_t abcclass_flash_display_StageDisplayState = 97;
const uint32_t abcclass_flash_display_StageOrientation = 98;
const uint32_t abcclass_flash_display_StageQuality = 99;
const uint32_t abcclass_flash_display_StageScaleMode = 100;
const uint32_t abcclass_flash_display_SWFVersion = 101;
const uint32_t abcclass_flash_display_TriangleCulling = 102;
const uint32_t abcclass_flash_errors_ScriptTimeoutError = 103;
const uint32_t abcclass_flash_errors_StackOverflowError = 104;
const uint32_t abcclass_flash_errors_InvalidSWFError = 105;
const uint32_t abcclass_flash_errors_SQLErrorOperation = 106;
const uint32_t abcclass_flash_errors_SQLError = 107;
const uint32_t abcclass_flash_errors_DRMManagerError = 108;
const uint32_t abcclass_flash_events_IEventDispatcher = 109;
const uint32_t abcclass_flash_events_Event = 110;
const uint32_t abcclass_flash_filesystem_File = 111;
const uint32_t abcclass_flash_filesystem_FileMode = 112;
const uint32_t abcclass_flash_filesystem_FileStream = 113;
const uint32_t abcclass_flash_geom_Orientation3D = 114;
const uint32_t abcclass_flash_geom_Point = 115;
const uint32_t abcclass_flash_geom_Rectangle = 116;
const uint32_t abcclass_flash_net_FileReference = 117;
const uint32_t abcclass_flash_net_URLRequest = 118;
const uint32_t abcclass_flash_net_URLRequestDefaults = 119;
const uint32_t abcclass_flash_net_URLRequestHeader = 120;
const uint32_t abcclass_flash_sampler_StackFrame = 121;
const uint32_t abcclass_flash_sampler_Sample = 122;
const uint32_t abcclass_flash_sampler_ClassFactory = 123;
const uint32_t abcclass_flash_system_Capabilities = 124;
const uint32_t abcclass_flash_system_Security = 125;
const uint32_t abcclass_flash_system_SecurityPrivilege = 126;
const uint32_t abcclass_flash_system_System = 127;
const uint32_t abcclass_flash_system_WorkerState = 128;
const uint32_t abcclass_flash_system_Worker = 129;
const uint32_t abcclass_flash_system_WorkerEvent = 130;
const uint32_t abcclass_flash_system_WorkerDomain = 131;
const uint32_t abcclass_flash_trace_Trace = 132;
const uint32_t abcclass_flash_utils_Endian = 133;
const uint32_t abcclass_shell_async_CoreEventLoop = 134;
const uint32_t abcclass_flash_events_EventDispatcher = 135;
const uint32_t abcclass_flash_events_HTTPStatusEvent = 136;
const uint32_t abcclass_flash_events_TimerEvent = 137;
const uint32_t abcclass_flash_sampler_NewObjectSample = 138;
const uint32_t abcclass_flash_sampler_DeleteObjectSample = 139;
const uint32_t abcclass_flash_utils_Timer = 140;
...
const uint32_t native_script_function_C_unistd_ftruncate = 47; // native
const uint32_t native_script_function_C_unistd_fsync = 48; // native
const uint32_t native_script_function_C_unistd_execvp = 49; // native
const uint32_t native_script_function_C_unistd_execve = 50; // native
const uint32_t native_script_function_C_unistd_execv = 51; // native
const uint32_t native_script_function_C_unistd_execlp = 52; // native
const uint32_t native_script_function_C_unistd_execle = 53; // native
const uint32_t native_script_function_C_unistd_execl = 54; // native
const uint32_t native_script_function_C_unistd_dup2 = 55; // native
const uint32_t native_script_function_C_unistd_dup = 56; // native
const uint32_t native_script_function_C_unistd_close = 57; // native
const uint32_t native_script_function_C_unistd_chdir = 58; // native
const uint32_t native_script_function_C_unistd_access = 59; // native
const uint32_t native_script_function_C_sys_wait_waitpid = 60; // native
const uint32_t native_script_function_C_sys_wait_waitid = 61; // native
const uint32_t native_script_function_C_sys_wait_wait = 62; // native
const uint32_t native_script_function_C_sys_utsname_uname = 71; // native
const uint32_t native_script_function_C_sys_stat_umask = 72; // native
const uint32_t native_script_function_C_sys_stat_stat = 73; // native
const uint32_t native_script_function_C_sys_stat_fstat = 76; // native
const uint32_t native_script_function_C_sys_stat_chmod = 77; // native
const uint32_t native_script_function_C_sys_socket_socketpair = 85; // native
const uint32_t native_script_function_C_sys_socket_socket = 86; // native
const uint32_t native_script_function_C_sys_socket_sockatmark = 87; // native
const uint32_t native_script_function_C_sys_socket_shutdown = 88; // native
const uint32_t native_script_function_C_sys_socket_send = 93; // native
const uint32_t native_script_function_C_sys_socket_recv = 96; // native
const uint32_t native_script_function_C_sys_socket_listen = 97; // native
const uint32_t native_script_function_C_sys_select_isExceptional = 105; // native
const uint32_t native_script_function_C_sys_select_isWritable = 106; // native
const uint32_t native_script_function_C_sys_select_isReadable = 107; // native
const uint32_t native_script_function_C_sys_select_select = 108; // native
const uint32_t native_script_function_C_sys_select_FD_ZERO = 109; // native
const uint32_t native_script_function_C_sys_select_FD_SET = 110; // native
const uint32_t native_script_function_C_sys_select_FD_ISSET = 111; // native
const uint32_t native_script_function_C_sys_select_FD_CLR = 112; // native
const uint32_t native_script_function_C_spawn_spawnp = 113; // native
const uint32_t native_script_function_C_spawn_spawn = 114; // native
const uint32_t native_script_function_C_netdb_getprotoent = 143; // native
const uint32_t native_script_function_C_netdb_getprotobynumber = 144; // native
const uint32_t native_script_function_C_netdb_gethostent = 145; // native
const uint32_t native_script_function_C_netdb_gethostbyname = 146; // native
const uint32_t native_script_function_C_netdb_getaddrinfo = 148; // native
const uint32_t native_script_function_C_netdb_gai_strerror = 149; // native
const uint32_t native_script_function_C_fcntl_openat = 150; // native
const uint32_t native_script_function_C_fcntl_open = 151; // native
const uint32_t native_script_function_C_fcntl_fcntl = 152; // native
const uint32_t native_script_function_C_fcntl_creat = 153; // native
const uint32_t native_script_function_C_dirent_telldir = 154; // native
const uint32_t native_script_function_C_dirent_seekdir = 155; // native
const uint32_t native_script_function_C_dirent_rewinddir = 156; // native
const uint32_t native_script_function_C_dirent_readdir = 157; // native
const uint32_t native_script_function_C_dirent_opendir = 158; // native
const uint32_t native_script_function_C_dirent_fdopendir = 160; // native
const uint32_t native_script_function_C_dirent_dirfd = 161; // native
const uint32_t native_script_function_C_dirent_closedir = 162; // native
const uint32_t native_script_function_C_conio_set_binary_mode = 164; // native
...
const uint32_t C___c_getArgc = 284; // abc
const uint32_t C___c_getArgv = 285; // abc
const uint32_t C___c_getEnviron = 286; // abc
const uint32_t C_ctype___ctype__avm_isalnum = 289; // native
const uint32_t C_ctype___ctype__avm_isalpha = 290; // native
const uint32_t C_ctype___ctype__avm_isascii = 291; // native
const uint32_t C_ctype___ctype__avm_isblank = 292; // native
const uint32_t C_ctype___ctype__avm_iscntrl = 293; // native
const uint32_t C_ctype___ctype__avm_isdigit = 294; // native
const uint32_t C_ctype___ctype__avm_isgraph = 295; // native
const uint32_t C_ctype___ctype__avm_islower = 296; // native
const uint32_t C_ctype___ctype__avm_isprint = 297; // native
const uint32_t C_ctype___ctype__avm_ispunct = 298; // native
const uint32_t C_ctype___ctype__avm_isspace = 299; // native
const uint32_t C_ctype___ctype__avm_isupper = 300; // native
const uint32_t C_ctype___ctype__avm_isxdigit = 301; // native
const uint32_t C_ctype___ctype__avm_toascii = 302; // native
const uint32_t C_ctype___ctype__avm_tolower = 303; // native
const uint32_t C_ctype___ctype__avm_toupper = 304; // native
const uint32_t C_errno___errno_EPERM_get = 307; // native
const uint32_t C_errno___errno_ENOENT_get = 308; // native
const uint32_t C_errno___errno_ESRCH_get = 309; // native
const uint32_t C_errno___errno_EINTR_get = 310; // native
const uint32_t C_errno___errno_EIO_get = 311; // native
const uint32_t C_errno___errno_ENXIO_get = 312; // native
const uint32_t C_errno___errno_E2BIG_get = 313; // native
const uint32_t C_errno___errno_ENOEXEC_get = 314; // native
const uint32_t C_errno___errno_EBADF_get = 315; // native
const uint32_t C_errno___errno_ECHILD_get = 316; // native
const uint32_t C_errno___errno_EAGAIN_get = 317; // native
const uint32_t C_errno___errno_ENOMEM_get = 318; // native
const uint32_t C_errno___errno_EACCES_get = 319; // native
const uint32_t C_errno___errno_EFAULT_get = 320; // native
const uint32_t C_errno___errno_ENOTBLK_get = 321; // native
const uint32_t C_errno___errno_EBUSY_get = 322; // native
const uint32_t C_errno___errno_EEXIST_get = 323; // native
const uint32_t C_errno___errno_EXDEV_get = 324; // native
const uint32_t C_errno___errno_ENODEV_get = 325; // native
const uint32_t C_errno___errno_ENOTDIR_get = 326; // native
const uint32_t C_errno___errno_EISDIR_get = 327; // native
const uint32_t C_errno___errno_EINVAL_get = 328; // native
const uint32_t C_errno___errno_ENFILE_get = 329; // native
const uint32_t C_errno___errno_EMFILE_get = 330; // native
const uint32_t C_errno___errno_ENOTTY_get = 331; // native
const uint32_t C_errno___errno_ETXTBSY_get = 332; // native
const uint32_t C_errno___errno_EFBIG_get = 333; // native
const uint32_t C_errno___errno_ENOSPC_get = 334; // native
const uint32_t C_errno___errno_ESPIPE_get = 335; // native
const uint32_t C_errno___errno_EROFS_get = 336; // native
const uint32_t C_errno___errno_EMLINK_get = 337; // native
const uint32_t C_errno___errno_EPIPE_get = 338; // native
const uint32_t C_errno___errno_EDOM_get = 339; // native
const uint32_t C_errno___errno_ERANGE_get = 340; // native
const uint32_t C_errno___errno_EDEADLK_get = 341; // native
const uint32_t C_errno___errno_ENAMETOOLONG_get = 342; // native
const uint32_t C_errno___errno_ENOLCK_get = 343; // native
const uint32_t C_errno___errno_ENOSYS_get = 344; // native
const uint32_t C_errno___errno_ENOTEMPTY_get = 345; // native
const uint32_t C_errno___errno_ELOOP_get = 346; // native
const uint32_t C_errno___errno_EWOULDBLOCK_get = 347; // native
const uint32_t C_errno___errno_ENOMSG_get = 348; // native
const uint32_t C_errno___errno_EIDRM_get = 349; // native
const uint32_t C_errno___errno_EDEADLOCK_get = 350; // native
const uint32_t C_errno___errno_ENOSTR_get = 351; // native
const uint32_t C_errno___errno_ENODATA_get = 352; // native
const uint32_t C_errno___errno_ETIME_get = 353; // native
const uint32_t C_errno___errno_ENOSR_get = 354; // native
const uint32_t C_errno___errno_ENOLINK_get = 355; // native
const uint32_t C_errno___errno_EBADMSG_get = 356; // native
const uint32_t C_errno___errno_EOVERFLOW_get = 357; // native
const uint32_t C_errno___errno_EILSEQ_get = 358; // native
const uint32_t C_errno___errno_ENOTSOCK_get = 359; // native
const uint32_t C_errno___errno_EDESTADDRREQ_get = 360; // native
const uint32_t C_errno___errno_EMSGSIZE_get = 361; // native
const uint32_t C_errno___errno_EPROTO_get = 362; // native
const uint32_t C_errno___errno_EPROTOTYPE_get = 363; // native
const uint32_t C_errno___errno_ENOPROTOOPT_get = 364; // native
const uint32_t C_errno___errno_EPROTONOSUPPORT_get = 365; // native
const uint32_t C_errno___errno_EOPNOTSUPP_get = 366; // native
const uint32_t C_errno___errno_EAFNOSUPPORT_get = 367; // native
const uint32_t C_errno___errno_EADDRINUSE_get = 368; // native
const uint32_t C_errno___errno_EADDRNOTAVAIL_get = 369; // native
const uint32_t C_errno___errno_ENETDOWN_get = 370; // native
const uint32_t C_errno___errno_ENETUNREACH_get = 371; // native
const uint32_t C_errno___errno_ENETRESET_get = 372; // native
const uint32_t C_errno___errno_ECONNABORTED_get = 373; // native
const uint32_t C_errno___errno_ECONNRESET_get = 374; // native
const uint32_t C_errno___errno_ENOBUFS_get = 375; // native
const uint32_t C_errno___errno_EISCONN_get = 376; // native
const uint32_t C_errno___errno_ENOTCONN_get = 377; // native
const uint32_t C_errno___errno_ETIMEDOUT_get = 378; // native
const uint32_t C_errno___errno_ECONNREFUSED_get = 379; // native
const uint32_t C_errno___errno_EHOSTUNREACH_get = 380; // native
const uint32_t C_errno___errno_EALREADY_get = 381; // native
const uint32_t C_errno___errno_EINPROGRESS_get = 382; // native
const uint32_t C_errno___errno_ECANCELED_get = 383; // native
const uint32_t C_errno___errno_EOWNERDEAD_get = 384; // native
const uint32_t C_errno___errno_ENOTRECOVERABLE_get = 385; // native
const uint32_t C_errno___errno_EREMOTE_get = 386; // native
const uint32_t C_errno___errno_EUSERS_get = 387; // native
const uint32_t C_errno___errno_ESOCKTNOSUPPORT_get = 388; // native
const uint32_t C_errno___errno_EPFNOSUPPORT_get = 389; // native
const uint32_t C_errno___errno_ESHUTDOWN_get = 390; // native
const uint32_t C_errno___errno_ETOOMANYREFS_get = 391; // native
const uint32_t C_errno___errno_EHOSTDOWN_get = 392; // native
const uint32_t C_errno___errno_ESTALE_get = 393; // native
const uint32_t C_errno___errno_EDQUOT_get = 394; // native
const uint32_t C_errno___errno_EMULTIHOP_get = 395; // native
const uint32_t C_errno___errno_ECHRNG_get = 396; // native
const uint32_t C_errno___errno_EL2NSYNC_get = 397; // native
const uint32_t C_errno___errno_EL3HLT_get = 398; // native
const uint32_t C_errno___errno_EL3RST_get = 399; // native
const uint32_t C_errno___errno_ELNRNG_get = 400; // native
const uint32_t C_errno___errno_EUNATCH_get = 401; // native
const uint32_t C_errno___errno_ENOCSI_get = 402; // native
const uint32_t C_errno___errno_EL2HLT_get = 403; // native
const uint32_t C_errno___errno_EBADE_get = 404; // native
const uint32_t C_errno___errno_EBADR_get = 405; // native
const uint32_t C_errno___errno_EXFULL_get = 406; // native
const uint32_t C_errno___errno_ENOANO_get = 407; // native
const uint32_t C_errno___errno_EBADRQC_get = 408; // native
const uint32_t C_errno___errno_EBADSLT_get = 409; // native
const uint32_t C_errno___errno_EBFONT_get = 410; // native
const uint32_t C_errno___errno_ENONET_get = 411; // native
const uint32_t C_errno___errno_ENOPKG_get = 412; // native
const uint32_t C_errno___errno_EADV_get = 413; // native
const uint32_t C_errno___errno_ESRMNT_get = 414; // native
const uint32_t C_errno___errno_ECOMM_get = 415; // native
const uint32_t C_errno___errno_EDOTDOT_get = 416; // native
const uint32_t C_errno___errno_ENOTUNIQ_get = 417; // native
const uint32_t C_errno___errno_EBADFD_get = 418; // native
const uint32_t C_errno___errno_EREMCHG_get = 419; // native
const uint32_t C_errno___errno_ELIBACC_get = 420; // native
const uint32_t C_errno___errno_ELIBBAD_get = 421; // native
const uint32_t C_errno___errno_ELIBSCN_get = 422; // native
const uint32_t C_errno___errno_ELIBMAX_get = 423; // native
const uint32_t C_errno___errno_ELIBEXEC_get = 424; // native
const uint32_t C_errno___errno_ERESTART_get = 425; // native
const uint32_t C_errno___errno_ESTRPIPE_get = 426; // native
const uint32_t C_errno___errno_EUCLEAN_get = 427; // native
const uint32_t C_errno___errno_ENOTNAM_get = 428; // native
const uint32_t C_errno___errno_ENAVAIL_get = 429; // native
const uint32_t C_errno___errno_EISNAM_get = 430; // native
const uint32_t C_errno___errno_EREMOTEIO_get = 431; // native
const uint32_t C_errno___errno_ENOMEDIUM_get = 432; // native
const uint32_t C_errno___errno_EMEDIUMTYPE_get = 433; // native
const uint32_t C_errno___errno_ENOKEY_get = 434; // native
const uint32_t C_errno___errno_EKEYEXPIRED_get = 435; // native
const uint32_t C_errno___errno_EKEYREVOKED_get = 436; // native
const uint32_t C_errno___errno_EKEYREJECTED_get = 437; // native
const uint32_t C_errno___errno_ERFKILL_get = 438; // native
const uint32_t C_errno___errno_EHWPOISON_get = 439; // native
const uint32_t C_errno___errno__GetErrno = 440; // native
const uint32_t C_errno___errno__SetErrno = 441; // native
const uint32_t C_errno_ErrorNumber_value_get = 445; // abc
const uint32_t C_errno_ErrorNumber_value_set = 446; // abc
const uint32_t C_errno_ErrorNumber_valueOf = 447; // abc
const uint32_t C_errno_ErrorNumber_toString = 448; // abc
const uint32_t C_errno_ErrorNumber_toErrnoString = 449; // abc
const uint32_t C_errno_CError_errorID_get = 452; // abc
const uint32_t C_errno_CError_apply = 453; // abc
const uint32_t C_errno_CError_toString = 454; // abc
const uint32_t C_limits___limits_CHAR_BIT_get = 456; // native
const uint32_t C_limits___limits_CHAR_MAX_get = 457; // native
const uint32_t C_limits___limits_CHAR_MIN_get = 458; // native
const uint32_t C_limits___limits_INT_MAX_get = 459; // native
const uint32_t C_limits___limits_INT_MIN_get = 460; // native
const uint32_t C_limits___limits_LLONG_MAX_get = 461; // native
const uint32_t C_limits___limits_LLONG_MIN_get = 462; // native
const uint32_t C_limits___limits_LONG_BIT_get = 463; // native
const uint32_t C_limits___limits_LONG_MAX_get = 464; // native
const uint32_t C_limits___limits_LONG_MIN_get = 465; // native
const uint32_t C_limits___limits_SCHAR_MAX_get = 466; // native
const uint32_t C_limits___limits_SCHAR_MIN_get = 467; // native
const uint32_t C_limits___limits_SHRT_MAX_get = 468; // native
const uint32_t C_limits___limits_SHRT_MIN_get = 469; // native
const uint32_t C_limits___limits_UCHAR_MAX_get = 470; // native
const uint32_t C_limits___limits_UINT_MAX_get = 471; // native
const uint32_t C_limits___limits_ULLONG_MAX_get = 472; // native
const uint32_t C_limits___limits_ULONG_MAX_get = 473; // native
const uint32_t C_limits___limits_USHRT_MAX_get = 474; // native
const uint32_t C_limits___limits_WORD_BIT_get = 475; // native
const uint32_t C_limits___limits_ARG_MAX_get = 476; // native
const uint32_t C_limits___limits_ATEXIT_MAX_get = 477; // native
const uint32_t C_limits___limits_CHILD_MAX_get = 478; // native
const uint32_t C_limits___limits_LINK_MAX_get = 479; // native
const uint32_t C_limits___limits_MAX_CANON_get = 480; // native
const uint32_t C_limits___limits_MAX_INPUT_get = 481; // native
const uint32_t C_limits___limits_NAME_MAX_get = 482; // native
const uint32_t C_limits___limits_NGROUPS_MAX_get = 483; // native
const uint32_t C_limits___limits_OPEN_MAX_get = 484; // native
const uint32_t C_limits___limits_PATH_MAX_get = 485; // native
const uint32_t C_limits___limits_PIPE_BUF_get = 486; // native
const uint32_t C_limits___limits_SSIZE_MAX_get = 487; // native
const uint32_t C_limits___limits_STREAM_MAX_get = 488; // native
const uint32_t C_limits___limits_TZNAME_MAX_get = 489; // native
const uint32_t C_limits___limits_MB_LEN_MAX_get = 490; // native
const uint32_t C_limits___limits_SIZE_MAX_get = 491; // native
const uint32_t C_limits___limits_SYMLINK_MAX_get = 492; // native
const uint32_t C_limits___limits_AIO_LISTIO_MAX_get = 493; // native
const uint32_t C_limits___limits_AIO_MAX_get = 494; // native
const uint32_t C_limits___limits_AIO_PRIO_DELTA_MAX_get = 495; // native
const uint32_t C_limits___limits_DELAYTIMER_MAX_get = 496; // native
const uint32_t C_limits___limits_HOST_NAME_MAX_get = 497; // native
const uint32_t C_limits___limits_LOGIN_NAME_MAX_get = 498; // native
const uint32_t C_limits___limits_MQ_OPEN_MAX_get = 499; // native
const uint32_t C_limits___limits_MQ_PRIO_MAX_get = 500; // native
const uint32_t C_limits___limits_PAGESIZE_get = 501; // native
const uint32_t C_limits___limits_PAGE_SIZE_get = 502; // native
const uint32_t C_limits___limits_RE_DUP_MAX_get = 503; // native
const uint32_t C_limits___limits_RTSIG_MAX_get = 504; // native
const uint32_t C_limits___limits_SEM_NSEMS_MAX_get = 505; // native
const uint32_t C_limits___limits_SEM_VALUE_MAX_get = 506; // native
const uint32_t C_limits___limits_SIGQUEUE_MAX_get = 507; // native
const uint32_t C_limits___limits_SS_REPL_MAX_get = 508; // native
const uint32_t C_limits___limits_SYMLOOP_MAX_get = 509; // native
const uint32_t C_limits___limits_TIMER_MAX_get = 510; // native
const uint32_t C_limits___limits_TRACE_EVENT_NAME_MAX_get = 511; // native
const uint32_t C_limits___limits_TRACE_NAME_MAX_get = 512; // native
const uint32_t C_limits___limits_TRACE_SYS_MAX_get = 513; // native
const uint32_t C_limits___limits_TRACE_USER_EVENT_MAX_get = 514; // native
const uint32_t C_limits___limits_TTY_NAME_MAX_get = 515; // native
const uint32_t C_limits___limits__POSIX_ARG_MAX_get = 516; // native
const uint32_t C_limits___limits__POSIX_CHILD_MAX_get = 517; // native
const uint32_t C_limits___limits__POSIX_LINK_MAX_get = 518; // native
const uint32_t C_limits___limits__POSIX_MAX_CANON_get = 519; // native
const uint32_t C_limits___limits__POSIX_MAX_INPUT_get = 520; // native
const uint32_t C_limits___limits__POSIX_NAME_MAX_get = 521; // native
const uint32_t C_limits___limits__POSIX_NGROUPS_MAX_get = 522; // native
const uint32_t C_limits___limits__POSIX_OPEN_MAX_get = 523; // native
const uint32_t C_limits___limits__POSIX_PATH_MAX_get = 524; // native
const uint32_t C_limits___limits__POSIX_PIPE_BUF_get = 525; // native
const uint32_t C_limits___limits__POSIX_SSIZE_MAX_get = 526; // native
const uint32_t C_limits___limits__POSIX_STREAM_MAX_get = 527; // native
const uint32_t C_limits___limits__POSIX_TZNAME_MAX_get = 528; // native
const uint32_t C_limits___limits__POSIX_SYMLINK_MAX_get = 529; // native
const uint32_t C_limits___limits__POSIX_AIO_LISTIO_MAX_get = 530; // native
const uint32_t C_limits___limits__POSIX_AIO_MAX_get = 531; // native
const uint32_t C_limits___limits__POSIX_DELAYTIMER_MAX_get = 532; // native
const uint32_t C_limits___limits__POSIX_HOST_NAME_MAX_get = 533; // native
const uint32_t C_limits___limits__POSIX_LOGIN_NAME_MAX_get = 534; // native
const uint32_t C_limits___limits__POSIX_MQ_OPEN_MAX_get = 535; // native
const uint32_t C_limits___limits__POSIX_MQ_PRIO_MAX_get = 536; // native
const uint32_t C_limits___limits__POSIX_RE_DUP_MAX_get = 537; // native
const uint32_t C_limits___limits__POSIX_RTSIG_MAX_get = 538; // native
const uint32_t C_limits___limits__POSIX_SEM_NSEMS_MAX_get = 539; // native
const uint32_t C_limits___limits__POSIX_SEM_VALUE_MAX_get = 540; // native
const uint32_t C_limits___limits__POSIX_SIGQUEUE_MAX_get = 541; // native
const uint32_t C_limits___limits__POSIX_SS_REPL_MAX_get = 542; // native
const uint32_t C_limits___limits__POSIX_SYMLOOP_MAX_get = 543; // native
const uint32_t C_limits___limits__POSIX_TIMER_MAX_get = 544; // native
const uint32_t C_limits___limits__POSIX_TRACE_EVENT_NAME_MAX_get = 545; // native
const uint32_t C_limits___limits__POSIX_TRACE_NAME_MAX_get = 546; // native
const uint32_t C_limits___limits__POSIX_TRACE_SYS_MAX_get = 547; // native
const uint32_t C_limits___limits__POSIX_TRACE_USER_EVENT_MAX_get = 548; // native
const uint32_t C_limits___limits__POSIX_TTY_NAME_MAX_get = 549; // native
const uint32_t C_locale___locale_LC_ALL_get = 552; // native
const uint32_t C_signal___signal_SIGEV_NONE_get = 555; // native
const uint32_t C_signal___signal_SIGEV_SIGNAL_get = 556; // native
const uint32_t C_signal___signal_SIGEV_THREAD_get = 557; // native
const uint32_t C_stdio___stdio_BUFSIZ_get = 564; // native
const uint32_t C_stdio___stdio__IOFBF_get = 565; // native
const uint32_t C_stdio___stdio__IOLBF_get = 566; // native
const uint32_t C_stdio___stdio__IONBF_get = 567; // native
const uint32_t C_stdio___stdio_SEEK_CUR_get = 568; // native
const uint32_t C_stdio___stdio_SEEK_END_get = 569; // native
const uint32_t C_stdio___stdio_SEEK_SET_get = 570; // native
const uint32_t C_stdio___stdio_FILENAME_MAX_get = 571; // native
const uint32_t C_stdio___stdio_FOPEN_MAX_get = 572; // native
const uint32_t C_stdio___stdio_TMP_MAX_get = 573; // native
const uint32_t C_stdio___stdio_EOF_get = 574; // native
const uint32_t C_stdio___stdio_stdin_get = 575; // native
const uint32_t C_stdio___stdio_stdout_get = 576; // native
const uint32_t C_stdio___stdio_stderr_get = 577; // native
const uint32_t C_stdio___stdio__getc = 578; // native
const uint32_t C_stdio___stdio__getc_unlocked = 579; // native
const uint32_t C_stdio___stdio__getchar_unlocked = 580; // native
const uint32_t C_stdlib___stdlib_EXIT_SUCCESS_get = 587; // native
const uint32_t C_stdlib___stdlib_EXIT_FAILURE_get = 588; // native
const uint32_t C_stdlib___stdlib_RAND_MAX_get = 589; // native
const uint32_t C_stdlib___stdlib_MB_CUR_MAX_get = 590; // native
const uint32_t C_stdlib___stdlib__str2num = 591; // abc
const uint32_t C_stdlib___stdlib__str2int = 592; // abc
const uint32_t C_stdlib___stdlib__str2uint = 593; // abc
const uint32_t C_stdlib_div_t_toString = 597; // abc
const uint32_t C_stdlib_ldiv_t_toString = 600; // abc
const uint32_t C_stdlib_lldiv_t_toString = 603; // abc
const uint32_t C_time___time_CLOCKS_PER_SEC_get = 605; // native
const uint32_t C_arpa_inet___inet__htonl = 614; // native
const uint32_t C_arpa_inet___inet__htons = 615; // native
const uint32_t C_arpa_inet___inet__ntohl = 616; // native
const uint32_t C_arpa_inet___inet__ntohs = 617; // native
const uint32_t C_arpa_inet___inet__inet_addr = 618; // native
const uint32_t C_arpa_inet___inet__inet_network = 619; // native
const uint32_t C_arpa_inet___inet__inet_ntoa = 620; // native
const uint32_t C_arpa_inet___inet__inet_aton = 621; // native
const uint32_t C_arpa_inet___inet__inet_ntop4 = 622; // native
const uint32_t C_arpa_inet___inet__inet_ntop6 = 623; // native
const uint32_t C_arpa_inet___inet__inet_pton4 = 624; // native
const uint32_t C_arpa_inet___inet__inet_pton6 = 625; // native
const uint32_t C_fcntl___fcntl_O_RDONLY_get = 632; // native
const uint32_t C_fcntl___fcntl_O_WRONLY_get = 633; // native
const uint32_t C_fcntl___fcntl_O_RDWR_get = 634; // native
const uint32_t C_fcntl___fcntl_O_ACCMODE_get = 635; // native
const uint32_t C_fcntl___fcntl_O_APPEND_get = 636; // native
const uint32_t C_fcntl___fcntl_O_CREAT_get = 637; // native
const uint32_t C_fcntl___fcntl_O_TRUNC_get = 638; // native
const uint32_t C_fcntl___fcntl_O_EXCL_get = 639; // native
const uint32_t C_fcntl___fcntl_O_EXEC_get = 640; // native
const uint32_t C_fcntl___fcntl_O_CLOEXEC_get = 641; // native
const uint32_t C_fcntl___fcntl_O_DIRECTORY_get = 642; // native
const uint32_t C_fcntl___fcntl_O_NOFOLLOW_get = 643; // native
const uint32_t C_fcntl___fcntl_O_NONBLOCK_get = 644; // native
const uint32_t C_fcntl___fcntl_O_NOCTTY_get = 645; // native
const uint32_t C_fcntl___fcntl_O_SEARCH_get = 646; // native
const uint32_t C_fcntl___fcntl_O_TTY_INIT_get = 647; // native
const uint32_t C_fcntl___fcntl_O_SYNC_get = 648; // native
const uint32_t C_fcntl___fcntl_O_DSYNC_get = 649; // native
const uint32_t C_fcntl___fcntl_O_RSYNC_get = 650; // native
const uint32_t C_fcntl___fcntl_O_ASYNC_get = 651; // native
const uint32_t C_fcntl___fcntl_O_FSYNC_get = 652; // native
const uint32_t C_fcntl___fcntl_O_SHLOCK_get = 653; // native
const uint32_t C_fcntl___fcntl_O_EXLOCK_get = 654; // native
const uint32_t C_fcntl___fcntl_O_TEXT_get = 655; // native
const uint32_t C_fcntl___fcntl_O_BINARY_get = 656; // native
const uint32_t C_fcntl___fcntl_O_WTEXT_get = 657; // native
const uint32_t C_fcntl___fcntl_O_U16TEXT_get = 658; // native
const uint32_t C_fcntl___fcntl_O_U8TEXT_get = 659; // native
const uint32_t C_fcntl___fcntl_O_RAW_get = 660; // native
const uint32_t C_fcntl___fcntl_O_NOINHERIT_get = 661; // native
const uint32_t C_fcntl___fcntl_O_TEMPORARY_get = 662; // native
const uint32_t C_fcntl___fcntl_O_SHORT_LIVED_get = 663; // native
const uint32_t C_fcntl___fcntl_O_SEQUENTIAL_get = 664; // native
const uint32_t C_fcntl___fcntl_O_RANDOM_get = 665; // native
const uint32_t C_fcntl___fcntl_F_DUPFD_get = 666; // native
const uint32_t C_fcntl___fcntl_F_DUPFD_CLOEXEC_get = 667; // native
const uint32_t C_fcntl___fcntl_F_GETFD_get = 668; // native
const uint32_t C_fcntl___fcntl_F_SETFD_get = 669; // native
const uint32_t C_fcntl___fcntl_F_GETFL_get = 670; // native
const uint32_t C_fcntl___fcntl_F_SETFL_get = 671; // native
const uint32_t C_fcntl___fcntl_F_GETOWN_get = 672; // native
const uint32_t C_fcntl___fcntl_F_SETOWN_get = 673; // native
const uint32_t C_netdb___netdb_AI_PASSIVE_get = 676; // native
const uint32_t C_netdb___netdb_AI_CANONNAME_get = 677; // native
const uint32_t C_netdb___netdb_AI_NUMERICHOST_get = 678; // native
const uint32_t C_netdb___netdb_AI_NUMERICSERV_get = 679; // native
const uint32_t C_netdb___netdb_AI_V4MAPPED_get = 680; // native
const uint32_t C_netdb___netdb_AI_ALL_get = 681; // native
const uint32_t C_netdb___netdb_AI_ADDRCONFIG_get = 682; // native
const uint32_t C_netdb___netdb_NI_NOFQDN_get = 683; // native
const uint32_t C_netdb___netdb_NI_NUMERICHOST_get = 684; // native
const uint32_t C_netdb___netdb_NI_NAMEREQD_get = 685; // native
const uint32_t C_netdb___netdb_NI_NUMERICSERV_get = 686; // native
const uint32_t C_netdb___netdb_NI_NUMERICSCOPE_get = 687; // native
const uint32_t C_netdb___netdb_NI_DGRAM_get = 688; // native
const uint32_t C_netdb___netdb_EAI_AGAIN_get = 689; // native
const uint32_t C_netdb___netdb_EAI_BADFLAGS_get = 690; // native
const uint32_t C_netdb___netdb_EAI_FAIL_get = 691; // native
const uint32_t C_netdb___netdb_EAI_FAMILY_get = 692; // native
const uint32_t C_netdb___netdb_EAI_MEMORY_get = 693; // native
const uint32_t C_netdb___netdb_EAI_NONAME_get = 694; // native
const uint32_t C_netdb___netdb_EAI_SERVICE_get = 695; // native
const uint32_t C_netdb___netdb_EAI_SOCKTYPE_get = 696; // native
const uint32_t C_netdb___netdb_EAI_SYSTEM_get = 697; // native
const uint32_t C_netdb___netdb_EAI_OVERFLOW_get = 698; // native
const uint32_t C_netdb___netdb_gethostbyaddr4 = 699; // native
const uint32_t C_netdb___netdb_gethostbyaddr6 = 700; // native
const uint32_t C_netdb_hostent_h_addr_get = 704; // abc
const uint32_t C_netdb_hostent_toString = 705; // abc
const uint32_t C_netdb_protoent_toString = 709; // abc
const uint32_t C_netdb_addrinfo_toString = 715; // abc
const uint32_t C_netdb_CEAIrror_errorID_get = 718; // abc
const uint32_t C_netdb_CEAIrror_apply = 719; // abc
const uint32_t C_netdb_CEAIrror_toString = 720; // abc
const uint32_t C_netinet___netinet_IPPROTO_IP_get = 722; // native
const uint32_t C_netinet___netinet_IPPROTO_IPV6_get = 723; // native
const uint32_t C_netinet___netinet_IPPROTO_ICMP_get = 724; // native
const uint32_t C_netinet___netinet_IPPROTO_RAW_get = 725; // native
const uint32_t C_netinet___netinet_IPPROTO_TCP_get = 726; // native
const uint32_t C_netinet___netinet_IPPROTO_UDP_get = 727; // native
const uint32_t C_netinet___netinet_INET_ADDRSTRLEN_get = 728; // native
const uint32_t C_netinet___netinet_INET6_ADDRSTRLEN_get = 729; // native
const uint32_t C_netinet___netinet_IPV6_JOIN_GROUP_get = 730; // native
const uint32_t C_netinet___netinet_IPV6_LEAVE_GROUP_get = 731; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_HOPS_get = 732; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_IF_get = 733; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_LOOP_get = 734; // native
const uint32_t C_netinet___netinet_IPV6_UNICAST_HOPS_get = 735; // native
const uint32_t C_netinet___netinet_IPV6_V6ONLY_get = 736; // native
const uint32_t C_netinet_in_addr_private__tohex = 740; // abc
const uint32_t C_netinet_in_addr_isValid = 741; // abc
const uint32_t C_netinet_in_addr_toString = 742; // abc
const uint32_t C_netinet_sockaddr_in_toString = 745; // abc
const uint32_t C_netinet_in6_addr_fromArray = 747; // abc
const uint32_t C_netinet_in6_addr_fromVarArgs = 748; // abc
const uint32_t C_netinet_in6_addr_private__tohex = 750; // abc
const uint32_t C_netinet_in6_addr_isValid = 751; // abc
const uint32_t C_netinet_in6_addr_toString = 752; // abc
const uint32_t C_netinet_sockaddr_in6_toString = 755; // abc
const uint32_t C_spawn_pid_t_valueOf = 759; // abc
const uint32_t C_spawn_pid_t_toString = 760; // abc
const uint32_t C_sys_select___select_FD_SETSIZE_get = 763; // native
const uint32_t C_sys_select_timeval_toString = 767; // abc
const uint32_t C_sys_socket___socket_SOCK_DGRAM_get = 771; // native
const uint32_t C_sys_socket___socket_SOCK_RAW_get = 772; // native
const uint32_t C_sys_socket___socket_SOCK_SEQPACKET_get = 773; // native
const uint32_t C_sys_socket___socket_SOCK_STREAM_get = 774; // native
const uint32_t C_sys_socket___socket_SOL_SOCKET_get = 775; // native
const uint32_t C_sys_socket___socket_SO_ACCEPTCONN_get = 776; // native
const uint32_t C_sys_socket___socket_SO_BROADCAST_get = 777; // native
const uint32_t C_sys_socket___socket_SO_DEBUG_get = 778; // native
const uint32_t C_sys_socket___socket_SO_DONTROUTE_get = 779; // native
const uint32_t C_sys_socket___socket_SO_ERROR_get = 780; // native
const uint32_t C_sys_socket___socket_SO_KEEPALIVE_get = 781; // native
const uint32_t C_sys_socket___socket_SO_LINGER_get = 782; // native
const uint32_t C_sys_socket___socket_SO_OOBINLINE_get = 783; // native
const uint32_t C_sys_socket___socket_SO_RCVBUF_get = 784; // native
const uint32_t C_sys_socket___socket_SO_RCVLOWAT_get = 785; // native
const uint32_t C_sys_socket___socket_SO_RCVTIMEO_get = 786; // native
const uint32_t C_sys_socket___socket_SO_REUSEADDR_get = 787; // native
const uint32_t C_sys_socket___socket_SO_SNDBUF_get = 788; // native
const uint32_t C_sys_socket___socket_SO_SNDLOWAT_get = 789; // native
const uint32_t C_sys_socket___socket_SO_SNDTIMEO_get = 790; // native
const uint32_t C_sys_socket___socket_SO_TYPE_get = 791; // native
const uint32_t C_sys_socket___socket_SOMAXCONN_get = 792; // native
const uint32_t C_sys_socket___socket_MSG_CTRUNC_get = 793; // native
const uint32_t C_sys_socket___socket_MSG_DONTROUTE_get = 794; // native
const uint32_t C_sys_socket___socket_MSG_EOR_get = 795; // native
const uint32_t C_sys_socket___socket_MSG_OOB_get = 796; // native
const uint32_t C_sys_socket___socket_MSG_NOSIGNAL_get = 797; // native
const uint32_t C_sys_socket___socket_MSG_PEEK_get = 798; // native
const uint32_t C_sys_socket___socket_MSG_TRUNC_get = 799; // native
const uint32_t C_sys_socket___socket_MSG_WAITALL_get = 800; // native
const uint32_t C_sys_socket___socket_AF_INET_get = 801; // native
const uint32_t C_sys_socket___socket_AF_INET6_get = 802; // native
const uint32_t C_sys_socket___socket_AF_UNIX_get = 803; // native
const uint32_t C_sys_socket___socket_AF_UNSPEC_get = 804; // native
const uint32_t C_sys_socket___socket_SHUT_RD_get = 805; // native
const uint32_t C_sys_socket___socket_SHUT_RDWR_get = 806; // native
const uint32_t C_sys_socket___socket_SHUT_WR_get = 807; // native
const uint32_t C_sys_socket___socket_accept4 = 808; // native
const uint32_t C_sys_socket___socket_accept6 = 809; // native
const uint32_t C_sys_socket___socket_bind4 = 810; // native
const uint32_t C_sys_socket___socket_bind6 = 811; // native
const uint32_t C_sys_socket___socket_connect4 = 812; // native
const uint32_t C_sys_socket___socket_connect6 = 813; // native
const uint32_t C_sys_socket___socket_getpeername4 = 814; // native
const uint32_t C_sys_socket___socket_getpeername6 = 815; // native
const uint32_t C_sys_socket___socket_getsockname4 = 816; // native
const uint32_t C_sys_socket___socket_getsockname6 = 817; // native
const uint32_t C_sys_socket___socket_getsockoptint = 818; // native
const uint32_t C_sys_socket___socket_recvfrom4 = 819; // native
const uint32_t C_sys_socket___socket_recvfrom6 = 820; // native
const uint32_t C_sys_socket___socket_sendto4 = 821; // native
const uint32_t C_sys_socket___socket_sendto6 = 822; // native
const uint32_t C_sys_socket___socket_setsockoptint = 823; // native
const uint32_t C_sys_socket_sockaddr_private__load = 827; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_storage = 828; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_in = 829; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_in6 = 830; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr = 831; // abc
const uint32_t C_sys_stat___stat_mkdir = 837; // native
const uint32_t C_sys_stat_status_toString = 840; // abc
const uint32_t C_sys_wait___wait_WCONTINUED_get = 845; // native
const uint32_t C_sys_wait___wait_WNOHANG_get = 846; // native
const uint32_t C_sys_wait___wait_WUNTRACED_get = 847; // native
const uint32_t C_sys_wait___wait_WEXITED_get = 848; // native
const uint32_t C_sys_wait___wait_WNOWAIT_get = 849; // native
const uint32_t C_sys_wait___wait_WSTOPPED_get = 850; // native
const uint32_t C_sys_wait___wait_P_ALL_get = 851; // native
const uint32_t C_sys_wait___wait_P_PGID_get = 852; // native
const uint32_t C_sys_wait___wait_P_PID_get = 853; // native
const uint32_t C_sys_wait___wait__WEXITSTATUS = 854; // native
const uint32_t C_sys_wait___wait__WIFCONTINUED = 855; // native
const uint32_t C_sys_wait___wait__WIFEXITED = 856; // native
const uint32_t C_sys_wait___wait__WIFSIGNALED = 857; // native
const uint32_t C_sys_wait___wait__WIFSTOPPED = 858; // native
const uint32_t C_sys_wait___wait__WSTOPSIG = 859; // native
const uint32_t C_sys_wait___wait__WTERMSIG = 860; // native
const uint32_t C_unistd___unistd_F_OK_get = 865; // native
const uint32_t C_unistd___unistd_X_OK_get = 866; // native
const uint32_t C_unistd___unistd_W_OK_get = 867; // native
const uint32_t C_unistd___unistd_R_OK_get = 868; // native
const uint32_t C_unistd___unistd_getcwd = 869; // native
const uint32_t C_unistd___unistd_gethostname = 870; // native
const uint32_t C_unistd___unistd_getlogin = 871; // native
const uint32_t C_unistd___unistd_getpid = 872; // native
const uint32_t C_unistd___unistd_rmdir = 873; // native
const uint32_t C_unistd___unistd_sleep = 874; // native
const uint32_t C_unistd___unistd_unlink = 875; // native
const uint32_t shell_Program_private__getArgv = 878; // native
const uint32_t shell_Program_private__getEnviron = 879; // native
const uint32_t shell_Program_private__getProgramFilename = 880; // native
const uint32_t shell_Program_private__isProjector = 881; // native
const uint32_t shell_Program_private__setExitListener = 882; // native
const uint32_t shell_Program_private__popenRead = 883; // native
const uint32_t shell_Program_private__findShell = 884; // abc
const uint32_t shell_Program_private__findType = 885; // abc
const uint32_t shell_Program_totalMemory_get = 886; // native
const uint32_t shell_Program_freeMemory_get = 887; // native
const uint32_t shell_Program_privateMemory_get = 888; // native
const uint32_t shell_Program_environ_get = 889; // abc
const uint32_t shell_Program_environment_get = 890; // abc
const uint32_t shell_Program_filename_get = 891; // abc
const uint32_t shell_Program_pid_get = 892; // abc
const uint32_t shell_Program_shell_get = 893; // abc
const uint32_t shell_Program_type_get = 894; // abc
const uint32_t shell_Program_workingDirectory_get = 895; // abc
const uint32_t shell_Program_workingDirectory_set = 896; // abc
const uint32_t shell_Program_atExit = 897; // abc
const uint32_t shell_Program_AVM2_setExitListener = 898; // abc
const uint32_t shell_Program_AVM2_selfCheck = 899; // abc
const uint32_t shell_Program_abort = 900; // native
const uint32_t shell_Program_exec = 901; // native
const uint32_t shell_Program_exit = 902; // native
const uint32_t shell_Program_open = 903; // abc
const uint32_t shell_Program_sleep = 904; // native
const uint32_t shell_Program_getNanosecondTimer = 905; // native
const uint32_t shell_Program_getTimer = 906; // native
const uint32_t shell_Program_readLine = 907; // native
const uint32_t shell_Program_write = 908; // native
const uint32_t shell_Program_writeLine = 909; // abc
const uint32_t shell_Program_trace = 910; // native
const uint32_t shell_Program_forceFullCollection = 911; // native
const uint32_t shell_Program_queueCollection = 912; // native
const uint32_t shell_Program_pauseForGCIfCollectionImminent = 913; // native
const uint32_t shell_Program_disposeXML = 914; // native
const uint32_t shell_Runtime_private__getAvmplusPlatform = 917; // native
const uint32_t shell_Runtime_private__getAvmplusArchitecture = 918; // native
const uint32_t shell_Runtime_private__getAvmplusVersion = 919; // native
const uint32_t shell_Runtime_private__getAvmplusDescription = 920; // native
const uint32_t shell_Runtime_private__getFeatures = 921; // native
const uint32_t shell_Runtime_private__getRunmode = 922; // native
const uint32_t shell_Runtime_private__getEndian = 923; // native
const uint32_t shell_Runtime_private__parseRegExpResult = 924; // abc
const uint32_t shell_Runtime_private__parseVersion = 925; // abc
const uint32_t shell_Runtime_private__parseTag = 926; // abc
const uint32_t shell_Runtime_private__redtamarinDetect = 928; // abc
const uint32_t shell_Runtime_apiVersion_get = 929; // native
const uint32_t shell_Runtime_api_get = 930; // abc
const uint32_t shell_Runtime_swfVersion_get = 931; // native
const uint32_t shell_Runtime_platform_get = 932; // abc
const uint32_t shell_Runtime_architecture_get = 933; // abc
const uint32_t shell_Runtime_AVMversion_get = 934; // abc
const uint32_t shell_Runtime_description_get = 935; // abc
const uint32_t shell_Runtime_version_get = 936; // abc
const uint32_t shell_Runtime_tag_get = 937; // abc
const uint32_t shell_Runtime_codename_get = 938; // abc
const uint32_t shell_Runtime_label_get = 939; // abc
const uint32_t shell_Runtime_features_get = 940; // abc
const uint32_t shell_Runtime_runmode_get = 941; // abc
const uint32_t shell_Runtime_endian_get = 942; // abc
const uint32_t shell_Runtime_redtamarin_get = 943; // abc
const uint32_t shell_Runtime_loop_get = 944; // abc
const uint32_t shell_Runtime_loop_set = 945; // abc
const uint32_t shell_Runtime_eval = 946; // native
const uint32_t shell_Runtime_returnEval = 947; // native
const uint32_t shell_Runtime_is64bit = 948; // native
const uint32_t shell_Diagnostics_private__isGlobal = 951; // native
const uint32_t shell_Diagnostics_private__isIntptr = 952; // native
const uint32_t shell_Diagnostics_private__canonicalizeNumber = 953; // native
const uint32_t shell_Diagnostics_private__deopt = 954; // native
const uint32_t shell_Diagnostics_private__runInSafepoint = 955; // native
const uint32_t shell_Diagnostics_private__log = 956; // native
const uint32_t shell_Diagnostics_private__initializeLogging = 957; // native
const uint32_t shell_Diagnostics_debugger = 958; // native
const uint32_t shell_Diagnostics_isDebugger = 959; // native
const uint32_t shell_Diagnostics_AVM2_log = 960; // abc
const uint32_t shell_Diagnostics_AVM2_initializeLogging = 961; // abc
const uint32_t shell_Diagnostics_AVM2_isGlobal = 962; // abc
const uint32_t shell_Diagnostics_AVM2_isIntptr = 963; // abc
const uint32_t shell_Diagnostics_AVM2_canonicalizeNumber = 964; // abc
const uint32_t shell_Diagnostics_AVM2_deopt = 965; // abc
const uint32_t shell_Diagnostics_AVM2_runInSafepoint = 966; // abc
const uint32_t shell_HardwareInformation_private__getProcessorCountAtBoot = 969; // native
const uint32_t shell_HardwareInformation_private__getMemorySize = 970; // native
const uint32_t shell_HardwareInformation_private__getMemoryUsage = 971; // native
const uint32_t shell_HardwareInformation_private__getMemoryPeakUsage = 972; // native
const uint32_t shell_HardwareInformation_processors_get = 973; // abc
const uint32_t shell_HardwareInformation_memory_get = 974; // abc
const uint32_t shell_HardwareInformation_memoryUsage_get = 975; // abc
const uint32_t shell_HardwareInformation_memoryPeakUsage_get = 976; // abc
const uint32_t shell_OperatingSystem_private__parseRegExpResult = 979; // abc
const uint32_t shell_OperatingSystem_private__getVersionFrom = 980; // abc
const uint32_t shell_OperatingSystem_private__findWithin = 981; // abc
const uint32_t shell_OperatingSystem_private__windowsDetect = 982; // abc
const uint32_t shell_OperatingSystem_private__windowsReadVerOutput = 983; // abc
const uint32_t shell_OperatingSystem_private__windowsParseVersion = 984; // abc
const uint32_t shell_OperatingSystem_private__macintoshDetect = 985; // abc
const uint32_t shell_OperatingSystem_private__macintoshParseSystemVersionFile = 986; // abc
const uint32_t shell_OperatingSystem_private__macintoshParseSystemVersion = 987; // abc
const uint32_t shell_OperatingSystem_private__linuxDetect = 988; // abc
const uint32_t shell_OperatingSystem_private__linuxParseConfig = 989; // abc
const uint32_t shell_OperatingSystem_private__linuxParseReleaseFile = 990; // abc
const uint32_t shell_OperatingSystem_private__linuxParseUbuntuReleaseFile = 991; // abc
const uint32_t shell_OperatingSystem_private__getNameAll = 992; // abc
const uint32_t shell_OperatingSystem_private__getVersionAll = 993; // abc
const uint32_t shell_OperatingSystem_private__getVendorAll = 994; // abc
const uint32_t shell_OperatingSystem_private__getVendorNameAll = 995; // abc
const uint32_t shell_OperatingSystem_private__getVendorVersionAll = 996; // abc
const uint32_t shell_OperatingSystem_private__getVendorBuildAll = 997; // abc
const uint32_t shell_OperatingSystem_private__getVendorDescriptionAll = 998; // abc
const uint32_t shell_OperatingSystem_private__getCodenameAll = 999; // abc
const uint32_t shell_OperatingSystem_private__getLongDescriptionAll = 1000; // abc
const uint32_t shell_OperatingSystem_isWindowsStore = 1001; // native
const uint32_t shell_OperatingSystem_name_get = 1002; // abc
const uint32_t shell_OperatingSystem_version_get = 1003; // abc
const uint32_t shell_OperatingSystem_hostname_get = 1004; // abc
const uint32_t shell_OperatingSystem_username_get = 1005; // abc
const uint32_t shell_OperatingSystem_vendor_get = 1006; // abc
const uint32_t shell_OperatingSystem_vendorName_get = 1007; // abc
const uint32_t shell_OperatingSystem_vendorVersion_get = 1008; // abc
const uint32_t shell_OperatingSystem_vendorBuild_get = 1009; // abc
const uint32_t shell_OperatingSystem_vendorDescription_get = 1010; // abc
const uint32_t shell_OperatingSystem_codename_get = 1011; // abc
const uint32_t shell_OperatingSystem_longDescription_get = 1012; // abc
const uint32_t shell_FileSystem_private__isAttributeHidden = 1015; // native
const uint32_t shell_FileSystem_private__getLogicalDrives = 1016; // native
const uint32_t shell_FileSystem_private__findLogicalDrives = 1017; // abc
const uint32_t shell_FileSystem_private__findRootDirectory = 1018; // abc
const uint32_t shell_FileSystem_private__findHomeDirectory = 1019; // abc
const uint32_t shell_FileSystem_private__filterWithRegexp = 1021; // abc
const uint32_t shell_FileSystem_drives_get = 1022; // abc
const uint32_t shell_FileSystem_lineEnding_get = 1023; // abc
const uint32_t shell_FileSystem_rootDirectory_get = 1024; // abc
const uint32_t shell_FileSystem_homeDirectory_get = 1025; // abc
const uint32_t shell_FileSystem_separators_get = 1026; // abc
const uint32_t shell_FileSystem_pathSeparator_get = 1027; // abc
const uint32_t shell_FileSystem_nativeRead = 1028; // native
const uint32_t shell_FileSystem_nativeWrite = 1029; // native
const uint32_t shell_FileSystem_nativeReadByteArray = 1030; // native
const uint32_t shell_FileSystem_nativeWriteByteArray = 1031; // native
const uint32_t shell_FileSystem_absolutePath = 1032; // abc
const uint32_t shell_FileSystem_normalizePath = 1033; // abc
const uint32_t shell_FileSystem_getBasenameFromPath = 1034; // abc
const uint32_t shell_FileSystem_getDirectoryFromPath = 1035; // abc
const uint32_t shell_FileSystem_getComponentsFromPath = 1036; // abc
const uint32_t shell_FileSystem_containsPath = 1037; // abc
const uint32_t shell_FileSystem_create = 1038; // abc
const uint32_t shell_FileSystem_createByteArray = 1039; // abc
const uint32_t shell_FileSystem_createDirectory = 1040; // abc
const uint32_t shell_FileSystem_copyFile = 1041; // abc
const uint32_t shell_FileSystem_copyFiles = 1042; // abc
const uint32_t shell_FileSystem_bufferedCopyFile = 1043; // abc
const uint32_t shell_FileSystem_bufferedFastCopyFile = 1044; // abc
const uint32_t shell_FileSystem_copyDirectory = 1045; // abc
const uint32_t shell_FileSystem_exists = 1046; // abc
const uint32_t shell_FileSystem_move = 1047; // abc
const uint32_t shell_FileSystem_remove = 1048; // abc
const uint32_t shell_FileSystem_removeFile = 1049; // abc
const uint32_t shell_FileSystem_removeDirectory = 1050; // abc
const uint32_t shell_FileSystem_read = 1051; // abc
const uint32_t shell_FileSystem_readByteArray = 1052; // abc
const uint32_t shell_FileSystem_bufferedReadByteArray = 1053; // abc
const uint32_t shell_FileSystem_write = 1054; // abc
const uint32_t shell_FileSystem_writeByteArray = 1055; // abc
const uint32_t shell_FileSystem_bufferedWriteByteArray = 1056; // abc
const uint32_t shell_FileSystem_canAccess = 1057; // abc
const uint32_t shell_FileSystem_canRead = 1058; // abc
const uint32_t shell_FileSystem_canWrite = 1059; // abc
const uint32_t shell_FileSystem_hasDriveLetter = 1060; // abc
const uint32_t shell_FileSystem_getFileMode = 1061; // abc
const uint32_t shell_FileSystem_getFileAccessTime = 1062; // abc
const uint32_t shell_FileSystem_getFileModifiedTime = 1063; // abc
const uint32_t shell_FileSystem_getFileChangedTime = 1064; // abc
const uint32_t shell_FileSystem_getFileSize = 1065; // abc
const uint32_t shell_FileSystem_getSize = 1066; // abc
const uint32_t shell_FileSystem_getDirectorySize = 1067; // abc
const uint32_t shell_FileSystem_getFreeDiskSpace = 1068; // native
const uint32_t shell_FileSystem_getTotalDiskSpace = 1069; // native
const uint32_t shell_FileSystem_getUsedDiskSpace = 1070; // abc
const uint32_t shell_FileSystem_isRegularFile = 1071; // abc
const uint32_t shell_FileSystem_isRegularFileMode = 1072; // abc
const uint32_t shell_FileSystem_isDirectory = 1073; // abc
const uint32_t shell_FileSystem_isDirectoryMode = 1074; // abc
const uint32_t shell_FileSystem_isHidden = 1075; // abc
const uint32_t shell_FileSystem_isDotOrDotdot = 1076; // abc
const uint32_t shell_FileSystem_isSeparator = 1077; // abc
const uint32_t shell_FileSystem_isEmptyDirectory = 1078; // abc
const uint32_t shell_FileSystem_isValidWindowsComponent = 1079; // abc
const uint32_t shell_FileSystem_isValidMacintoshComponent = 1080; // abc
const uint32_t shell_FileSystem_isValidLinuxComponent = 1081; // abc
const uint32_t shell_FileSystem_isValidComponent = 1082; // abc
const uint32_t shell_FileSystem_isValidEverywhereComponent = 1083; // abc
const uint32_t shell_FileSystem_isValid = 1084; // abc
const uint32_t shell_FileSystem_isValidEverywhere = 1085; // abc
const uint32_t shell_FileSystem_endsWithSeparator = 1086; // abc
const uint32_t shell_FileSystem_ensureEndsWithSeparator = 1087; // abc
const uint32_t shell_FileSystem_stripTrailingSeparators = 1088; // abc
const uint32_t shell_FileSystem_listFilesOrDirectories = 1089; // abc
const uint32_t shell_FileSystem_listFilesOrDirectoriesWithFilter = 1090; // abc
const uint32_t shell_FileSystem_listFilesOrDirectoriesWithRegexp = 1091; // abc
const uint32_t shell_FileSystem_listFiles = 1092; // abc
const uint32_t shell_FileSystem_listFilesWithFilter = 1093; // abc
const uint32_t shell_FileSystem_listFilesWithRegexp = 1094; // abc
const uint32_t shell_FileSystem_listDirectories = 1095; // abc
const uint32_t shell_FileSystem_listDirectoriesWithFilter = 1096; // abc
const uint32_t shell_FileSystem_listDirectoriesWithRegexp = 1097; // abc
const uint32_t shell_FileSystem_listByDepth = 1098; // abc
const uint32_t shell_FileSystem_listByBreadth = 1099; // abc
const uint32_t shell_Cygwin_private__getAvailability = 1106; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry = 1107; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry32 = 1108; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry64 = 1109; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory = 1110; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory32 = 1111; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory64 = 1112; // abc
const uint32_t shell_Cygwin_private__getCygwinShell = 1113; // abc
const uint32_t shell_Cygwin_isAvailable_get = 1114; // abc
const uint32_t shell_Cygwin_installDirectory_get = 1115; // abc
const uint32_t shell_Cygwin_shell_get = 1116; // abc
const uint32_t shell_Cygwin_addToEnvironment = 1117; // abc
const uint32_t shell_Cygwin_forceInstallDirectory = 1118; // abc
const uint32_t shell_Cygwin_forceShell = 1119; // abc
const uint32_t shell_Cygwin_open = 1120; // abc
const uint32_t shell_Domain_currentDomain_get = 1123; // native
const uint32_t shell_Domain_MIN_DOMAIN_MEMORY_LENGTH_get = 1124; // native
const uint32_t shell_Domain_private_init = 1125; // native
const uint32_t shell_Domain_parentDomain_get = 1127; // abc
const uint32_t shell_Domain_loadBytes = 1128; // native
const uint32_t shell_Domain_getClass = 1129; // native
const uint32_t shell_Domain_getDefinition = 1130; // abc
const uint32_t shell_Domain_hasDefinition = 1131; // abc
const uint32_t shell_Domain_load = 1132; // abc
const uint32_t shell_Domain_domainMemory_get = 1133; // native
const uint32_t shell_Domain_domainMemory_set = 1134; // native
const uint32_t shell_Environment_private__parse = 1137; // abc
const uint32_t shell_Environment_private__findIndexBy = 1138; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_callProperty = 1139; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_deleteProperty = 1140; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_getProperty = 1141; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_setProperty = 1142; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_hasProperty = 1143; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextNameIndex = 1144; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextName = 1145; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextValue = 1146; // abc
const uint32_t shell_Environment_length_get = 1147; // abc
const uint32_t shell_Environment_hasOwnProperty = 1148; // abc
const uint32_t shell_Environment_propertyIsEnumerable = 1149; // abc
const uint32_t shell_Environment_synchronised_get = 1150; // abc
const uint32_t shell_Environment_refresh = 1151; // abc
const uint32_t shell_Environment_toArray = 1152; // abc
const uint32_t shell_Environment_toObject = 1153; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_running_get = 1157; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_running_set = 1158; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frequency_get = 1159; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frequency_set = 1160; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timers_get = 1161; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timers_set = 1162; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frame_get = 1163; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_started_get = 1164; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_elapsed_get = 1165; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timerPending_get = 1166; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_setCallback = 1167; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_handleTimers = 1168; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_start = 1169; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_stop = 1170; // abc
const uint32_t flash_accessibility_ISearchableText_flash_accessibility_ISearchableText_searchText_get = 1173; // abc
const uint32_t flash_accessibility_ISimpleTextSelection_flash_accessibility_ISimpleTextSelection_selectionAnchorIndex_get = 1176; // abc
const uint32_t flash_accessibility_ISimpleTextSelection_flash_accessibility_ISimpleTextSelection_selectionActiveIndex_get = 1177; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accRole = 1183; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accName = 1184; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accValue = 1185; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accState = 1186; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accDefaultAction = 1187; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accDoDefaultAction = 1188; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_isLabeledBy = 1189; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_getChildIDArray = 1190; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accLocation = 1191; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accSelection = 1192; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accFocus = 1193; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accSelect = 1194; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_selectionAnchorIndex = 1195; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_selectionActiveIndex = 1196; // abc
const uint32_t flash_data_EncryptedLocalStore_isSupported_get = 1200; // abc
const uint32_t flash_display_Scene_name_get = 1250; // abc
const uint32_t flash_display_Scene_labels_get = 1251; // abc
const uint32_t flash_display_Scene_numFrames_get = 1252; // abc
const uint32_t flash_errors_SQLError_operation_get = 1279; // abc
const uint32_t flash_errors_SQLError_details_get = 1280; // abc
const uint32_t flash_errors_SQLError_detailID_get = 1281; // abc
const uint32_t flash_errors_SQLError_detailArguments_get = 1282; // abc
const uint32_t flash_errors_DRMManagerError_subErrorID_get = 1285; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_addEventListener = 1287; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_dispatchEvent = 1288; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_hasEventListener = 1289; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_removeEventListener = 1290; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_willTrigger = 1291; // abc
const uint32_t flash_events_Event_private_ctor = 1295; // abc
const uint32_t flash_events_Event_type_get = 1296; // abc
const uint32_t flash_events_Event_bubbles_get = 1297; // abc
const uint32_t flash_events_Event_cancelable_get = 1298; // abc
const uint32_t flash_events_Event_target_get = 1299; // abc
const uint32_t flash_events_Event_currentTarget_get = 1300; // abc
const uint32_t flash_events_Event_eventPhase_get = 1301; // abc
const uint32_t flash_events_Event_formatToString = 1302; // abc
const uint32_t flash_events_Event_clone = 1303; // abc
const uint32_t flash_events_Event_isDefaultPrevented = 1304; // abc
const uint32_t flash_events_Event_preventDefault = 1305; // abc
const uint32_t flash_events_Event_stopImmediatePropagation = 1306; // abc
const uint32_t flash_events_Event_stopPropagation = 1307; // abc
const uint32_t flash_events_Event_toString = 1308; // abc
const uint32_t flash_filesystem_File_isDummy = 1310; // native
const uint32_t flash_filesystem_File_isLocalDummy = 1311; // native
const uint32_t flash_filesystem_File_url_get = 1313; // abc
const uint32_t flash_filesystem_File_url_set = 1314; // abc
const uint32_t flash_filesystem_File_nativePath_get = 1315; // abc
const uint32_t flash_filesystem_File_nativePath_set = 1316; // abc
const uint32_t flash_filesystem_FileStream_open = 1321; // abc
const uint32_t flash_filesystem_FileStream_openAsync = 1322; // abc
const uint32_t flash_filesystem_FileStream_truncate = 1323; // abc
const uint32_t flash_filesystem_FileStream_close = 1324; // abc
const uint32_t flash_geom_Point_interpolate = 1328; // abc
const uint32_t flash_geom_Point_distance = 1329; // abc
const uint32_t flash_geom_Point_polar = 1330; // abc
const uint32_t flash_geom_Point_length_get = 1332; // abc
const uint32_t flash_geom_Point_clone = 1333; // abc
const uint32_t flash_geom_Point_offset = 1334; // abc
const uint32_t flash_geom_Point_equals = 1335; // abc
const uint32_t flash_geom_Point_subtract = 1336; // abc
const uint32_t flash_geom_Point_add = 1337; // abc
const uint32_t flash_geom_Point_normalize = 1338; // abc
const uint32_t flash_geom_Point_toString = 1339; // abc
const uint32_t flash_geom_Rectangle_left_get = 1342; // abc
const uint32_t flash_geom_Rectangle_left_set = 1343; // abc
const uint32_t flash_geom_Rectangle_right_get = 1344; // abc
const uint32_t flash_geom_Rectangle_right_set = 1345; // abc
const uint32_t flash_geom_Rectangle_top_get = 1346; // abc
const uint32_t flash_geom_Rectangle_top_set = 1347; // abc
const uint32_t flash_geom_Rectangle_bottom_get = 1348; // abc
const uint32_t flash_geom_Rectangle_bottom_set = 1349; // abc
const uint32_t flash_geom_Rectangle_topLeft_get = 1350; // abc
const uint32_t flash_geom_Rectangle_topLeft_set = 1351; // abc
const uint32_t flash_geom_Rectangle_bottomRight_get = 1352; // abc
const uint32_t flash_geom_Rectangle_bottomRight_set = 1353; // abc
const uint32_t flash_geom_Rectangle_size_get = 1354; // abc
const uint32_t flash_geom_Rectangle_size_set = 1355; // abc
const uint32_t flash_geom_Rectangle_clone = 1356; // abc
const uint32_t flash_geom_Rectangle_isEmpty = 1357; // abc
const uint32_t flash_geom_Rectangle_setEmpty = 1358; // abc
const uint32_t flash_geom_Rectangle_inflate = 1359; // abc
const uint32_t flash_geom_Rectangle_inflatePoint = 1360; // abc
const uint32_t flash_geom_Rectangle_offset = 1361; // abc
const uint32_t flash_geom_Rectangle_offsetPoint = 1362; // abc
const uint32_t flash_geom_Rectangle_contains = 1363; // abc
const uint32_t flash_geom_Rectangle_containsPoint = 1364; // abc
const uint32_t flash_geom_Rectangle_containsRect = 1365; // abc
const uint32_t flash_geom_Rectangle_intersection = 1366; // abc
const uint32_t flash_geom_Rectangle_intersects = 1367; // abc
const uint32_t flash_geom_Rectangle_union = 1368; // abc
const uint32_t flash_geom_Rectangle_equals = 1369; // abc
const uint32_t flash_geom_Rectangle_toString = 1370; // abc
const uint32_t flash_net_FileReference_isDummy = 1372; // native
const uint32_t flash_net_FileReference_isLocalDummy = 1373; // native
const uint32_t flash_net_FileReference_private__reset = 1375; // abc
const uint32_t flash_net_FileReference_creationDate_get = 1376; // abc
const uint32_t flash_net_FileReference_creator_get = 1377; // abc
const uint32_t flash_net_FileReference_modificationDate_get = 1378; // abc
const uint32_t flash_net_FileReference_name_get = 1379; // abc
const uint32_t flash_net_FileReference_size_get = 1380; // abc
const uint32_t flash_net_FileReference_type_get = 1381; // abc
const uint32_t flash_net_FileReference_data_get = 1382; // abc
const uint32_t flash_net_FileReference_extension_get = 1383; // abc
const uint32_t flash_net_FileReference_browse = 1384; // abc
const uint32_t flash_net_FileReference_AVM2_browseOverride = 1385; // abc
const uint32_t flash_net_FileReference_private__load = 1386; // abc
const uint32_t flash_net_FileReference_load = 1387; // abc
const uint32_t flash_net_FileReference_private__save = 1388; // abc
const uint32_t flash_net_FileReference_save = 1389; // abc
const uint32_t flash_net_FileReference_AVM2_saveOverride = 1390; // abc
const uint32_t flash_net_FileReference_uploadUnencoded = 1391; // abc
const uint32_t flash_net_URLRequest_private_setRequestHeaders = 1394; // abc
const uint32_t flash_net_URLRequest_private_filterRequestHeaders = 1395; // abc
const uint32_t flash_net_URLRequest_requestHeaders_get = 1396; // abc
const uint32_t flash_net_URLRequest_requestHeaders_set = 1397; // abc
const uint32_t flash_net_URLRequest_userAgent_get = 1398; // abc
const uint32_t flash_net_URLRequest_userAgent_set = 1399; // abc
const uint32_t flash_net_URLRequestDefaults_private_initLoginCredentials = 1401; // abc
const uint32_t flash_net_URLRequestDefaults_private_initUA = 1402; // abc
const uint32_t flash_net_URLRequestDefaults_setLoginCredentialsForHost = 1403; // abc
const uint32_t flash_net_URLRequestDefaults_followRedirects_get = 1404; // abc
const uint32_t flash_net_URLRequestDefaults_followRedirects_set = 1405; // abc
const uint32_t flash_net_URLRequestDefaults_idleTimeout_get = 1406; // abc
const uint32_t flash_net_URLRequestDefaults_idleTimeout_set = 1407; // abc
const uint32_t flash_sampler_StackFrame_toString = 1412; // abc
const uint32_t flash_system_Capabilities_avHardwareDisable_get = 1419; // abc
const uint32_t flash_system_Capabilities_cpuArchitecture_get = 1420; // abc
const uint32_t flash_system_Capabilities_manufacturer_get = 1421; // abc
const uint32_t flash_system_Capabilities_playerType_get = 1422; // abc
const uint32_t flash_system_Capabilities_isDebugger_get = 1423; // abc
const uint32_t flash_system_Capabilities_supports32BitProcesses_get = 1424; // abc
const uint32_t flash_system_Capabilities_supports64BitProcesses_get = 1425; // abc
const uint32_t flash_system_Capabilities_hasMultiChannelAudio = 1426; // abc
const uint32_t flash_system_Security_exactSettings_get = 1429; // abc
const uint32_t flash_system_Security_exactSettings_set = 1430; // abc
const uint32_t flash_system_Security_pageDomain_get = 1431; // abc
const uint32_t flash_system_Security_AVM2_pageDomain_set = 1432; // abc
const uint32_t flash_system_Security_sandboxType_get = 1433; // abc
const uint32_t flash_system_Security_AVM2_sandboxType_set = 1434; // abc
const uint32_t flash_system_Security_allowDomain = 1435; // abc
const uint32_t flash_system_Security_allowInsecureDomain = 1436; // abc
const uint32_t flash_system_Security_loadPolicyFile = 1437; // abc
const uint32_t flash_system_Security_showSettings = 1438; // abc
const uint32_t flash_system_System_setClipboard = 1443; // abc
const uint32_t flash_system_System_totalMemory_get = 1444; // abc
const uint32_t flash_system_System_totalMemoryNumber_get = 1445; // abc
const uint32_t flash_system_System_freeMemory_get = 1446; // native
const uint32_t flash_system_System_privateMemory_get = 1447; // abc
const uint32_t flash_system_System_useCodePage_get = 1448; // abc
const uint32_t flash_system_System_useCodePage_set = 1449; // abc
const uint32_t flash_system_System_vmVersion_get = 1450; // abc
const uint32_t flash_system_System_pause = 1451; // abc
const uint32_t flash_system_System_resume = 1452; // abc
const uint32_t flash_system_System_exit = 1453; // abc
const uint32_t flash_system_System_gc = 1454; // abc
const uint32_t flash_system_System_disposeXML = 1455; // abc
const uint32_t flash_system_WorkerState_code = 1458; // abc
const uint32_t flash_system_Worker_current_get = 1461; // abc
const uint32_t flash_system_Worker_pr = 1462; // native
const uint32_t flash_system_Worker_state_get = 1464; // native
const uint32_t flash_system_Worker_start = 1465; // native
const uint32_t flash_system_Worker_isParentOf = 1466; // native
const uint32_t flash_system_Worker_isPrimordial_get = 1467; // native
const uint32_t flash_system_Worker_setSharedProperty = 1468; // native
const uint32_t flash_system_Worker_getSharedProperty = 1469; // native
const uint32_t flash_system_Worker_terminate = 1470; // native
const uint32_t flash_system_WorkerEvent_currentState_get = 1473; // abc
const uint32_t flash_system_WorkerEvent_previousState_get = 1474; // abc
const uint32_t flash_system_WorkerEvent_target_get = 1475; // abc
const uint32_t flash_system_WorkerDomain_current_get = 1477; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromByteArray = 1479; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromPrimordial = 1480; // abc
const uint32_t flash_system_WorkerDomain_private_createWorkerFromByteArrayInternal = 1481; // native
const uint32_t flash_system_WorkerDomain_listWorkers = 1482; // native
const uint32_t flash_trace_Trace_setLevel = 1484; // native
const uint32_t flash_trace_Trace_getLevel = 1485; // native
const uint32_t flash_trace_Trace_setListener = 1486; // native
const uint32_t flash_trace_Trace_getListener = 1487; // native
const uint32_t shell_async_CoreEventLoop_running_get = 1493; // abc
const uint32_t shell_async_CoreEventLoop_running_set = 1494; // abc
const uint32_t shell_async_CoreEventLoop_frequency_get = 1495; // abc
const uint32_t shell_async_CoreEventLoop_frequency_set = 1496; // abc
const uint32_t shell_async_CoreEventLoop_timers_get = 1497; // abc
const uint32_t shell_async_CoreEventLoop_timers_set = 1498; // abc
const uint32_t shell_async_CoreEventLoop_frame_get = 1499; // abc
const uint32_t shell_async_CoreEventLoop_started_get = 1500; // abc
const uint32_t shell_async_CoreEventLoop_elapsed_get = 1501; // abc
const uint32_t shell_async_CoreEventLoop_private_tick = 1502; // abc
const uint32_t shell_async_CoreEventLoop_setCallback = 1503; // abc
const uint32_t shell_async_CoreEventLoop_private__loop = 1504; // abc
const uint32_t shell_async_CoreEventLoop_timerPending_get = 1505; // abc
const uint32_t shell_async_CoreEventLoop_handleTimers = 1506; // abc
const uint32_t shell_async_CoreEventLoop_start = 1507; // abc
const uint32_t shell_async_CoreEventLoop_stop = 1508; // abc
const uint32_t flash_events_EventDispatcher_private_trimHeaderValue = 1510; // abc
const uint32_t flash_events_EventDispatcher_private_ctor = 1512; // abc
const uint32_t flash_events_EventDispatcher_private_dispatchEventFunction = 1513; // abc
const uint32_t flash_events_EventDispatcher_private_dispatchHttpStatusEvent = 1515; // abc
const uint32_t flash_events_EventDispatcher_addEventListener = 1516; // abc
const uint32_t flash_events_EventDispatcher_dispatchEvent = 1517; // abc
const uint32_t flash_events_EventDispatcher_hasEventListener = 1518; // abc
const uint32_t flash_events_EventDispatcher_removeEventListener = 1519; // abc
const uint32_t flash_events_EventDispatcher_willTrigger = 1520; // abc
const uint32_t flash_events_EventDispatcher_toString = 1521; // abc
const uint32_t flash_events_HTTPStatusEvent_status_get = 1524; // abc
const uint32_t flash_events_HTTPStatusEvent_responseURL_get = 1525; // abc
const uint32_t flash_events_HTTPStatusEvent_responseURL_set = 1526; // abc
const uint32_t flash_events_HTTPStatusEvent_responseHeaders_get = 1527; // abc
const uint32_t flash_events_HTTPStatusEvent_responseHeaders_set = 1528; // abc
const uint32_t flash_events_HTTPStatusEvent_redirected_get = 1529; // abc
const uint32_t flash_events_HTTPStatusEvent_redirected_set = 1530; // abc
const uint32_t flash_events_HTTPStatusEvent_clone = 1531; // abc
const uint32_t flash_events_HTTPStatusEvent_toString = 1532; // abc
const uint32_t flash_events_TimerEvent_clone = 1535; // abc
const uint32_t flash_events_TimerEvent_toString = 1536; // abc
const uint32_t flash_events_TimerEvent_updateAfterEvent = 1537; // abc
const uint32_t flash_sampler_NewObjectSample_object_get = 1539; // native
const uint32_t flash_sampler_NewObjectSample_size_get = 1540; // native
const uint32_t flash_utils_Timer_private__timerDispatch = 1546; // abc
const uint32_t flash_utils_Timer_private__start = 1547; // abc
const uint32_t flash_utils_Timer_tick = 1548; // abc
const uint32_t flash_utils_Timer_delay_get = 1549; // abc
const uint32_t flash_utils_Timer_delay_set = 1550; // abc
const uint32_t flash_utils_Timer_repeatCount_get = 1551; // abc
const uint32_t flash_utils_Timer_repeatCount_set = 1552; // abc
const uint32_t flash_utils_Timer_currentCount_get = 1553; // abc
const uint32_t flash_utils_Timer_running_get = 1554; // abc
const uint32_t flash_utils_Timer_reset = 1555; // abc
const uint32_t flash_utils_Timer_start = 1556; // abc
const uint32_t flash_utils_Timer_stop = 1557; // abc
...
// C::__c$
//-----------------------------------------------------------
class avmplus___cClassSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::__cClass;
#define GC_TRIVIAL_TRACER___cClass
};
//-----------------------------------------------------------
...
// C::__c
//-----------------------------------------------------------
class avmplus___cObjectSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::__cObject;
#define GC_TRIVIAL_TRACER___cObject
};
//-----------------------------------------------------------
...
private:
    REALLY_INLINE shell_toplevelClassManifest(avmplus::ScriptEnv* e) : ClassManifestBase(141, e) { }
    REALLY_INLINE static shell_toplevelClassManifest* create(avmplus::ScriptEnv* e) { return new (MMgc::GC::GetGC(e), MMgc::kExact, sizeof(ClassClosure*)*140) shell_toplevelClassManifest(e); }
public:
    ...
    REALLY_INLINE GCRef<avmplus::__cClass> get___cClass() { return (avmplus::__cClass*)(lazyInitClass(avmplus::NativeID::abcclass_C___c)); }
