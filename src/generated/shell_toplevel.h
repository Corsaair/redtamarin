...
namespace avmplus {
    ...
    class CygwinClass; // shell::Cygwin$
    class CygwinObject; // shell::Cygwin
    ...
    class ShellTypeClass; // shell::ShellType$
    class ShellTypeObject; // shell::ShellType
...
const uint32_t abcclass_shell_ShellType = 58;
const uint32_t abcclass_shell_Cygwin = 59;
const uint32_t abcclass_shell_Domain = 60;
const uint32_t abcclass_shell_Environment = 61;
const uint32_t abcclass_shell_BinaryData = 62;
const uint32_t abcclass_shell_async_EventLoop = 63;
const uint32_t abcclass_flash_accessibility_ISearchableText = 64;
const uint32_t abcclass_flash_accessibility_ISimpleTextSelection = 65;
const uint32_t abcclass_flash_accessibility_Accessibility = 66;
const uint32_t abcclass_flash_accessibility_AccessibilityImplementation = 67;
const uint32_t abcclass_flash_accessibility_AccessibilityProperties = 68;
const uint32_t abcclass_flash_data_EncryptedLocalStore = 69;
const uint32_t abcclass_flash_data_SQLCollationType = 70;
const uint32_t abcclass_flash_data_SQLColumnNameStyle = 71;
const uint32_t abcclass_flash_data_SQLColumnSchema = 72;
const uint32_t abcclass_flash_data_SQLConnection = 73;
const uint32_t abcclass_flash_data_SQLIndexSchema = 74;
const uint32_t abcclass_flash_data_SQLMode = 75;
const uint32_t abcclass_flash_data_SQLResult = 76;
const uint32_t abcclass_flash_data_SQLSchema = 77;
const uint32_t abcclass_flash_data_SQLSchemaResult = 78;
const uint32_t abcclass_flash_data_SQLStatement = 79;
const uint32_t abcclass_flash_data_SQLTableSchema = 80;
const uint32_t abcclass_flash_data_SQLTransactionLockType = 81;
const uint32_t abcclass_flash_data_SQLTriggerSchema = 82;
const uint32_t abcclass_flash_data_SQLViewSchema = 83;
const uint32_t abcclass_flash_display_IBitmapDrawable = 84;
const uint32_t abcclass_flash_display_IDrawCommand = 85;
const uint32_t abcclass_flash_display_IGraphicsData = 86;
const uint32_t abcclass_flash_display_IGraphicsFill = 87;
const uint32_t abcclass_flash_display_IGraphicsPath = 88;
const uint32_t abcclass_flash_display_IGraphicsStroke = 89;
const uint32_t abcclass_flash_display_ActionScriptVersion = 90;
const uint32_t abcclass_flash_display_PixelSnapping = 91;
const uint32_t abcclass_flash_display_PNGEncoderOptions = 92;
const uint32_t abcclass_flash_display_Scene = 93;
const uint32_t abcclass_flash_display_StageAlign = 94;
const uint32_t abcclass_flash_display_StageAspectRatio = 95;
const uint32_t abcclass_flash_display_StageDisplayState = 96;
const uint32_t abcclass_flash_display_StageOrientation = 97;
const uint32_t abcclass_flash_display_StageQuality = 98;
const uint32_t abcclass_flash_display_StageScaleMode = 99;
const uint32_t abcclass_flash_display_SWFVersion = 100;
const uint32_t abcclass_flash_display_TriangleCulling = 101;
const uint32_t abcclass_flash_errors_ScriptTimeoutError = 102;
const uint32_t abcclass_flash_errors_StackOverflowError = 103;
const uint32_t abcclass_flash_errors_InvalidSWFError = 104;
const uint32_t abcclass_flash_errors_SQLErrorOperation = 105;
const uint32_t abcclass_flash_errors_SQLError = 106;
const uint32_t abcclass_flash_errors_DRMManagerError = 107;
const uint32_t abcclass_flash_events_IEventDispatcher = 108;
const uint32_t abcclass_flash_events_Event = 109;
const uint32_t abcclass_flash_filesystem_File = 110;
const uint32_t abcclass_flash_filesystem_FileMode = 111;
const uint32_t abcclass_flash_filesystem_FileStream = 112;
const uint32_t abcclass_flash_geom_Orientation3D = 113;
const uint32_t abcclass_flash_geom_Point = 114;
const uint32_t abcclass_flash_geom_Rectangle = 115;
const uint32_t abcclass_flash_net_FileReference = 116;
const uint32_t abcclass_flash_net_URLRequest = 117;
const uint32_t abcclass_flash_net_URLRequestDefaults = 118;
const uint32_t abcclass_flash_net_URLRequestHeader = 119;
const uint32_t abcclass_flash_sampler_StackFrame = 120;
const uint32_t abcclass_flash_sampler_Sample = 121;
const uint32_t abcclass_flash_sampler_ClassFactory = 122;
const uint32_t abcclass_flash_system_Capabilities = 123;
const uint32_t abcclass_flash_system_Security = 124;
const uint32_t abcclass_flash_system_SecurityPrivilege = 125;
const uint32_t abcclass_flash_system_System = 126;
const uint32_t abcclass_flash_system_WorkerState = 127;
const uint32_t abcclass_flash_system_Worker = 128;
const uint32_t abcclass_flash_system_WorkerEvent = 129;
const uint32_t abcclass_flash_system_WorkerDomain = 130;
const uint32_t abcclass_flash_trace_Trace = 131;
const uint32_t abcclass_flash_utils_Endian = 132;
const uint32_t abcclass_shell_async_CoreEventLoop = 133;
const uint32_t abcclass_flash_events_EventDispatcher = 134;
const uint32_t abcclass_flash_events_HTTPStatusEvent = 135;
const uint32_t abcclass_flash_events_TimerEvent = 136;
const uint32_t abcclass_flash_sampler_NewObjectSample = 137;
const uint32_t abcclass_flash_sampler_DeleteObjectSample = 138;
const uint32_t abcclass_flash_utils_Timer = 139;

/* methods */
const uint32_t native_script_function_flash_sampler_getMasterString = 13; // native
const uint32_t native_script_function_flash_sampler_getSavedThis = 14; // native
const uint32_t native_script_function_flash_sampler_getLexicalScopes = 15; // native
const uint32_t native_script_function_flash_sampler_isGetterSetter = 16; // native
const uint32_t native_script_function_flash_sampler__getInvocationCount = 17; // native
const uint32_t native_script_function_flash_sampler_getSampleCount = 21; // native
const uint32_t native_script_function_flash_sampler__getSamples = 22; // native
const uint32_t native_script_function_flash_sampler_getMemberNames = 24; // native
const uint32_t native_script_function_flash_sampler_getSize = 25; // native
const uint32_t native_script_function_flash_sampler__setSamplerCallback = 26; // native
const uint32_t native_script_function_flash_sampler_sampleInternalAllocs = 29; // native
const uint32_t native_script_function_flash_sampler_pauseSampling = 30; // native
const uint32_t native_script_function_flash_sampler_stopSampling = 31; // native
const uint32_t native_script_function_flash_sampler_startSampling = 32; // native
const uint32_t native_script_function_flash_sampler_clearSamples = 33; // native
const uint32_t native_script_function_C_unistd_ftruncate = 49; // native
const uint32_t native_script_function_C_unistd_fsync = 50; // native
const uint32_t native_script_function_C_unistd_execvp = 51; // native
const uint32_t native_script_function_C_unistd_execve = 52; // native
const uint32_t native_script_function_C_unistd_execv = 53; // native
const uint32_t native_script_function_C_unistd_execlp = 54; // native
const uint32_t native_script_function_C_unistd_execle = 55; // native
const uint32_t native_script_function_C_unistd_execl = 56; // native
const uint32_t native_script_function_C_unistd_dup2 = 57; // native
const uint32_t native_script_function_C_unistd_dup = 58; // native
const uint32_t native_script_function_C_unistd_close = 59; // native
const uint32_t native_script_function_C_unistd_chdir = 60; // native
const uint32_t native_script_function_C_unistd_access = 61; // native
const uint32_t native_script_function_C_sys_wait_waitpid = 62; // native
const uint32_t native_script_function_C_sys_wait_waitid = 63; // native
const uint32_t native_script_function_C_sys_wait_wait = 64; // native
const uint32_t native_script_function_C_sys_utsname_uname = 73; // native
const uint32_t native_script_function_C_sys_stat_umask = 75; // native
const uint32_t native_script_function_C_sys_stat_stat = 76; // native
const uint32_t native_script_function_C_sys_stat_fstat = 79; // native
const uint32_t native_script_function_C_sys_stat_chmod = 80; // native
const uint32_t native_script_function_C_sys_socket_socketpair = 88; // native
const uint32_t native_script_function_C_sys_socket_socket = 89; // native
const uint32_t native_script_function_C_sys_socket_sockatmark = 90; // native
const uint32_t native_script_function_C_sys_socket_shutdown = 91; // native
const uint32_t native_script_function_C_sys_socket_send = 96; // native
const uint32_t native_script_function_C_sys_socket_recv = 99; // native
const uint32_t native_script_function_C_sys_socket_listen = 100; // native
const uint32_t native_script_function_C_sys_select_isExceptional = 108; // native
const uint32_t native_script_function_C_sys_select_isWritable = 109; // native
const uint32_t native_script_function_C_sys_select_isReadable = 110; // native
const uint32_t native_script_function_C_sys_select_select = 111; // native
const uint32_t native_script_function_C_sys_select_FD_ZERO = 112; // native
const uint32_t native_script_function_C_sys_select_FD_SET = 113; // native
const uint32_t native_script_function_C_sys_select_FD_ISSET = 114; // native
const uint32_t native_script_function_C_sys_select_FD_CLR = 115; // native
const uint32_t native_script_function_C_spawn_spawnp = 116; // native
const uint32_t native_script_function_C_spawn_spawn = 117; // native
const uint32_t native_script_function_C_netdb_getprotoent = 146; // native
const uint32_t native_script_function_C_netdb_getprotobynumber = 147; // native
const uint32_t native_script_function_C_netdb_gethostent = 148; // native
const uint32_t native_script_function_C_netdb_gethostbyname = 149; // native
const uint32_t native_script_function_C_netdb_getaddrinfo = 151; // native
const uint32_t native_script_function_C_netdb_gai_strerror = 152; // native
const uint32_t native_script_function_C_fcntl_openat = 153; // native
const uint32_t native_script_function_C_fcntl_open = 154; // native
const uint32_t native_script_function_C_fcntl_fcntl = 155; // native
const uint32_t native_script_function_C_fcntl_creat = 156; // native
const uint32_t native_script_function_C_dirent_telldir = 157; // native
const uint32_t native_script_function_C_dirent_seekdir = 158; // native
const uint32_t native_script_function_C_dirent_rewinddir = 159; // native
const uint32_t native_script_function_C_dirent_readdir = 160; // native
const uint32_t native_script_function_C_dirent_opendir = 161; // native
const uint32_t native_script_function_C_dirent_fdopendir = 163; // native
const uint32_t native_script_function_C_dirent_dirfd = 164; // native
const uint32_t native_script_function_C_dirent_closedir = 165; // native
const uint32_t native_script_function_C_conio_set_binary_mode = 166; // native
const uint32_t native_script_function_C_conio_kbhit = 167; // native
const uint32_t native_script_function_C_conio_echo = 168; // native
const uint32_t native_script_function_C_conio_canonical = 169; // native
const uint32_t native_script_function_C_string_strspn = 184; // native
const uint32_t native_script_function_C_string_strerror = 193; // native
const uint32_t native_script_function_C_string_strcoll = 194; // native
const uint32_t native_script_function_C_string_strcmp = 195; // native
const uint32_t native_script_function_C_stdlib_unsetenv = 198; // native
const uint32_t native_script_function_C_stdlib_system = 199; // native
const uint32_t native_script_function_C_stdlib_srand = 207; // native
const uint32_t native_script_function_C_stdlib_setenv = 208; // native
const uint32_t native_script_function_C_stdlib_realpath = 209; // native
const uint32_t native_script_function_C_stdlib_rand = 210; // native
const uint32_t native_script_function_C_stdlib_putenv = 211; // native
const uint32_t native_script_function_C_stdlib_mkstemp = 212; // native
const uint32_t native_script_function_C_stdlib_mkdtemp = 213; // native
const uint32_t native_script_function_C_stdlib_mblen = 214; // native
const uint32_t native_script_function_C_stdlib_lldiv = 215; // native
const uint32_t native_script_function_C_stdlib_ldiv = 217; // native
const uint32_t native_script_function_C_stdlib_getenv = 219; // native
const uint32_t native_script_function_C_stdlib_div = 221; // native
const uint32_t native_script_function_C_stdlib_atol = 223; // native
const uint32_t native_script_function_C_stdlib_atoi = 224; // native
const uint32_t native_script_function_C_stdlib_atof = 225; // native
const uint32_t native_script_function_C_stdio_rewind = 230; // native
const uint32_t native_script_function_C_stdio_rename = 231; // native
const uint32_t native_script_function_C_stdio_remove = 232; // native
const uint32_t native_script_function_C_stdio_popen = 233; // native
const uint32_t native_script_function_C_stdio_perror = 234; // native
const uint32_t native_script_function_C_stdio_pclose = 235; // native
const uint32_t native_script_function_C_stdio_getchar = 238; // native
const uint32_t native_script_function_C_stdio_fwrite = 240; // native
const uint32_t native_script_function_C_stdio_funlockfile = 241; // native
const uint32_t native_script_function_C_stdio_ftrylockfile = 242; // native
const uint32_t native_script_function_C_stdio_ftell = 243; // native
const uint32_t native_script_function_C_stdio_fsetpos = 244; // native
const uint32_t native_script_function_C_stdio_fseek = 245; // native
const uint32_t native_script_function_C_stdio_freopen = 246; // native
const uint32_t native_script_function_C_stdio_fread = 247; // native
const uint32_t native_script_function_C_stdio_fputs = 248; // native
const uint32_t native_script_function_C_stdio_fputc = 249; // native
const uint32_t native_script_function_C_stdio_fopen = 250; // native
const uint32_t native_script_function_C_stdio_flockfile = 251; // native
const uint32_t native_script_function_C_stdio_fileno = 252; // native
const uint32_t native_script_function_C_stdio_fgets = 253; // native
const uint32_t native_script_function_C_stdio_fgetpos = 254; // native
const uint32_t native_script_function_C_stdio_fgetc = 255; // native
const uint32_t native_script_function_C_stdio_fflush = 256; // native
const uint32_t native_script_function_C_stdio_ferror = 257; // native
const uint32_t native_script_function_C_stdio_feof = 258; // native
const uint32_t native_script_function_C_stdio_fdopen = 259; // native
const uint32_t native_script_function_C_stdio_fclose = 260; // native
const uint32_t native_script_function_C_stdio_clearerr = 261; // native
const uint32_t native_script_function_C_signal_kill = 262; // native
const uint32_t native_script_function_C_assert__debugBreak = 285; // native
const uint32_t C_ctype___ctype__avm_isalnum = 290; // native
const uint32_t C_ctype___ctype__avm_isalpha = 291; // native
const uint32_t C_ctype___ctype__avm_isascii = 292; // native
const uint32_t C_ctype___ctype__avm_isblank = 293; // native
const uint32_t C_ctype___ctype__avm_iscntrl = 294; // native
const uint32_t C_ctype___ctype__avm_isdigit = 295; // native
const uint32_t C_ctype___ctype__avm_isgraph = 296; // native
const uint32_t C_ctype___ctype__avm_islower = 297; // native
const uint32_t C_ctype___ctype__avm_isprint = 298; // native
const uint32_t C_ctype___ctype__avm_ispunct = 299; // native
const uint32_t C_ctype___ctype__avm_isspace = 300; // native
const uint32_t C_ctype___ctype__avm_isupper = 301; // native
const uint32_t C_ctype___ctype__avm_isxdigit = 302; // native
const uint32_t C_ctype___ctype__avm_toascii = 303; // native
const uint32_t C_ctype___ctype__avm_tolower = 304; // native
const uint32_t C_ctype___ctype__avm_toupper = 305; // native
const uint32_t C_errno___errno_EPERM_get = 308; // native
const uint32_t C_errno___errno_ENOENT_get = 309; // native
const uint32_t C_errno___errno_ESRCH_get = 310; // native
const uint32_t C_errno___errno_EINTR_get = 311; // native
const uint32_t C_errno___errno_EIO_get = 312; // native
const uint32_t C_errno___errno_ENXIO_get = 313; // native
const uint32_t C_errno___errno_E2BIG_get = 314; // native
const uint32_t C_errno___errno_ENOEXEC_get = 315; // native
const uint32_t C_errno___errno_EBADF_get = 316; // native
const uint32_t C_errno___errno_ECHILD_get = 317; // native
const uint32_t C_errno___errno_EAGAIN_get = 318; // native
const uint32_t C_errno___errno_ENOMEM_get = 319; // native
const uint32_t C_errno___errno_EACCES_get = 320; // native
const uint32_t C_errno___errno_EFAULT_get = 321; // native
const uint32_t C_errno___errno_ENOTBLK_get = 322; // native
const uint32_t C_errno___errno_EBUSY_get = 323; // native
const uint32_t C_errno___errno_EEXIST_get = 324; // native
const uint32_t C_errno___errno_EXDEV_get = 325; // native
const uint32_t C_errno___errno_ENODEV_get = 326; // native
const uint32_t C_errno___errno_ENOTDIR_get = 327; // native
const uint32_t C_errno___errno_EISDIR_get = 328; // native
const uint32_t C_errno___errno_EINVAL_get = 329; // native
const uint32_t C_errno___errno_ENFILE_get = 330; // native
const uint32_t C_errno___errno_EMFILE_get = 331; // native
const uint32_t C_errno___errno_ENOTTY_get = 332; // native
const uint32_t C_errno___errno_ETXTBSY_get = 333; // native
const uint32_t C_errno___errno_EFBIG_get = 334; // native
const uint32_t C_errno___errno_ENOSPC_get = 335; // native
const uint32_t C_errno___errno_ESPIPE_get = 336; // native
const uint32_t C_errno___errno_EROFS_get = 337; // native
const uint32_t C_errno___errno_EMLINK_get = 338; // native
const uint32_t C_errno___errno_EPIPE_get = 339; // native
const uint32_t C_errno___errno_EDOM_get = 340; // native
const uint32_t C_errno___errno_ERANGE_get = 341; // native
const uint32_t C_errno___errno_EDEADLK_get = 342; // native
const uint32_t C_errno___errno_ENAMETOOLONG_get = 343; // native
const uint32_t C_errno___errno_ENOLCK_get = 344; // native
const uint32_t C_errno___errno_ENOSYS_get = 345; // native
const uint32_t C_errno___errno_ENOTEMPTY_get = 346; // native
const uint32_t C_errno___errno_ELOOP_get = 347; // native
const uint32_t C_errno___errno_EWOULDBLOCK_get = 348; // native
const uint32_t C_errno___errno_ENOMSG_get = 349; // native
const uint32_t C_errno___errno_EIDRM_get = 350; // native
const uint32_t C_errno___errno_EDEADLOCK_get = 351; // native
const uint32_t C_errno___errno_ENOSTR_get = 352; // native
const uint32_t C_errno___errno_ENODATA_get = 353; // native
const uint32_t C_errno___errno_ETIME_get = 354; // native
const uint32_t C_errno___errno_ENOSR_get = 355; // native
const uint32_t C_errno___errno_ENOLINK_get = 356; // native
const uint32_t C_errno___errno_EBADMSG_get = 357; // native
const uint32_t C_errno___errno_EOVERFLOW_get = 358; // native
const uint32_t C_errno___errno_EILSEQ_get = 359; // native
const uint32_t C_errno___errno_ENOTSOCK_get = 360; // native
const uint32_t C_errno___errno_EDESTADDRREQ_get = 361; // native
const uint32_t C_errno___errno_EMSGSIZE_get = 362; // native
const uint32_t C_errno___errno_EPROTO_get = 363; // native
const uint32_t C_errno___errno_EPROTOTYPE_get = 364; // native
const uint32_t C_errno___errno_ENOPROTOOPT_get = 365; // native
const uint32_t C_errno___errno_EPROTONOSUPPORT_get = 366; // native
const uint32_t C_errno___errno_EOPNOTSUPP_get = 367; // native
const uint32_t C_errno___errno_EAFNOSUPPORT_get = 368; // native
const uint32_t C_errno___errno_EADDRINUSE_get = 369; // native
const uint32_t C_errno___errno_EADDRNOTAVAIL_get = 370; // native
const uint32_t C_errno___errno_ENETDOWN_get = 371; // native
const uint32_t C_errno___errno_ENETUNREACH_get = 372; // native
const uint32_t C_errno___errno_ENETRESET_get = 373; // native
const uint32_t C_errno___errno_ECONNABORTED_get = 374; // native
const uint32_t C_errno___errno_ECONNRESET_get = 375; // native
const uint32_t C_errno___errno_ENOBUFS_get = 376; // native
const uint32_t C_errno___errno_EISCONN_get = 377; // native
const uint32_t C_errno___errno_ENOTCONN_get = 378; // native
const uint32_t C_errno___errno_ETIMEDOUT_get = 379; // native
const uint32_t C_errno___errno_ECONNREFUSED_get = 380; // native
const uint32_t C_errno___errno_EHOSTUNREACH_get = 381; // native
const uint32_t C_errno___errno_EALREADY_get = 382; // native
const uint32_t C_errno___errno_EINPROGRESS_get = 383; // native
const uint32_t C_errno___errno_ECANCELED_get = 384; // native
const uint32_t C_errno___errno_EOWNERDEAD_get = 385; // native
const uint32_t C_errno___errno_ENOTRECOVERABLE_get = 386; // native
const uint32_t C_errno___errno_EREMOTE_get = 387; // native
const uint32_t C_errno___errno_EUSERS_get = 388; // native
const uint32_t C_errno___errno_ESOCKTNOSUPPORT_get = 389; // native
const uint32_t C_errno___errno_EPFNOSUPPORT_get = 390; // native
const uint32_t C_errno___errno_ESHUTDOWN_get = 391; // native
const uint32_t C_errno___errno_ETOOMANYREFS_get = 392; // native
const uint32_t C_errno___errno_EHOSTDOWN_get = 393; // native
const uint32_t C_errno___errno_ESTALE_get = 394; // native
const uint32_t C_errno___errno_EDQUOT_get = 395; // native
const uint32_t C_errno___errno_EMULTIHOP_get = 396; // native
const uint32_t C_errno___errno_ECHRNG_get = 397; // native
const uint32_t C_errno___errno_EL2NSYNC_get = 398; // native
const uint32_t C_errno___errno_EL3HLT_get = 399; // native
const uint32_t C_errno___errno_EL3RST_get = 400; // native
const uint32_t C_errno___errno_ELNRNG_get = 401; // native
const uint32_t C_errno___errno_EUNATCH_get = 402; // native
const uint32_t C_errno___errno_ENOCSI_get = 403; // native
const uint32_t C_errno___errno_EL2HLT_get = 404; // native
const uint32_t C_errno___errno_EBADE_get = 405; // native
const uint32_t C_errno___errno_EBADR_get = 406; // native
const uint32_t C_errno___errno_EXFULL_get = 407; // native
const uint32_t C_errno___errno_ENOANO_get = 408; // native
const uint32_t C_errno___errno_EBADRQC_get = 409; // native
const uint32_t C_errno___errno_EBADSLT_get = 410; // native
const uint32_t C_errno___errno_EBFONT_get = 411; // native
const uint32_t C_errno___errno_ENONET_get = 412; // native
const uint32_t C_errno___errno_ENOPKG_get = 413; // native
const uint32_t C_errno___errno_EADV_get = 414; // native
const uint32_t C_errno___errno_ESRMNT_get = 415; // native
const uint32_t C_errno___errno_ECOMM_get = 416; // native
const uint32_t C_errno___errno_EDOTDOT_get = 417; // native
const uint32_t C_errno___errno_ENOTUNIQ_get = 418; // native
const uint32_t C_errno___errno_EBADFD_get = 419; // native
const uint32_t C_errno___errno_EREMCHG_get = 420; // native
const uint32_t C_errno___errno_ELIBACC_get = 421; // native
const uint32_t C_errno___errno_ELIBBAD_get = 422; // native
const uint32_t C_errno___errno_ELIBSCN_get = 423; // native
const uint32_t C_errno___errno_ELIBMAX_get = 424; // native
const uint32_t C_errno___errno_ELIBEXEC_get = 425; // native
const uint32_t C_errno___errno_ERESTART_get = 426; // native
const uint32_t C_errno___errno_ESTRPIPE_get = 427; // native
const uint32_t C_errno___errno_EUCLEAN_get = 428; // native
const uint32_t C_errno___errno_ENOTNAM_get = 429; // native
const uint32_t C_errno___errno_ENAVAIL_get = 430; // native
const uint32_t C_errno___errno_EISNAM_get = 431; // native
const uint32_t C_errno___errno_EREMOTEIO_get = 432; // native
const uint32_t C_errno___errno_ENOMEDIUM_get = 433; // native
const uint32_t C_errno___errno_EMEDIUMTYPE_get = 434; // native
const uint32_t C_errno___errno_ENOKEY_get = 435; // native
const uint32_t C_errno___errno_EKEYEXPIRED_get = 436; // native
const uint32_t C_errno___errno_EKEYREVOKED_get = 437; // native
const uint32_t C_errno___errno_EKEYREJECTED_get = 438; // native
const uint32_t C_errno___errno_ERFKILL_get = 439; // native
const uint32_t C_errno___errno_EHWPOISON_get = 440; // native
const uint32_t C_errno___errno__GetErrno = 441; // native
const uint32_t C_errno___errno__SetErrno = 442; // native
const uint32_t C_errno_ErrorNumber_value_get = 446; // abc
const uint32_t C_errno_ErrorNumber_value_set = 447; // abc
const uint32_t C_errno_ErrorNumber_valueOf = 448; // abc
const uint32_t C_errno_ErrorNumber_toString = 449; // abc
const uint32_t C_errno_ErrorNumber_toErrnoString = 450; // abc
const uint32_t C_errno_CError_errorID_get = 453; // abc
const uint32_t C_errno_CError_apply = 454; // abc
const uint32_t C_errno_CError_toString = 455; // abc
const uint32_t C_limits___limits_CHAR_BIT_get = 457; // native
const uint32_t C_limits___limits_CHAR_MAX_get = 458; // native
const uint32_t C_limits___limits_CHAR_MIN_get = 459; // native
const uint32_t C_limits___limits_INT_MAX_get = 460; // native
const uint32_t C_limits___limits_INT_MIN_get = 461; // native
const uint32_t C_limits___limits_LLONG_MAX_get = 462; // native
const uint32_t C_limits___limits_LLONG_MIN_get = 463; // native
const uint32_t C_limits___limits_LONG_BIT_get = 464; // native
const uint32_t C_limits___limits_LONG_MAX_get = 465; // native
const uint32_t C_limits___limits_LONG_MIN_get = 466; // native
const uint32_t C_limits___limits_SCHAR_MAX_get = 467; // native
const uint32_t C_limits___limits_SCHAR_MIN_get = 468; // native
const uint32_t C_limits___limits_SHRT_MAX_get = 469; // native
const uint32_t C_limits___limits_SHRT_MIN_get = 470; // native
const uint32_t C_limits___limits_UCHAR_MAX_get = 471; // native
const uint32_t C_limits___limits_UINT_MAX_get = 472; // native
const uint32_t C_limits___limits_ULLONG_MAX_get = 473; // native
const uint32_t C_limits___limits_ULONG_MAX_get = 474; // native
const uint32_t C_limits___limits_USHRT_MAX_get = 475; // native
const uint32_t C_limits___limits_WORD_BIT_get = 476; // native
const uint32_t C_limits___limits_ARG_MAX_get = 477; // native
const uint32_t C_limits___limits_ATEXIT_MAX_get = 478; // native
const uint32_t C_limits___limits_CHILD_MAX_get = 479; // native
const uint32_t C_limits___limits_LINK_MAX_get = 480; // native
const uint32_t C_limits___limits_MAX_CANON_get = 481; // native
const uint32_t C_limits___limits_MAX_INPUT_get = 482; // native
const uint32_t C_limits___limits_NAME_MAX_get = 483; // native
const uint32_t C_limits___limits_NGROUPS_MAX_get = 484; // native
const uint32_t C_limits___limits_OPEN_MAX_get = 485; // native
const uint32_t C_limits___limits_PATH_MAX_get = 486; // native
const uint32_t C_limits___limits_PIPE_BUF_get = 487; // native
const uint32_t C_limits___limits_SSIZE_MAX_get = 488; // native
const uint32_t C_limits___limits_STREAM_MAX_get = 489; // native
const uint32_t C_limits___limits_TZNAME_MAX_get = 490; // native
const uint32_t C_limits___limits_MB_LEN_MAX_get = 491; // native
const uint32_t C_limits___limits_SIZE_MAX_get = 492; // native
const uint32_t C_limits___limits_SYMLINK_MAX_get = 493; // native
const uint32_t C_limits___limits_AIO_LISTIO_MAX_get = 494; // native
const uint32_t C_limits___limits_AIO_MAX_get = 495; // native
const uint32_t C_limits___limits_AIO_PRIO_DELTA_MAX_get = 496; // native
const uint32_t C_limits___limits_DELAYTIMER_MAX_get = 497; // native
const uint32_t C_limits___limits_HOST_NAME_MAX_get = 498; // native
const uint32_t C_limits___limits_LOGIN_NAME_MAX_get = 499; // native
const uint32_t C_limits___limits_MQ_OPEN_MAX_get = 500; // native
const uint32_t C_limits___limits_MQ_PRIO_MAX_get = 501; // native
const uint32_t C_limits___limits_PAGESIZE_get = 502; // native
const uint32_t C_limits___limits_PAGE_SIZE_get = 503; // native
const uint32_t C_limits___limits_RE_DUP_MAX_get = 504; // native
const uint32_t C_limits___limits_RTSIG_MAX_get = 505; // native
const uint32_t C_limits___limits_SEM_NSEMS_MAX_get = 506; // native
const uint32_t C_limits___limits_SEM_VALUE_MAX_get = 507; // native
const uint32_t C_limits___limits_SIGQUEUE_MAX_get = 508; // native
const uint32_t C_limits___limits_SS_REPL_MAX_get = 509; // native
const uint32_t C_limits___limits_SYMLOOP_MAX_get = 510; // native
const uint32_t C_limits___limits_TIMER_MAX_get = 511; // native
const uint32_t C_limits___limits_TRACE_EVENT_NAME_MAX_get = 512; // native
const uint32_t C_limits___limits_TRACE_NAME_MAX_get = 513; // native
const uint32_t C_limits___limits_TRACE_SYS_MAX_get = 514; // native
const uint32_t C_limits___limits_TRACE_USER_EVENT_MAX_get = 515; // native
const uint32_t C_limits___limits_TTY_NAME_MAX_get = 516; // native
const uint32_t C_limits___limits__POSIX_ARG_MAX_get = 517; // native
const uint32_t C_limits___limits__POSIX_CHILD_MAX_get = 518; // native
const uint32_t C_limits___limits__POSIX_LINK_MAX_get = 519; // native
const uint32_t C_limits___limits__POSIX_MAX_CANON_get = 520; // native
const uint32_t C_limits___limits__POSIX_MAX_INPUT_get = 521; // native
const uint32_t C_limits___limits__POSIX_NAME_MAX_get = 522; // native
const uint32_t C_limits___limits__POSIX_NGROUPS_MAX_get = 523; // native
const uint32_t C_limits___limits__POSIX_OPEN_MAX_get = 524; // native
const uint32_t C_limits___limits__POSIX_PATH_MAX_get = 525; // native
const uint32_t C_limits___limits__POSIX_PIPE_BUF_get = 526; // native
const uint32_t C_limits___limits__POSIX_SSIZE_MAX_get = 527; // native
const uint32_t C_limits___limits__POSIX_STREAM_MAX_get = 528; // native
const uint32_t C_limits___limits__POSIX_TZNAME_MAX_get = 529; // native
const uint32_t C_limits___limits__POSIX_SYMLINK_MAX_get = 530; // native
const uint32_t C_limits___limits__POSIX_AIO_LISTIO_MAX_get = 531; // native
const uint32_t C_limits___limits__POSIX_AIO_MAX_get = 532; // native
const uint32_t C_limits___limits__POSIX_DELAYTIMER_MAX_get = 533; // native
const uint32_t C_limits___limits__POSIX_HOST_NAME_MAX_get = 534; // native
const uint32_t C_limits___limits__POSIX_LOGIN_NAME_MAX_get = 535; // native
const uint32_t C_limits___limits__POSIX_MQ_OPEN_MAX_get = 536; // native
const uint32_t C_limits___limits__POSIX_MQ_PRIO_MAX_get = 537; // native
const uint32_t C_limits___limits__POSIX_RE_DUP_MAX_get = 538; // native
const uint32_t C_limits___limits__POSIX_RTSIG_MAX_get = 539; // native
const uint32_t C_limits___limits__POSIX_SEM_NSEMS_MAX_get = 540; // native
const uint32_t C_limits___limits__POSIX_SEM_VALUE_MAX_get = 541; // native
const uint32_t C_limits___limits__POSIX_SIGQUEUE_MAX_get = 542; // native
const uint32_t C_limits___limits__POSIX_SS_REPL_MAX_get = 543; // native
const uint32_t C_limits___limits__POSIX_SYMLOOP_MAX_get = 544; // native
const uint32_t C_limits___limits__POSIX_TIMER_MAX_get = 545; // native
const uint32_t C_limits___limits__POSIX_TRACE_EVENT_NAME_MAX_get = 546; // native
const uint32_t C_limits___limits__POSIX_TRACE_NAME_MAX_get = 547; // native
const uint32_t C_limits___limits__POSIX_TRACE_SYS_MAX_get = 548; // native
const uint32_t C_limits___limits__POSIX_TRACE_USER_EVENT_MAX_get = 549; // native
const uint32_t C_limits___limits__POSIX_TTY_NAME_MAX_get = 550; // native
const uint32_t C_locale___locale_LC_ALL_get = 553; // native
const uint32_t C_signal___signal_SIGEV_NONE_get = 556; // native
const uint32_t C_signal___signal_SIGEV_SIGNAL_get = 557; // native
const uint32_t C_signal___signal_SIGEV_THREAD_get = 558; // native
const uint32_t C_stdio___stdio_BUFSIZ_get = 565; // native
const uint32_t C_stdio___stdio__IOFBF_get = 566; // native
const uint32_t C_stdio___stdio__IOLBF_get = 567; // native
const uint32_t C_stdio___stdio__IONBF_get = 568; // native
const uint32_t C_stdio___stdio_SEEK_CUR_get = 569; // native
const uint32_t C_stdio___stdio_SEEK_END_get = 570; // native
const uint32_t C_stdio___stdio_SEEK_SET_get = 571; // native
const uint32_t C_stdio___stdio_FILENAME_MAX_get = 572; // native
const uint32_t C_stdio___stdio_FOPEN_MAX_get = 573; // native
const uint32_t C_stdio___stdio_TMP_MAX_get = 574; // native
const uint32_t C_stdio___stdio_EOF_get = 575; // native
const uint32_t C_stdio___stdio_stdin_get = 576; // native
const uint32_t C_stdio___stdio_stdout_get = 577; // native
const uint32_t C_stdio___stdio_stderr_get = 578; // native
const uint32_t C_stdio___stdio__getc = 579; // native
const uint32_t C_stdio___stdio__getc_unlocked = 580; // native
const uint32_t C_stdio___stdio__getchar_unlocked = 581; // native
const uint32_t C_stdlib___stdlib_EXIT_SUCCESS_get = 588; // native
const uint32_t C_stdlib___stdlib_EXIT_FAILURE_get = 589; // native
const uint32_t C_stdlib___stdlib_RAND_MAX_get = 590; // native
const uint32_t C_stdlib___stdlib_MB_CUR_MAX_get = 591; // native
const uint32_t C_stdlib___stdlib__str2num = 592; // abc
const uint32_t C_stdlib___stdlib__str2int = 593; // abc
const uint32_t C_stdlib___stdlib__str2uint = 594; // abc
const uint32_t C_stdlib_div_t_toString = 598; // abc
const uint32_t C_stdlib_ldiv_t_toString = 601; // abc
const uint32_t C_stdlib_lldiv_t_toString = 604; // abc
const uint32_t C_time___time_CLOCKS_PER_SEC_get = 606; // native
const uint32_t C_arpa_inet___inet__htonl = 615; // native
const uint32_t C_arpa_inet___inet__htons = 616; // native
const uint32_t C_arpa_inet___inet__ntohl = 617; // native
const uint32_t C_arpa_inet___inet__ntohs = 618; // native
const uint32_t C_arpa_inet___inet__inet_addr = 619; // native
const uint32_t C_arpa_inet___inet__inet_network = 620; // native
const uint32_t C_arpa_inet___inet__inet_ntoa = 621; // native
const uint32_t C_arpa_inet___inet__inet_aton = 622; // native
const uint32_t C_arpa_inet___inet__inet_ntop4 = 623; // native
const uint32_t C_arpa_inet___inet__inet_ntop6 = 624; // native
const uint32_t C_arpa_inet___inet__inet_pton4 = 625; // native
const uint32_t C_arpa_inet___inet__inet_pton6 = 626; // native
const uint32_t C_fcntl___fcntl_O_RDONLY_get = 633; // native
const uint32_t C_fcntl___fcntl_O_WRONLY_get = 634; // native
const uint32_t C_fcntl___fcntl_O_RDWR_get = 635; // native
const uint32_t C_fcntl___fcntl_O_ACCMODE_get = 636; // native
const uint32_t C_fcntl___fcntl_O_APPEND_get = 637; // native
const uint32_t C_fcntl___fcntl_O_CREAT_get = 638; // native
const uint32_t C_fcntl___fcntl_O_TRUNC_get = 639; // native
const uint32_t C_fcntl___fcntl_O_EXCL_get = 640; // native
const uint32_t C_fcntl___fcntl_O_EXEC_get = 641; // native
const uint32_t C_fcntl___fcntl_O_CLOEXEC_get = 642; // native
const uint32_t C_fcntl___fcntl_O_DIRECTORY_get = 643; // native
const uint32_t C_fcntl___fcntl_O_NOFOLLOW_get = 644; // native
const uint32_t C_fcntl___fcntl_O_NONBLOCK_get = 645; // native
const uint32_t C_fcntl___fcntl_O_NOCTTY_get = 646; // native
const uint32_t C_fcntl___fcntl_O_SEARCH_get = 647; // native
const uint32_t C_fcntl___fcntl_O_TTY_INIT_get = 648; // native
const uint32_t C_fcntl___fcntl_O_SYNC_get = 649; // native
const uint32_t C_fcntl___fcntl_O_DSYNC_get = 650; // native
const uint32_t C_fcntl___fcntl_O_RSYNC_get = 651; // native
const uint32_t C_fcntl___fcntl_O_ASYNC_get = 652; // native
const uint32_t C_fcntl___fcntl_O_FSYNC_get = 653; // native
const uint32_t C_fcntl___fcntl_O_SHLOCK_get = 654; // native
const uint32_t C_fcntl___fcntl_O_EXLOCK_get = 655; // native
const uint32_t C_fcntl___fcntl_O_TEXT_get = 656; // native
const uint32_t C_fcntl___fcntl_O_BINARY_get = 657; // native
const uint32_t C_fcntl___fcntl_O_WTEXT_get = 658; // native
const uint32_t C_fcntl___fcntl_O_U16TEXT_get = 659; // native
const uint32_t C_fcntl___fcntl_O_U8TEXT_get = 660; // native
const uint32_t C_fcntl___fcntl_O_RAW_get = 661; // native
const uint32_t C_fcntl___fcntl_O_NOINHERIT_get = 662; // native
const uint32_t C_fcntl___fcntl_O_TEMPORARY_get = 663; // native
const uint32_t C_fcntl___fcntl_O_SHORT_LIVED_get = 664; // native
const uint32_t C_fcntl___fcntl_O_SEQUENTIAL_get = 665; // native
const uint32_t C_fcntl___fcntl_O_RANDOM_get = 666; // native
const uint32_t C_fcntl___fcntl_F_DUPFD_get = 667; // native
const uint32_t C_fcntl___fcntl_F_DUPFD_CLOEXEC_get = 668; // native
const uint32_t C_fcntl___fcntl_F_GETFD_get = 669; // native
const uint32_t C_fcntl___fcntl_F_SETFD_get = 670; // native
const uint32_t C_fcntl___fcntl_F_GETFL_get = 671; // native
const uint32_t C_fcntl___fcntl_F_SETFL_get = 672; // native
const uint32_t C_fcntl___fcntl_F_GETOWN_get = 673; // native
const uint32_t C_fcntl___fcntl_F_SETOWN_get = 674; // native
const uint32_t C_netdb___netdb_AI_PASSIVE_get = 677; // native
const uint32_t C_netdb___netdb_AI_CANONNAME_get = 678; // native
const uint32_t C_netdb___netdb_AI_NUMERICHOST_get = 679; // native
const uint32_t C_netdb___netdb_AI_NUMERICSERV_get = 680; // native
const uint32_t C_netdb___netdb_AI_V4MAPPED_get = 681; // native
const uint32_t C_netdb___netdb_AI_ALL_get = 682; // native
const uint32_t C_netdb___netdb_AI_ADDRCONFIG_get = 683; // native
const uint32_t C_netdb___netdb_NI_NOFQDN_get = 684; // native
const uint32_t C_netdb___netdb_NI_NUMERICHOST_get = 685; // native
const uint32_t C_netdb___netdb_NI_NAMEREQD_get = 686; // native
const uint32_t C_netdb___netdb_NI_NUMERICSERV_get = 687; // native
const uint32_t C_netdb___netdb_NI_NUMERICSCOPE_get = 688; // native
const uint32_t C_netdb___netdb_NI_DGRAM_get = 689; // native
const uint32_t C_netdb___netdb_EAI_AGAIN_get = 690; // native
const uint32_t C_netdb___netdb_EAI_BADFLAGS_get = 691; // native
const uint32_t C_netdb___netdb_EAI_FAIL_get = 692; // native
const uint32_t C_netdb___netdb_EAI_FAMILY_get = 693; // native
const uint32_t C_netdb___netdb_EAI_MEMORY_get = 694; // native
const uint32_t C_netdb___netdb_EAI_NONAME_get = 695; // native
const uint32_t C_netdb___netdb_EAI_SERVICE_get = 696; // native
const uint32_t C_netdb___netdb_EAI_SOCKTYPE_get = 697; // native
const uint32_t C_netdb___netdb_EAI_SYSTEM_get = 698; // native
const uint32_t C_netdb___netdb_EAI_OVERFLOW_get = 699; // native
const uint32_t C_netdb___netdb_gethostbyaddr4 = 700; // native
const uint32_t C_netdb___netdb_gethostbyaddr6 = 701; // native
const uint32_t C_netdb_hostent_h_addr_get = 705; // abc
const uint32_t C_netdb_hostent_toString = 706; // abc
const uint32_t C_netdb_protoent_toString = 710; // abc
const uint32_t C_netdb_addrinfo_toString = 716; // abc
const uint32_t C_netdb_CEAIrror_errorID_get = 719; // abc
const uint32_t C_netdb_CEAIrror_apply = 720; // abc
const uint32_t C_netdb_CEAIrror_toString = 721; // abc
const uint32_t C_netinet___netinet_IPPROTO_IP_get = 723; // native
const uint32_t C_netinet___netinet_IPPROTO_IPV6_get = 724; // native
const uint32_t C_netinet___netinet_IPPROTO_ICMP_get = 725; // native
const uint32_t C_netinet___netinet_IPPROTO_RAW_get = 726; // native
const uint32_t C_netinet___netinet_IPPROTO_TCP_get = 727; // native
const uint32_t C_netinet___netinet_IPPROTO_UDP_get = 728; // native
const uint32_t C_netinet___netinet_INET_ADDRSTRLEN_get = 729; // native
const uint32_t C_netinet___netinet_INET6_ADDRSTRLEN_get = 730; // native
const uint32_t C_netinet___netinet_IPV6_JOIN_GROUP_get = 731; // native
const uint32_t C_netinet___netinet_IPV6_LEAVE_GROUP_get = 732; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_HOPS_get = 733; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_IF_get = 734; // native
const uint32_t C_netinet___netinet_IPV6_MULTICAST_LOOP_get = 735; // native
const uint32_t C_netinet___netinet_IPV6_UNICAST_HOPS_get = 736; // native
const uint32_t C_netinet___netinet_IPV6_V6ONLY_get = 737; // native
const uint32_t C_netinet_in_addr_private__tohex = 741; // abc
const uint32_t C_netinet_in_addr_isValid = 742; // abc
const uint32_t C_netinet_in_addr_toString = 743; // abc
const uint32_t C_netinet_sockaddr_in_toString = 746; // abc
const uint32_t C_netinet_in6_addr_fromArray = 748; // abc
const uint32_t C_netinet_in6_addr_fromVarArgs = 749; // abc
const uint32_t C_netinet_in6_addr_private__tohex = 751; // abc
const uint32_t C_netinet_in6_addr_isValid = 752; // abc
const uint32_t C_netinet_in6_addr_toString = 753; // abc
const uint32_t C_netinet_sockaddr_in6_toString = 756; // abc
const uint32_t C_spawn_pid_t_valueOf = 760; // abc
const uint32_t C_spawn_pid_t_toString = 761; // abc
const uint32_t C_sys_select___select_FD_SETSIZE_get = 764; // native
const uint32_t C_sys_select_timeval_toString = 768; // abc
const uint32_t C_sys_socket___socket_SOCK_DGRAM_get = 772; // native
const uint32_t C_sys_socket___socket_SOCK_RAW_get = 773; // native
const uint32_t C_sys_socket___socket_SOCK_SEQPACKET_get = 774; // native
const uint32_t C_sys_socket___socket_SOCK_STREAM_get = 775; // native
const uint32_t C_sys_socket___socket_SOL_SOCKET_get = 776; // native
const uint32_t C_sys_socket___socket_SO_ACCEPTCONN_get = 777; // native
const uint32_t C_sys_socket___socket_SO_BROADCAST_get = 778; // native
const uint32_t C_sys_socket___socket_SO_DEBUG_get = 779; // native
const uint32_t C_sys_socket___socket_SO_DONTROUTE_get = 780; // native
const uint32_t C_sys_socket___socket_SO_ERROR_get = 781; // native
const uint32_t C_sys_socket___socket_SO_KEEPALIVE_get = 782; // native
const uint32_t C_sys_socket___socket_SO_LINGER_get = 783; // native
const uint32_t C_sys_socket___socket_SO_OOBINLINE_get = 784; // native
const uint32_t C_sys_socket___socket_SO_RCVBUF_get = 785; // native
const uint32_t C_sys_socket___socket_SO_RCVLOWAT_get = 786; // native
const uint32_t C_sys_socket___socket_SO_RCVTIMEO_get = 787; // native
const uint32_t C_sys_socket___socket_SO_REUSEADDR_get = 788; // native
const uint32_t C_sys_socket___socket_SO_SNDBUF_get = 789; // native
const uint32_t C_sys_socket___socket_SO_SNDLOWAT_get = 790; // native
const uint32_t C_sys_socket___socket_SO_SNDTIMEO_get = 791; // native
const uint32_t C_sys_socket___socket_SO_TYPE_get = 792; // native
const uint32_t C_sys_socket___socket_SOMAXCONN_get = 793; // native
const uint32_t C_sys_socket___socket_MSG_CTRUNC_get = 794; // native
const uint32_t C_sys_socket___socket_MSG_DONTROUTE_get = 795; // native
const uint32_t C_sys_socket___socket_MSG_EOR_get = 796; // native
const uint32_t C_sys_socket___socket_MSG_OOB_get = 797; // native
const uint32_t C_sys_socket___socket_MSG_NOSIGNAL_get = 798; // native
const uint32_t C_sys_socket___socket_MSG_PEEK_get = 799; // native
const uint32_t C_sys_socket___socket_MSG_TRUNC_get = 800; // native
const uint32_t C_sys_socket___socket_MSG_WAITALL_get = 801; // native
const uint32_t C_sys_socket___socket_AF_INET_get = 802; // native
const uint32_t C_sys_socket___socket_AF_INET6_get = 803; // native
const uint32_t C_sys_socket___socket_AF_UNIX_get = 804; // native
const uint32_t C_sys_socket___socket_AF_UNSPEC_get = 805; // native
const uint32_t C_sys_socket___socket_SHUT_RD_get = 806; // native
const uint32_t C_sys_socket___socket_SHUT_RDWR_get = 807; // native
const uint32_t C_sys_socket___socket_SHUT_WR_get = 808; // native
const uint32_t C_sys_socket___socket_accept4 = 809; // native
const uint32_t C_sys_socket___socket_accept6 = 810; // native
const uint32_t C_sys_socket___socket_bind4 = 811; // native
const uint32_t C_sys_socket___socket_bind6 = 812; // native
const uint32_t C_sys_socket___socket_connect4 = 813; // native
const uint32_t C_sys_socket___socket_connect6 = 814; // native
const uint32_t C_sys_socket___socket_getpeername4 = 815; // native
const uint32_t C_sys_socket___socket_getpeername6 = 816; // native
const uint32_t C_sys_socket___socket_getsockname4 = 817; // native
const uint32_t C_sys_socket___socket_getsockname6 = 818; // native
const uint32_t C_sys_socket___socket_getsockoptint = 819; // native
const uint32_t C_sys_socket___socket_recvfrom4 = 820; // native
const uint32_t C_sys_socket___socket_recvfrom6 = 821; // native
const uint32_t C_sys_socket___socket_sendto4 = 822; // native
const uint32_t C_sys_socket___socket_sendto6 = 823; // native
const uint32_t C_sys_socket___socket_setsockoptint = 824; // native
const uint32_t C_sys_socket_sockaddr_private__load = 828; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_storage = 829; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_in = 830; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr_in6 = 831; // abc
const uint32_t C_sys_socket_sockaddr_toSockaddr = 832; // abc
const uint32_t C_sys_stat___stat_mkdir = 838; // native
const uint32_t C_sys_stat_status_toString = 841; // abc
const uint32_t C_sys_wait___wait_WCONTINUED_get = 846; // native
const uint32_t C_sys_wait___wait_WNOHANG_get = 847; // native
const uint32_t C_sys_wait___wait_WUNTRACED_get = 848; // native
const uint32_t C_sys_wait___wait_WEXITED_get = 849; // native
const uint32_t C_sys_wait___wait_WNOWAIT_get = 850; // native
const uint32_t C_sys_wait___wait_WSTOPPED_get = 851; // native
const uint32_t C_sys_wait___wait_P_ALL_get = 852; // native
const uint32_t C_sys_wait___wait_P_PGID_get = 853; // native
const uint32_t C_sys_wait___wait_P_PID_get = 854; // native
const uint32_t C_sys_wait___wait__WEXITSTATUS = 855; // native
const uint32_t C_sys_wait___wait__WIFCONTINUED = 856; // native
const uint32_t C_sys_wait___wait__WIFEXITED = 857; // native
const uint32_t C_sys_wait___wait__WIFSIGNALED = 858; // native
const uint32_t C_sys_wait___wait__WIFSTOPPED = 859; // native
const uint32_t C_sys_wait___wait__WSTOPSIG = 860; // native
const uint32_t C_sys_wait___wait__WTERMSIG = 861; // native
const uint32_t C_unistd___unistd_F_OK_get = 866; // native
const uint32_t C_unistd___unistd_X_OK_get = 867; // native
const uint32_t C_unistd___unistd_W_OK_get = 868; // native
const uint32_t C_unistd___unistd_R_OK_get = 869; // native
const uint32_t C_unistd___unistd_getcwd = 870; // native
const uint32_t C_unistd___unistd_gethostname = 871; // native
const uint32_t C_unistd___unistd_getlogin = 872; // native
const uint32_t C_unistd___unistd_getpid = 873; // native
const uint32_t C_unistd___unistd_rmdir = 874; // native
const uint32_t C_unistd___unistd_sleep = 875; // native
const uint32_t C_unistd___unistd_unlink = 876; // native
const uint32_t shell_Program_private__getArgv = 879; // native
const uint32_t shell_Program_private__getEnviron = 880; // native
const uint32_t shell_Program_private__getProgramFilename = 881; // native
const uint32_t shell_Program_private__isProjector = 882; // native
const uint32_t shell_Program_private__setExitListener = 883; // native
const uint32_t shell_Program_private__popenRead = 884; // native
const uint32_t shell_Program_private__findShell = 885; // abc
const uint32_t shell_Program_private__findType = 886; // abc
const uint32_t shell_Program_totalMemory_get = 887; // native
const uint32_t shell_Program_freeMemory_get = 888; // native
const uint32_t shell_Program_privateMemory_get = 889; // native
const uint32_t shell_Program_environ_get = 890; // abc
const uint32_t shell_Program_environment_get = 891; // abc
const uint32_t shell_Program_filename_get = 892; // abc
const uint32_t shell_Program_pid_get = 893; // abc
const uint32_t shell_Program_shell_get = 894; // abc
const uint32_t shell_Program_type_get = 895; // abc
const uint32_t shell_Program_workingDirectory_get = 896; // abc
const uint32_t shell_Program_workingDirectory_set = 897; // abc
const uint32_t shell_Program_atExit = 898; // abc
const uint32_t shell_Program_AVM2_setExitListener = 899; // abc
const uint32_t shell_Program_AVM2_selfCheck = 900; // abc
const uint32_t shell_Program_abort = 901; // native
const uint32_t shell_Program_exec = 902; // native
const uint32_t shell_Program_exit = 903; // native
const uint32_t shell_Program_open = 904; // abc
const uint32_t shell_Program_sleep = 905; // native
const uint32_t shell_Program_getNanosecondTimer = 906; // native
const uint32_t shell_Program_getTimer = 907; // native
const uint32_t shell_Program_readLine = 908; // native
const uint32_t shell_Program_write = 909; // native
const uint32_t shell_Program_writeLine = 910; // abc
const uint32_t shell_Program_trace = 911; // native
const uint32_t shell_Program_forceFullCollection = 912; // native
const uint32_t shell_Program_queueCollection = 913; // native
const uint32_t shell_Program_pauseForGCIfCollectionImminent = 914; // native
const uint32_t shell_Program_disposeXML = 915; // native
const uint32_t shell_Runtime_private__getAvmplusPlatform = 918; // native
const uint32_t shell_Runtime_private__getAvmplusArchitecture = 919; // native
const uint32_t shell_Runtime_private__getAvmplusVersion = 920; // native
const uint32_t shell_Runtime_private__getAvmplusDescription = 921; // native
const uint32_t shell_Runtime_private__getFeatures = 922; // native
const uint32_t shell_Runtime_private__getRunmode = 923; // native
const uint32_t shell_Runtime_private__getEndian = 924; // native
const uint32_t shell_Runtime_private__parseRegExpResult = 925; // abc
const uint32_t shell_Runtime_private__parseVersion = 926; // abc
const uint32_t shell_Runtime_private__parseTag = 927; // abc
const uint32_t shell_Runtime_private__redtamarinDetect = 929; // abc
const uint32_t shell_Runtime_apiVersion_get = 930; // native
const uint32_t shell_Runtime_api_get = 931; // abc
const uint32_t shell_Runtime_swfVersion_get = 932; // native
const uint32_t shell_Runtime_platform_get = 933; // abc
const uint32_t shell_Runtime_architecture_get = 934; // abc
const uint32_t shell_Runtime_AVMversion_get = 935; // abc
const uint32_t shell_Runtime_description_get = 936; // abc
const uint32_t shell_Runtime_version_get = 937; // abc
const uint32_t shell_Runtime_tag_get = 938; // abc
const uint32_t shell_Runtime_codename_get = 939; // abc
const uint32_t shell_Runtime_label_get = 940; // abc
const uint32_t shell_Runtime_features_get = 941; // abc
const uint32_t shell_Runtime_runmode_get = 942; // abc
const uint32_t shell_Runtime_endian_get = 943; // abc
const uint32_t shell_Runtime_redtamarin_get = 944; // abc
const uint32_t shell_Runtime_loop_get = 945; // abc
const uint32_t shell_Runtime_loop_set = 946; // abc
const uint32_t shell_Runtime_eval = 947; // native
const uint32_t shell_Runtime_returnEval = 948; // native
const uint32_t shell_Runtime_is64bit = 949; // native
const uint32_t shell_Diagnostics_private__isGlobal = 952; // native
const uint32_t shell_Diagnostics_private__isIntptr = 953; // native
const uint32_t shell_Diagnostics_private__canonicalizeNumber = 954; // native
const uint32_t shell_Diagnostics_private__deopt = 955; // native
const uint32_t shell_Diagnostics_private__runInSafepoint = 956; // native
const uint32_t shell_Diagnostics_private__log = 957; // native
const uint32_t shell_Diagnostics_private__initializeLogging = 958; // native
const uint32_t shell_Diagnostics_debugger = 959; // native
const uint32_t shell_Diagnostics_isDebugger = 960; // native
const uint32_t shell_Diagnostics_AVM2_log = 961; // abc
const uint32_t shell_Diagnostics_AVM2_initializeLogging = 962; // abc
const uint32_t shell_Diagnostics_AVM2_isGlobal = 963; // abc
const uint32_t shell_Diagnostics_AVM2_isIntptr = 964; // abc
const uint32_t shell_Diagnostics_AVM2_canonicalizeNumber = 965; // abc
const uint32_t shell_Diagnostics_AVM2_deopt = 966; // abc
const uint32_t shell_Diagnostics_AVM2_runInSafepoint = 967; // abc
const uint32_t shell_HardwareInformation_private__getProcessorCountAtBoot = 970; // native
const uint32_t shell_HardwareInformation_private__getMemorySize = 971; // native
const uint32_t shell_HardwareInformation_private__getMemoryFree = 972; // native
const uint32_t shell_HardwareInformation_private__getProcMemoryUsage = 973; // native
const uint32_t shell_HardwareInformation_private__getProcMemoryPeakUsage = 974; // native
const uint32_t shell_HardwareInformation_processors_get = 975; // abc
const uint32_t shell_HardwareInformation_memory_get = 976; // abc
const uint32_t shell_HardwareInformation_memoryUsage_get = 977; // abc
const uint32_t shell_HardwareInformation_memoryFree_get = 978; // abc
const uint32_t shell_HardwareInformation_processMemoryUsage_get = 979; // abc
const uint32_t shell_HardwareInformation_processMemoryPeakUsage_get = 980; // abc
const uint32_t shell_OperatingSystem_private__parseRegExpResult = 983; // abc
const uint32_t shell_OperatingSystem_private__getVersionFrom = 984; // abc
const uint32_t shell_OperatingSystem_private__findWithin = 985; // abc
const uint32_t shell_OperatingSystem_private__windowsDetect = 986; // abc
const uint32_t shell_OperatingSystem_private__windowsReadVerOutput = 987; // abc
const uint32_t shell_OperatingSystem_private__windowsParseVersion = 988; // abc
const uint32_t shell_OperatingSystem_private__macintoshDetect = 989; // abc
const uint32_t shell_OperatingSystem_private__macintoshParseSystemVersionFile = 990; // abc
const uint32_t shell_OperatingSystem_private__macintoshParseSystemVersion = 991; // abc
const uint32_t shell_OperatingSystem_private__linuxDetect = 992; // abc
const uint32_t shell_OperatingSystem_private__linuxParseConfig = 993; // abc
const uint32_t shell_OperatingSystem_private__linuxParseReleaseFile = 994; // abc
const uint32_t shell_OperatingSystem_private__linuxParseUbuntuReleaseFile = 995; // abc
const uint32_t shell_OperatingSystem_private__getNameAll = 996; // abc
const uint32_t shell_OperatingSystem_private__getVersionAll = 997; // abc
const uint32_t shell_OperatingSystem_private__getVendorAll = 998; // abc
const uint32_t shell_OperatingSystem_private__getVendorNameAll = 999; // abc
const uint32_t shell_OperatingSystem_private__getVendorVersionAll = 1000; // abc
const uint32_t shell_OperatingSystem_private__getVendorBuildAll = 1001; // abc
const uint32_t shell_OperatingSystem_private__getVendorDescriptionAll = 1002; // abc
const uint32_t shell_OperatingSystem_private__getCodenameAll = 1003; // abc
const uint32_t shell_OperatingSystem_private__getLongDescriptionAll = 1004; // abc
const uint32_t shell_OperatingSystem_isWindowsStore = 1005; // native
const uint32_t shell_OperatingSystem_name_get = 1006; // abc
const uint32_t shell_OperatingSystem_version_get = 1007; // abc
const uint32_t shell_OperatingSystem_hostname_get = 1008; // abc
const uint32_t shell_OperatingSystem_username_get = 1009; // abc
const uint32_t shell_OperatingSystem_vendor_get = 1010; // abc
const uint32_t shell_OperatingSystem_vendorName_get = 1011; // abc
const uint32_t shell_OperatingSystem_vendorVersion_get = 1012; // abc
const uint32_t shell_OperatingSystem_vendorBuild_get = 1013; // abc
const uint32_t shell_OperatingSystem_vendorDescription_get = 1014; // abc
const uint32_t shell_OperatingSystem_codename_get = 1015; // abc
const uint32_t shell_OperatingSystem_longDescription_get = 1016; // abc
const uint32_t shell_FileSystem_private__isAttributeHidden = 1019; // native
const uint32_t shell_FileSystem_private__getLogicalDrives = 1020; // native
const uint32_t shell_FileSystem_private__findLogicalDrives = 1021; // abc
const uint32_t shell_FileSystem_private__findRootDirectory = 1022; // abc
const uint32_t shell_FileSystem_private__findHomeDirectory = 1023; // abc
const uint32_t shell_FileSystem_private__filterWithRegexp = 1025; // abc
const uint32_t shell_FileSystem_drives_get = 1026; // abc
const uint32_t shell_FileSystem_lineEnding_get = 1027; // abc
const uint32_t shell_FileSystem_rootDirectory_get = 1028; // abc
const uint32_t shell_FileSystem_homeDirectory_get = 1029; // abc
const uint32_t shell_FileSystem_separators_get = 1030; // abc
const uint32_t shell_FileSystem_pathSeparator_get = 1031; // abc
const uint32_t shell_FileSystem_nativeRead = 1032; // native
const uint32_t shell_FileSystem_nativeWrite = 1033; // native
const uint32_t shell_FileSystem_nativeReadByteArray = 1034; // native
const uint32_t shell_FileSystem_nativeWriteByteArray = 1035; // native
const uint32_t shell_FileSystem_absolutePath = 1036; // abc
const uint32_t shell_FileSystem_normalizePath = 1037; // abc
const uint32_t shell_FileSystem_getBasenameFromPath = 1038; // abc
const uint32_t shell_FileSystem_getDirectoryFromPath = 1039; // abc
const uint32_t shell_FileSystem_getComponentsFromPath = 1040; // abc
const uint32_t shell_FileSystem_containsPath = 1041; // abc
const uint32_t shell_FileSystem_create = 1042; // abc
const uint32_t shell_FileSystem_createByteArray = 1043; // abc
const uint32_t shell_FileSystem_createDirectory = 1044; // abc
const uint32_t shell_FileSystem_copyFile = 1045; // abc
const uint32_t shell_FileSystem_copyFiles = 1046; // abc
const uint32_t shell_FileSystem_bufferedCopyFile = 1047; // abc
const uint32_t shell_FileSystem_bufferedFastCopyFile = 1048; // abc
const uint32_t shell_FileSystem_copyDirectory = 1049; // abc
const uint32_t shell_FileSystem_exists = 1050; // abc
const uint32_t shell_FileSystem_move = 1051; // abc
const uint32_t shell_FileSystem_remove = 1052; // abc
const uint32_t shell_FileSystem_removeFile = 1053; // abc
const uint32_t shell_FileSystem_removeDirectory = 1054; // abc
const uint32_t shell_FileSystem_read = 1055; // abc
const uint32_t shell_FileSystem_readByteArray = 1056; // abc
const uint32_t shell_FileSystem_bufferedReadByteArray = 1057; // abc
const uint32_t shell_FileSystem_write = 1058; // abc
const uint32_t shell_FileSystem_writeByteArray = 1059; // abc
const uint32_t shell_FileSystem_bufferedWriteByteArray = 1060; // abc
const uint32_t shell_FileSystem_canAccess = 1061; // abc
const uint32_t shell_FileSystem_canRead = 1062; // abc
const uint32_t shell_FileSystem_canWrite = 1063; // abc
const uint32_t shell_FileSystem_hasDriveLetter = 1064; // abc
const uint32_t shell_FileSystem_getFileMode = 1065; // abc
const uint32_t shell_FileSystem_getFileAccessTime = 1066; // abc
const uint32_t shell_FileSystem_getFileModifiedTime = 1067; // abc
const uint32_t shell_FileSystem_getFileChangedTime = 1068; // abc
const uint32_t shell_FileSystem_getFileSize = 1069; // abc
const uint32_t shell_FileSystem_getSize = 1070; // abc
const uint32_t shell_FileSystem_getDirectorySize = 1071; // abc
const uint32_t shell_FileSystem_getFreeDiskSpace = 1072; // native
const uint32_t shell_FileSystem_getTotalDiskSpace = 1073; // native
const uint32_t shell_FileSystem_getUsedDiskSpace = 1074; // abc
const uint32_t shell_FileSystem_isRegularFile = 1075; // abc
const uint32_t shell_FileSystem_isRegularFileMode = 1076; // abc
const uint32_t shell_FileSystem_isDirectory = 1077; // abc
const uint32_t shell_FileSystem_isDirectoryMode = 1078; // abc
const uint32_t shell_FileSystem_isHidden = 1079; // abc
const uint32_t shell_FileSystem_isDotOrDotdot = 1080; // abc
const uint32_t shell_FileSystem_isSeparator = 1081; // abc
const uint32_t shell_FileSystem_isEmptyDirectory = 1082; // abc
const uint32_t shell_FileSystem_isValidWindowsComponent = 1083; // abc
const uint32_t shell_FileSystem_isValidMacintoshComponent = 1084; // abc
const uint32_t shell_FileSystem_isValidLinuxComponent = 1085; // abc
const uint32_t shell_FileSystem_isValidComponent = 1086; // abc
const uint32_t shell_FileSystem_isValidEverywhereComponent = 1087; // abc
const uint32_t shell_FileSystem_isValid = 1088; // abc
const uint32_t shell_FileSystem_isValidEverywhere = 1089; // abc
const uint32_t shell_FileSystem_endsWithSeparator = 1090; // abc
const uint32_t shell_FileSystem_ensureEndsWithSeparator = 1091; // abc
const uint32_t shell_FileSystem_stripTrailingSeparators = 1092; // abc
const uint32_t shell_FileSystem_listFilesOrDirectories = 1093; // abc
const uint32_t shell_FileSystem_listFilesOrDirectoriesWithFilter = 1094; // abc
const uint32_t shell_FileSystem_listFilesOrDirectoriesWithRegexp = 1095; // abc
const uint32_t shell_FileSystem_listFiles = 1096; // abc
const uint32_t shell_FileSystem_listFilesWithFilter = 1097; // abc
const uint32_t shell_FileSystem_listFilesWithRegexp = 1098; // abc
const uint32_t shell_FileSystem_listDirectories = 1099; // abc
const uint32_t shell_FileSystem_listDirectoriesWithFilter = 1100; // abc
const uint32_t shell_FileSystem_listDirectoriesWithRegexp = 1101; // abc
const uint32_t shell_FileSystem_listByDepth = 1102; // abc
const uint32_t shell_FileSystem_listByBreadth = 1103; // abc
const uint32_t shell_Cygwin_private__getAvailability = 1110; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry = 1111; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry32 = 1112; // abc
const uint32_t shell_Cygwin_private__findCygwinInRegistry64 = 1113; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory = 1114; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory32 = 1115; // abc
const uint32_t shell_Cygwin_private__getCygwinInstallDirectory64 = 1116; // abc
const uint32_t shell_Cygwin_private__getCygwinShell = 1117; // abc
const uint32_t shell_Cygwin_isAvailable_get = 1118; // abc
const uint32_t shell_Cygwin_installDirectory_get = 1119; // abc
const uint32_t shell_Cygwin_shell_get = 1120; // abc
const uint32_t shell_Cygwin_addToEnvironment = 1121; // abc
const uint32_t shell_Cygwin_forceInstallDirectory = 1122; // abc
const uint32_t shell_Cygwin_forceShell = 1123; // abc
const uint32_t shell_Cygwin_open = 1124; // abc
const uint32_t shell_Domain_currentDomain_get = 1127; // native
const uint32_t shell_Domain_MIN_DOMAIN_MEMORY_LENGTH_get = 1128; // native
const uint32_t shell_Domain_private_init = 1129; // native
const uint32_t shell_Domain_parentDomain_get = 1131; // abc
const uint32_t shell_Domain_loadBytes = 1132; // native
const uint32_t shell_Domain_getClass = 1133; // native
const uint32_t shell_Domain_getDefinition = 1134; // abc
const uint32_t shell_Domain_hasDefinition = 1135; // abc
const uint32_t shell_Domain_load = 1136; // abc
const uint32_t shell_Domain_domainMemory_get = 1137; // native
const uint32_t shell_Domain_domainMemory_set = 1138; // native
const uint32_t shell_Environment_private__parse = 1141; // abc
const uint32_t shell_Environment_private__findIndexBy = 1142; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_callProperty = 1143; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_deleteProperty = 1144; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_getProperty = 1145; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_setProperty = 1146; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_hasProperty = 1147; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextNameIndex = 1148; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextName = 1149; // abc
const uint32_t shell_Environment_http___www_adobe_com_2006_actionscript_flash_proxy_nextValue = 1150; // abc
const uint32_t shell_Environment_length_get = 1151; // abc
const uint32_t shell_Environment_hasOwnProperty = 1152; // abc
const uint32_t shell_Environment_propertyIsEnumerable = 1153; // abc
const uint32_t shell_Environment_synchronised_get = 1154; // abc
const uint32_t shell_Environment_refresh = 1155; // abc
const uint32_t shell_Environment_toArray = 1156; // abc
const uint32_t shell_Environment_toObject = 1157; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_running_get = 1161; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_running_set = 1162; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frequency_get = 1163; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frequency_set = 1164; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timers_get = 1165; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timers_set = 1166; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_frame_get = 1167; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_started_get = 1168; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_elapsed_get = 1169; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_timerPending_get = 1170; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_setCallback = 1171; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_handleTimers = 1172; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_start = 1173; // abc
const uint32_t shell_async_EventLoop_shell_async_EventLoop_stop = 1174; // abc
const uint32_t flash_accessibility_ISearchableText_flash_accessibility_ISearchableText_searchText_get = 1177; // abc
const uint32_t flash_accessibility_ISimpleTextSelection_flash_accessibility_ISimpleTextSelection_selectionAnchorIndex_get = 1180; // abc
const uint32_t flash_accessibility_ISimpleTextSelection_flash_accessibility_ISimpleTextSelection_selectionActiveIndex_get = 1181; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accRole = 1187; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accName = 1188; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accValue = 1189; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accState = 1190; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accDefaultAction = 1191; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accDoDefaultAction = 1192; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_isLabeledBy = 1193; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_getChildIDArray = 1194; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accLocation = 1195; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accSelection = 1196; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_accFocus = 1197; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_accSelect = 1198; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_selectionAnchorIndex = 1199; // abc
const uint32_t flash_accessibility_AccessibilityImplementation_get_selectionActiveIndex = 1200; // abc
const uint32_t flash_data_EncryptedLocalStore_isSupported_get = 1204; // abc
const uint32_t flash_display_Scene_name_get = 1254; // abc
const uint32_t flash_display_Scene_labels_get = 1255; // abc
const uint32_t flash_display_Scene_numFrames_get = 1256; // abc
const uint32_t flash_errors_SQLError_operation_get = 1283; // abc
const uint32_t flash_errors_SQLError_details_get = 1284; // abc
const uint32_t flash_errors_SQLError_detailID_get = 1285; // abc
const uint32_t flash_errors_SQLError_detailArguments_get = 1286; // abc
const uint32_t flash_errors_DRMManagerError_subErrorID_get = 1289; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_addEventListener = 1291; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_dispatchEvent = 1292; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_hasEventListener = 1293; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_removeEventListener = 1294; // abc
const uint32_t flash_events_IEventDispatcher_flash_events_IEventDispatcher_willTrigger = 1295; // abc
const uint32_t flash_events_Event_private_ctor = 1299; // abc
const uint32_t flash_events_Event_type_get = 1300; // abc
const uint32_t flash_events_Event_bubbles_get = 1301; // abc
const uint32_t flash_events_Event_cancelable_get = 1302; // abc
const uint32_t flash_events_Event_target_get = 1303; // abc
const uint32_t flash_events_Event_currentTarget_get = 1304; // abc
const uint32_t flash_events_Event_eventPhase_get = 1305; // abc
const uint32_t flash_events_Event_formatToString = 1306; // abc
const uint32_t flash_events_Event_clone = 1307; // abc
const uint32_t flash_events_Event_isDefaultPrevented = 1308; // abc
const uint32_t flash_events_Event_preventDefault = 1309; // abc
const uint32_t flash_events_Event_stopImmediatePropagation = 1310; // abc
const uint32_t flash_events_Event_stopPropagation = 1311; // abc
const uint32_t flash_events_Event_toString = 1312; // abc
const uint32_t flash_filesystem_File_isDummy = 1314; // native
const uint32_t flash_filesystem_File_isLocalDummy = 1315; // native
const uint32_t flash_filesystem_File_url_get = 1317; // abc
const uint32_t flash_filesystem_File_url_set = 1318; // abc
const uint32_t flash_filesystem_File_nativePath_get = 1319; // abc
const uint32_t flash_filesystem_File_nativePath_set = 1320; // abc
const uint32_t flash_filesystem_FileStream_open = 1325; // abc
const uint32_t flash_filesystem_FileStream_openAsync = 1326; // abc
const uint32_t flash_filesystem_FileStream_truncate = 1327; // abc
const uint32_t flash_filesystem_FileStream_close = 1328; // abc
const uint32_t flash_geom_Point_interpolate = 1332; // abc
const uint32_t flash_geom_Point_distance = 1333; // abc
const uint32_t flash_geom_Point_polar = 1334; // abc
const uint32_t flash_geom_Point_length_get = 1336; // abc
const uint32_t flash_geom_Point_clone = 1337; // abc
const uint32_t flash_geom_Point_offset = 1338; // abc
const uint32_t flash_geom_Point_equals = 1339; // abc
const uint32_t flash_geom_Point_subtract = 1340; // abc
const uint32_t flash_geom_Point_add = 1341; // abc
const uint32_t flash_geom_Point_normalize = 1342; // abc
const uint32_t flash_geom_Point_toString = 1343; // abc
const uint32_t flash_geom_Rectangle_left_get = 1346; // abc
const uint32_t flash_geom_Rectangle_left_set = 1347; // abc
const uint32_t flash_geom_Rectangle_right_get = 1348; // abc
const uint32_t flash_geom_Rectangle_right_set = 1349; // abc
const uint32_t flash_geom_Rectangle_top_get = 1350; // abc
const uint32_t flash_geom_Rectangle_top_set = 1351; // abc
const uint32_t flash_geom_Rectangle_bottom_get = 1352; // abc
const uint32_t flash_geom_Rectangle_bottom_set = 1353; // abc
const uint32_t flash_geom_Rectangle_topLeft_get = 1354; // abc
const uint32_t flash_geom_Rectangle_topLeft_set = 1355; // abc
const uint32_t flash_geom_Rectangle_bottomRight_get = 1356; // abc
const uint32_t flash_geom_Rectangle_bottomRight_set = 1357; // abc
const uint32_t flash_geom_Rectangle_size_get = 1358; // abc
const uint32_t flash_geom_Rectangle_size_set = 1359; // abc
const uint32_t flash_geom_Rectangle_clone = 1360; // abc
const uint32_t flash_geom_Rectangle_isEmpty = 1361; // abc
const uint32_t flash_geom_Rectangle_setEmpty = 1362; // abc
const uint32_t flash_geom_Rectangle_inflate = 1363; // abc
const uint32_t flash_geom_Rectangle_inflatePoint = 1364; // abc
const uint32_t flash_geom_Rectangle_offset = 1365; // abc
const uint32_t flash_geom_Rectangle_offsetPoint = 1366; // abc
const uint32_t flash_geom_Rectangle_contains = 1367; // abc
const uint32_t flash_geom_Rectangle_containsPoint = 1368; // abc
const uint32_t flash_geom_Rectangle_containsRect = 1369; // abc
const uint32_t flash_geom_Rectangle_intersection = 1370; // abc
const uint32_t flash_geom_Rectangle_intersects = 1371; // abc
const uint32_t flash_geom_Rectangle_union = 1372; // abc
const uint32_t flash_geom_Rectangle_equals = 1373; // abc
const uint32_t flash_geom_Rectangle_toString = 1374; // abc
const uint32_t flash_net_FileReference_isDummy = 1376; // native
const uint32_t flash_net_FileReference_isLocalDummy = 1377; // native
const uint32_t flash_net_FileReference_private__reset = 1379; // abc
const uint32_t flash_net_FileReference_creationDate_get = 1380; // abc
const uint32_t flash_net_FileReference_creator_get = 1381; // abc
const uint32_t flash_net_FileReference_modificationDate_get = 1382; // abc
const uint32_t flash_net_FileReference_name_get = 1383; // abc
const uint32_t flash_net_FileReference_size_get = 1384; // abc
const uint32_t flash_net_FileReference_type_get = 1385; // abc
const uint32_t flash_net_FileReference_data_get = 1386; // abc
const uint32_t flash_net_FileReference_extension_get = 1387; // abc
const uint32_t flash_net_FileReference_browse = 1388; // abc
const uint32_t flash_net_FileReference_AVM2_browseOverride = 1389; // abc
const uint32_t flash_net_FileReference_private__load = 1390; // abc
const uint32_t flash_net_FileReference_load = 1391; // abc
const uint32_t flash_net_FileReference_private__save = 1392; // abc
const uint32_t flash_net_FileReference_save = 1393; // abc
const uint32_t flash_net_FileReference_AVM2_saveOverride = 1394; // abc
const uint32_t flash_net_FileReference_uploadUnencoded = 1395; // abc
const uint32_t flash_net_URLRequest_private_setRequestHeaders = 1398; // abc
const uint32_t flash_net_URLRequest_private_filterRequestHeaders = 1399; // abc
const uint32_t flash_net_URLRequest_requestHeaders_get = 1400; // abc
const uint32_t flash_net_URLRequest_requestHeaders_set = 1401; // abc
const uint32_t flash_net_URLRequest_userAgent_get = 1402; // abc
const uint32_t flash_net_URLRequest_userAgent_set = 1403; // abc
const uint32_t flash_net_URLRequestDefaults_private_initLoginCredentials = 1405; // abc
const uint32_t flash_net_URLRequestDefaults_private_initUA = 1406; // abc
const uint32_t flash_net_URLRequestDefaults_setLoginCredentialsForHost = 1407; // abc
const uint32_t flash_net_URLRequestDefaults_followRedirects_get = 1408; // abc
const uint32_t flash_net_URLRequestDefaults_followRedirects_set = 1409; // abc
const uint32_t flash_net_URLRequestDefaults_idleTimeout_get = 1410; // abc
const uint32_t flash_net_URLRequestDefaults_idleTimeout_set = 1411; // abc
const uint32_t flash_sampler_StackFrame_toString = 1416; // abc
const uint32_t flash_system_Capabilities_avHardwareDisable_get = 1423; // abc
const uint32_t flash_system_Capabilities_cpuArchitecture_get = 1424; // abc
const uint32_t flash_system_Capabilities_manufacturer_get = 1425; // abc
const uint32_t flash_system_Capabilities_playerType_get = 1426; // abc
const uint32_t flash_system_Capabilities_isDebugger_get = 1427; // abc
const uint32_t flash_system_Capabilities_supports32BitProcesses_get = 1428; // abc
const uint32_t flash_system_Capabilities_supports64BitProcesses_get = 1429; // abc
const uint32_t flash_system_Capabilities_hasMultiChannelAudio = 1430; // abc
const uint32_t flash_system_Security_exactSettings_get = 1433; // abc
const uint32_t flash_system_Security_exactSettings_set = 1434; // abc
const uint32_t flash_system_Security_pageDomain_get = 1435; // abc
const uint32_t flash_system_Security_AVM2_pageDomain_set = 1436; // abc
const uint32_t flash_system_Security_sandboxType_get = 1437; // abc
const uint32_t flash_system_Security_AVM2_sandboxType_set = 1438; // abc
const uint32_t flash_system_Security_allowDomain = 1439; // abc
const uint32_t flash_system_Security_allowInsecureDomain = 1440; // abc
const uint32_t flash_system_Security_loadPolicyFile = 1441; // abc
const uint32_t flash_system_Security_showSettings = 1442; // abc
const uint32_t flash_system_System_setClipboard = 1447; // abc
const uint32_t flash_system_System_totalMemory_get = 1448; // abc
const uint32_t flash_system_System_totalMemoryNumber_get = 1449; // abc
const uint32_t flash_system_System_freeMemory_get = 1450; // native
const uint32_t flash_system_System_privateMemory_get = 1451; // abc
const uint32_t flash_system_System_useCodePage_get = 1452; // abc
const uint32_t flash_system_System_useCodePage_set = 1453; // abc
const uint32_t flash_system_System_vmVersion_get = 1454; // abc
const uint32_t flash_system_System_pause = 1455; // abc
const uint32_t flash_system_System_resume = 1456; // abc
const uint32_t flash_system_System_exit = 1457; // abc
const uint32_t flash_system_System_gc = 1458; // abc
const uint32_t flash_system_System_disposeXML = 1459; // abc
const uint32_t flash_system_WorkerState_code = 1462; // abc
const uint32_t flash_system_Worker_current_get = 1465; // abc
const uint32_t flash_system_Worker_pr = 1466; // native
const uint32_t flash_system_Worker_state_get = 1468; // native
const uint32_t flash_system_Worker_start = 1469; // native
const uint32_t flash_system_Worker_isParentOf = 1470; // native
const uint32_t flash_system_Worker_isPrimordial_get = 1471; // native
const uint32_t flash_system_Worker_setSharedProperty = 1472; // native
const uint32_t flash_system_Worker_getSharedProperty = 1473; // native
const uint32_t flash_system_Worker_terminate = 1474; // native
const uint32_t flash_system_WorkerEvent_currentState_get = 1477; // abc
const uint32_t flash_system_WorkerEvent_previousState_get = 1478; // abc
const uint32_t flash_system_WorkerEvent_target_get = 1479; // abc
const uint32_t flash_system_WorkerDomain_current_get = 1481; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromByteArray = 1483; // abc
const uint32_t flash_system_WorkerDomain_createWorkerFromPrimordial = 1484; // abc
const uint32_t flash_system_WorkerDomain_private_createWorkerFromByteArrayInternal = 1485; // native
const uint32_t flash_system_WorkerDomain_listWorkers = 1486; // native
const uint32_t flash_trace_Trace_setLevel = 1488; // native
const uint32_t flash_trace_Trace_getLevel = 1489; // native
const uint32_t flash_trace_Trace_setListener = 1490; // native
const uint32_t flash_trace_Trace_getListener = 1491; // native
const uint32_t shell_async_CoreEventLoop_running_get = 1497; // abc
const uint32_t shell_async_CoreEventLoop_running_set = 1498; // abc
const uint32_t shell_async_CoreEventLoop_frequency_get = 1499; // abc
const uint32_t shell_async_CoreEventLoop_frequency_set = 1500; // abc
const uint32_t shell_async_CoreEventLoop_timers_get = 1501; // abc
const uint32_t shell_async_CoreEventLoop_timers_set = 1502; // abc
const uint32_t shell_async_CoreEventLoop_frame_get = 1503; // abc
const uint32_t shell_async_CoreEventLoop_started_get = 1504; // abc
const uint32_t shell_async_CoreEventLoop_elapsed_get = 1505; // abc
const uint32_t shell_async_CoreEventLoop_private_tick = 1506; // abc
const uint32_t shell_async_CoreEventLoop_setCallback = 1507; // abc
const uint32_t shell_async_CoreEventLoop_private__loop = 1508; // abc
const uint32_t shell_async_CoreEventLoop_timerPending_get = 1509; // abc
const uint32_t shell_async_CoreEventLoop_handleTimers = 1510; // abc
const uint32_t shell_async_CoreEventLoop_start = 1511; // abc
const uint32_t shell_async_CoreEventLoop_stop = 1512; // abc
const uint32_t flash_events_EventDispatcher_private_trimHeaderValue = 1514; // abc
const uint32_t flash_events_EventDispatcher_private_ctor = 1516; // abc
const uint32_t flash_events_EventDispatcher_private_dispatchEventFunction = 1517; // abc
const uint32_t flash_events_EventDispatcher_private_dispatchHttpStatusEvent = 1519; // abc
const uint32_t flash_events_EventDispatcher_addEventListener = 1520; // abc
const uint32_t flash_events_EventDispatcher_dispatchEvent = 1521; // abc
const uint32_t flash_events_EventDispatcher_hasEventListener = 1522; // abc
const uint32_t flash_events_EventDispatcher_removeEventListener = 1523; // abc
const uint32_t flash_events_EventDispatcher_willTrigger = 1524; // abc
const uint32_t flash_events_EventDispatcher_toString = 1525; // abc
const uint32_t flash_events_HTTPStatusEvent_status_get = 1528; // abc
const uint32_t flash_events_HTTPStatusEvent_responseURL_get = 1529; // abc
const uint32_t flash_events_HTTPStatusEvent_responseURL_set = 1530; // abc
const uint32_t flash_events_HTTPStatusEvent_responseHeaders_get = 1531; // abc
const uint32_t flash_events_HTTPStatusEvent_responseHeaders_set = 1532; // abc
const uint32_t flash_events_HTTPStatusEvent_redirected_get = 1533; // abc
const uint32_t flash_events_HTTPStatusEvent_redirected_set = 1534; // abc
const uint32_t flash_events_HTTPStatusEvent_clone = 1535; // abc
const uint32_t flash_events_HTTPStatusEvent_toString = 1536; // abc
const uint32_t flash_events_TimerEvent_clone = 1539; // abc
const uint32_t flash_events_TimerEvent_toString = 1540; // abc
const uint32_t flash_events_TimerEvent_updateAfterEvent = 1541; // abc
const uint32_t flash_sampler_NewObjectSample_object_get = 1543; // native
const uint32_t flash_sampler_NewObjectSample_size_get = 1544; // native
const uint32_t flash_utils_Timer_private__timerDispatch = 1550; // abc
const uint32_t flash_utils_Timer_private__start = 1551; // abc
const uint32_t flash_utils_Timer_tick = 1552; // abc
const uint32_t flash_utils_Timer_delay_get = 1553; // abc
const uint32_t flash_utils_Timer_delay_set = 1554; // abc
const uint32_t flash_utils_Timer_repeatCount_get = 1555; // abc
const uint32_t flash_utils_Timer_repeatCount_set = 1556; // abc
const uint32_t flash_utils_Timer_currentCount_get = 1557; // abc
const uint32_t flash_utils_Timer_running_get = 1558; // abc
const uint32_t flash_utils_Timer_reset = 1559; // abc
const uint32_t flash_utils_Timer_start = 1560; // abc
const uint32_t flash_utils_Timer_stop = 1561; // abc
...
extern avmplus::Atom native_script_function_C_conio_set_binary_mode_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom native_script_function_C_conio_set_binary_mode_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
extern avmplus::Atom shell_Program_private__isProjector_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom shell_Program_private__isProjector_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
extern double shell_HardwareInformation_private__getMemoryFree_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double shell_HardwareInformation_private__getMemoryFree_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double shell_HardwareInformation_private__getProcMemoryUsage_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double shell_HardwareInformation_private__getProcMemoryUsage_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double shell_HardwareInformation_private__getProcMemoryPeakUsage_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double shell_HardwareInformation_private__getProcMemoryPeakUsage_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
private:
    ...
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_http___code_google_com_p_redtamarin_AVM2__filename;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_http___code_google_com_p_redtamarin_AVM2__type;
...
public:
    REALLY_INLINE void gcTracePrivateProperties(MMgc::GC* gc)
    {
        ...
        gc->TraceLocation(&m_http___code_google_com_p_redtamarin_AVM2__filename);
        gc->TraceLocation(&m_http___code_google_com_p_redtamarin_AVM2__type);
...
#define DECLARE_SLOTS_ProgramClass \
    ...
    protected: \
        REALLY_INLINE avmplus::String* get__filename() const { return m_slots_ProgramClass.m_http___code_google_com_p_redtamarin_AVM2__filename; } \
        REALLY_INLINE void set__filename(avmplus::String* newVal) { m_slots_ProgramClass.m_http___code_google_com_p_redtamarin_AVM2__filename = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__type() const { return m_slots_ProgramClass.m_http___code_google_com_p_redtamarin_AVM2__type; } \
        REALLY_INLINE void set__type(avmplus::String* newVal) { m_slots_ProgramClass.m_http___code_google_com_p_redtamarin_AVM2__type = newVal; } \
    protected: \
...
private:
    ...
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_CODENAME;
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_private__API;
    avmplus::AtomWB m_private__version;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__tag;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__codename;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__label;
...
#define DECLARE_SLOTS_RuntimeClass \
    ...
    protected: \
        REALLY_INLINE avmplus::String* get_CODENAME() const { return m_slots_RuntimeClass.m_private_CODENAME; } \
        REALLY_INLINE void setconst_CODENAME(avmplus::String* newVal) { m_slots_RuntimeClass.m_private_CODENAME = newVal; } \
    protected: \
    ...
    protected: \
        REALLY_INLINE avmplus::Atom get__version() const { return m_slots_RuntimeClass.m_private__version; } \
        REALLY_INLINE void set__version(avmplus::Atom newVal) { m_slots_RuntimeClass.m_private__version = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__tag() const { return m_slots_RuntimeClass.m_private__tag; } \
        REALLY_INLINE void set__tag(avmplus::String* newVal) { m_slots_RuntimeClass.m_private__tag = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__codename() const { return m_slots_RuntimeClass.m_private__codename; } \
        REALLY_INLINE void set__codename(avmplus::String* newVal) { m_slots_RuntimeClass.m_private__codename = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__label() const { return m_slots_RuntimeClass.m_private__label; } \
        REALLY_INLINE void set__label(avmplus::String* newVal) { m_slots_RuntimeClass.m_private__label = newVal; } \
    protected: \
...
private:
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_EMPTY;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_UNKNOWN;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__name;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__version;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__hostname;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__username;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__vendor;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__vendorName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__vendorVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__vendorBuild;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__vendorDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__codename;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__longDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_MICROSOFT;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_NT;
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_private__windows;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsProductName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsReleaseVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsBuild;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsLongDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__windowsCodename;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_APPLE;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_MAC_OS_X;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_PRODUCT_NAME;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_PRODUCT_BUILD_VERSION;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_PRODUCT_VERSION;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_PRODUCT_USER_VISIBLE_VERSION;
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_private__macintosh;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshProductName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshProductBuildVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshProductVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshProductUserVisibleVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshProductDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshLongDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__macintoshCodename;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_LINUX;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_DISTRIB_ID;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_DISTRIB_RELEASE;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_DISTRIB_DESCRIPTION;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_DISTRIB_CODENAME;
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_private__linuxDistros;
    MMgc::GCTraceableObject::GCMember<avmplus::ArrayObject> m_private__ubuntu;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxVendorName;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxVendorVersion;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxVendorBuild;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxVendorDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxLongDescription;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__linuxCodename;
};
#define DECLARE_SLOTS_OperatingSystemClass \
    ...
    private: \
        friend class avmplus::NativeID::SlotOffsetsAndAsserts; \
    protected: \
        REALLY_INLINE avmplus::String* get_EMPTY() const { return m_slots_OperatingSystemClass.m_private_EMPTY; } \
        REALLY_INLINE void setconst_EMPTY(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_EMPTY = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_UNKNOWN() const { return m_slots_OperatingSystemClass.m_private_UNKNOWN; } \
        REALLY_INLINE void setconst_UNKNOWN(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_UNKNOWN = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__name() const { return m_slots_OperatingSystemClass.m_private__name; } \
        REALLY_INLINE void set__name(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__name = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__version() const { return m_slots_OperatingSystemClass.m_private__version; } \
        REALLY_INLINE void set__version(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__version = newVal; } \
    protected: \
    ...
    protected: \
        REALLY_INLINE avmplus::String* get__username() const { return m_slots_OperatingSystemClass.m_private__username; } \
        REALLY_INLINE void set__username(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__username = newVal; } \
    protected: \
    ...
    protected: \
        REALLY_INLINE avmplus::String* get__vendorName() const { return m_slots_OperatingSystemClass.m_private__vendorName; } \
        REALLY_INLINE void set__vendorName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__vendorName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__vendorVersion() const { return m_slots_OperatingSystemClass.m_private__vendorVersion; } \
        REALLY_INLINE void set__vendorVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__vendorVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__vendorBuild() const { return m_slots_OperatingSystemClass.m_private__vendorBuild; } \
        REALLY_INLINE void set__vendorBuild(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__vendorBuild = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__vendorDescription() const { return m_slots_OperatingSystemClass.m_private__vendorDescription; } \
        REALLY_INLINE void set__vendorDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__vendorDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__codename() const { return m_slots_OperatingSystemClass.m_private__codename; } \
        REALLY_INLINE void set__codename(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__codename = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__longDescription() const { return m_slots_OperatingSystemClass.m_private__longDescription; } \
        REALLY_INLINE void set__longDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__longDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_MICROSOFT() const { return m_slots_OperatingSystemClass.m_private_MICROSOFT; } \
        REALLY_INLINE void setconst_MICROSOFT(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_MICROSOFT = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_NT() const { return m_slots_OperatingSystemClass.m_private_NT; } \
        REALLY_INLINE void setconst_NT(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_NT = newVal; } \
    protected: \
        REALLY_INLINE avmplus::ArrayObject* get__windows() const { return m_slots_OperatingSystemClass.m_private__windows; } \
        REALLY_INLINE void set__windows(avmplus::ArrayObject* newVal) { m_slots_OperatingSystemClass.m_private__windows = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsName() const { return m_slots_OperatingSystemClass.m_private__windowsName; } \
        REALLY_INLINE void set__windowsName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsVersion() const { return m_slots_OperatingSystemClass.m_private__windowsVersion; } \
        REALLY_INLINE void set__windowsVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsProductName() const { return m_slots_OperatingSystemClass.m_private__windowsProductName; } \
        REALLY_INLINE void set__windowsProductName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsProductName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsReleaseVersion() const { return m_slots_OperatingSystemClass.m_private__windowsReleaseVersion; } \
        REALLY_INLINE void set__windowsReleaseVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsReleaseVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsBuild() const { return m_slots_OperatingSystemClass.m_private__windowsBuild; } \
        REALLY_INLINE void set__windowsBuild(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsBuild = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsDescription() const { return m_slots_OperatingSystemClass.m_private__windowsDescription; } \
        REALLY_INLINE void set__windowsDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsLongDescription() const { return m_slots_OperatingSystemClass.m_private__windowsLongDescription; } \
        REALLY_INLINE void set__windowsLongDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsLongDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__windowsCodename() const { return m_slots_OperatingSystemClass.m_private__windowsCodename; } \
        REALLY_INLINE void set__windowsCodename(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__windowsCodename = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_APPLE() const { return m_slots_OperatingSystemClass.m_private_APPLE; } \
        REALLY_INLINE void setconst_APPLE(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_APPLE = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_MAC_OS_X() const { return m_slots_OperatingSystemClass.m_private_MAC_OS_X; } \
        REALLY_INLINE void setconst_MAC_OS_X(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_MAC_OS_X = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_PRODUCT_NAME() const { return m_slots_OperatingSystemClass.m_private_PRODUCT_NAME; } \
        REALLY_INLINE void setconst_PRODUCT_NAME(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_PRODUCT_NAME = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_PRODUCT_BUILD_VERSION() const { return m_slots_OperatingSystemClass.m_private_PRODUCT_BUILD_VERSION; } \
        REALLY_INLINE void setconst_PRODUCT_BUILD_VERSION(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_PRODUCT_BUILD_VERSION = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_PRODUCT_VERSION() const { return m_slots_OperatingSystemClass.m_private_PRODUCT_VERSION; } \
        REALLY_INLINE void setconst_PRODUCT_VERSION(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_PRODUCT_VERSION = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_PRODUCT_USER_VISIBLE_VERSION() const { return m_slots_OperatingSystemClass.m_private_PRODUCT_USER_VISIBLE_VERSION; } \
        REALLY_INLINE void setconst_PRODUCT_USER_VISIBLE_VERSION(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_PRODUCT_USER_VISIBLE_VERSION = newVal; } \
    protected: \
        REALLY_INLINE avmplus::ArrayObject* get__macintosh() const { return m_slots_OperatingSystemClass.m_private__macintosh; } \
        REALLY_INLINE void set__macintosh(avmplus::ArrayObject* newVal) { m_slots_OperatingSystemClass.m_private__macintosh = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshName() const { return m_slots_OperatingSystemClass.m_private__macintoshName; } \
        REALLY_INLINE void set__macintoshName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshVersion() const { return m_slots_OperatingSystemClass.m_private__macintoshVersion; } \
        REALLY_INLINE void set__macintoshVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshProductName() const { return m_slots_OperatingSystemClass.m_private__macintoshProductName; } \
        REALLY_INLINE void set__macintoshProductName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshProductName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshProductBuildVersion() const { return m_slots_OperatingSystemClass.m_private__macintoshProductBuildVersion; } \
        REALLY_INLINE void set__macintoshProductBuildVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshProductBuildVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshProductVersion() const { return m_slots_OperatingSystemClass.m_private__macintoshProductVersion; } \
        REALLY_INLINE void set__macintoshProductVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshProductVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshProductUserVisibleVersion() const { return m_slots_OperatingSystemClass.m_private__macintoshProductUserVisibleVersion; } \
        REALLY_INLINE void set__macintoshProductUserVisibleVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshProductUserVisibleVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshProductDescription() const { return m_slots_OperatingSystemClass.m_private__macintoshProductDescription; } \
        REALLY_INLINE void set__macintoshProductDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshProductDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshLongDescription() const { return m_slots_OperatingSystemClass.m_private__macintoshLongDescription; } \
        REALLY_INLINE void set__macintoshLongDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshLongDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__macintoshCodename() const { return m_slots_OperatingSystemClass.m_private__macintoshCodename; } \
        REALLY_INLINE void set__macintoshCodename(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__macintoshCodename = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_LINUX() const { return m_slots_OperatingSystemClass.m_private_LINUX; } \
        REALLY_INLINE void setconst_LINUX(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_LINUX = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_DISTRIB_ID() const { return m_slots_OperatingSystemClass.m_private_DISTRIB_ID; } \
        REALLY_INLINE void setconst_DISTRIB_ID(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_DISTRIB_ID = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_DISTRIB_RELEASE() const { return m_slots_OperatingSystemClass.m_private_DISTRIB_RELEASE; } \
        REALLY_INLINE void setconst_DISTRIB_RELEASE(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_DISTRIB_RELEASE = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_DISTRIB_DESCRIPTION() const { return m_slots_OperatingSystemClass.m_private_DISTRIB_DESCRIPTION; } \
        REALLY_INLINE void setconst_DISTRIB_DESCRIPTION(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_DISTRIB_DESCRIPTION = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get_DISTRIB_CODENAME() const { return m_slots_OperatingSystemClass.m_private_DISTRIB_CODENAME; } \
        REALLY_INLINE void setconst_DISTRIB_CODENAME(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private_DISTRIB_CODENAME = newVal; } \
    protected: \
    ...
    protected: \
        REALLY_INLINE avmplus::ArrayObject* get__ubuntu() const { return m_slots_OperatingSystemClass.m_private__ubuntu; } \
        REALLY_INLINE void set__ubuntu(avmplus::ArrayObject* newVal) { m_slots_OperatingSystemClass.m_private__ubuntu = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxName() const { return m_slots_OperatingSystemClass.m_private__linuxName; } \
        REALLY_INLINE void set__linuxName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxVersion() const { return m_slots_OperatingSystemClass.m_private__linuxVersion; } \
        REALLY_INLINE void set__linuxVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxVendorName() const { return m_slots_OperatingSystemClass.m_private__linuxVendorName; } \
        REALLY_INLINE void set__linuxVendorName(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxVendorName = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxVendorVersion() const { return m_slots_OperatingSystemClass.m_private__linuxVendorVersion; } \
        REALLY_INLINE void set__linuxVendorVersion(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxVendorVersion = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxVendorBuild() const { return m_slots_OperatingSystemClass.m_private__linuxVendorBuild; } \
        REALLY_INLINE void set__linuxVendorBuild(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxVendorBuild = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxVendorDescription() const { return m_slots_OperatingSystemClass.m_private__linuxVendorDescription; } \
        REALLY_INLINE void set__linuxVendorDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxVendorDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxLongDescription() const { return m_slots_OperatingSystemClass.m_private__linuxLongDescription; } \
        REALLY_INLINE void set__linuxLongDescription(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxLongDescription = newVal; } \
    protected: \
        REALLY_INLINE avmplus::String* get__linuxCodename() const { return m_slots_OperatingSystemClass.m_private__linuxCodename; } \
        REALLY_INLINE void set__linuxCodename(avmplus::String* newVal) { m_slots_OperatingSystemClass.m_private__linuxCodename = newVal; } \
    private: \
...
// shell::ShellType$
//-----------------------------------------------------------
class avmplus_ShellTypeClassSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::ShellTypeClass;
private:
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_RUNTIME;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_PROJECTOR;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_SCRIPT;
public:
    REALLY_INLINE void gcTracePrivateProperties(MMgc::GC* gc)
    {
        gc->TraceLocation(&m_RUNTIME);
        gc->TraceLocation(&m_PROJECTOR);
        gc->TraceLocation(&m_SCRIPT);
    }
};
//-----------------------------------------------------------
...
// shell::ShellType
//-----------------------------------------------------------
class avmplus_ShellTypeObjectSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::ShellTypeObject;
#define GC_TRIVIAL_TRACER_ShellTypeObject
};
//-----------------------------------------------------------
...
// shell::Cygwin$
//-----------------------------------------------------------
class avmplus_CygwinClassSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::CygwinClass;
private:
    avmplus::bool32 m_private__isAvailable;
    avmplus::bool32 m_private__addedToEnvironment;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_CYGWIN_REGISTRY;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private_CYGWIN_ROOT;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__availability;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__installDirectory;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__shell;
public:
    REALLY_INLINE void gcTracePrivateProperties(MMgc::GC* gc)
    {
        gc->TraceLocation(&m_private_CYGWIN_REGISTRY);
        gc->TraceLocation(&m_private_CYGWIN_ROOT);
        gc->TraceLocation(&m_private__availability);
        gc->TraceLocation(&m_private__installDirectory);
...
// shell::Cygwin
//-----------------------------------------------------------
class avmplus_CygwinObjectSlots
{
    friend class SlotOffsetsAndAsserts;
    friend class avmplus::CygwinObject;
#define GC_TRIVIAL_TRACER_CygwinObject
};
//-----------------------------------------------------------
...
private:
    avmplus::bool32 m_private__synchronise;
    avmplus::bool32 m_private__allowEmpty;
...
private:
    avmplus::bool32 m_private__exactSettings;
    MMgc::GCTraceableObject::GCMember<avmplus::String> m_private__pageDomain;
...
public:
    REALLY_INLINE void gcTracePrivateProperties(MMgc::GC* gc)
    {
        gc->TraceLocation(&m_private__pageDomain);
...
private:
    REALLY_INLINE shell_toplevelClassManifest(avmplus::ScriptEnv* e) : ClassManifestBase(140, e) { }
    REALLY_INLINE static shell_toplevelClassManifest* create(avmplus::ScriptEnv* e) { return new (MMgc::GC::GetGC(e), MMgc::kExact, sizeof(ClassClosure*)*139) shell_toplevelClassManifest(e); }
public:
    ...
    REALLY_INLINE GCRef<avmplus::CygwinClass> get_CygwinClass() { return (avmplus::CygwinClass*)(lazyInitClass(avmplus::NativeID::abcclass_shell_Cygwin)); }
    ...
    REALLY_INLINE GCRef<avmplus::ShellTypeClass> get_ShellTypeClass() { return (avmplus::ShellTypeClass*)(lazyInitClass(avmplus::NativeID::abcclass_shell_ShellType)); }
