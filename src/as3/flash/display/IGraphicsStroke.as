...
{
	/**
	 * This interface is used to define objects that can be used as stroke parameters
	 * in the <code>flash.display.Graphics</code> methods and drawing classes.
	 * Use the implementor classes of this interface to create and manage stroke property data,
