...
def gen_shell(outdir):
    ...
    gen(prefix = 'avmshell', inputfiles = '../as3/shell/Program.as DebugCLI.h ShellCore.h ProgramClass.h', outputdir = outdir, srcdir = shelldir, ns = 'avmshell')
    gen(prefix = 'extensions', inputfiles = 'DomainClass.h ../as3/shell/Domain.as ../extensions/*.h ../extensions/*.as', outputdir = outdir, srcdir = shelldir, ns = 'avmplus')
