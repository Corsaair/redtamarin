...
public class Constraint {
    ...
    public function markInputs(mark:*):void {}
    public function removeFromGraph():void {}
    public function markUnsatisfied():void {}
    public function inputsKnown(mark:*=null):Boolean {return false;}
     ...
     */
    public function satisfy(mark:int) {
...
public class UnaryConstraint extends Constraint {
    ...
    override public function markInputs(mark:*):void {
      // has no inputs
    }
    ...
    override public function inputsKnown(mark:*=null):Boolean {
      return true;
    }
...
public class Planner {
     ...
     */
    public function extractPlanFromConstraints(constraints):Plan {
...
public class Plan {
    ...
    public function addConstraint(c):void {
      this.v.add(c);
    }
    ...
    public function constraintAt(index:int):* {
 ...
 */
function projectionTest(n):void {
  planner = new Planner();
