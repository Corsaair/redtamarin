...
function fannkuch(n:int):int {
   var check:int = 0;
   var perm:Vector.<int> = new Vector.<int>(n,true);
   var perm1:Vector.<int> = new Vector.<int>(n,true);
   var count:Vector.<int> = new Vector.<int>(n,true);
   var maxPerm:Vector.<int> = new Vector.<int>(n,true);
